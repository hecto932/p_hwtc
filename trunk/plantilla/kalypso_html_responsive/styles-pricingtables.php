...
<head>
	<title>Pricing Tables styles | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="styles-pricingtables.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="styles-pricingtables.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="styles-pricingtables.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="styles-pricingtables.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="styles-pricingtables.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="styles-pricingtables.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="styles-pricingtables.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="styles-pricingtables.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="styles-pricingtables.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="styles-pricingtables.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="styles-pricingtables.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="styles-pricingtables.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="styles-pricingtables.php#">French</a></li>
								<li><a href="styles-pricingtables.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="styles-pricingtables.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="styles-pricingtables.php#">SLIDERS</a>
							<ul>
								<li><a href="styles-pricingtables.php#">Main Slider</a>
									<ul>
						...
						<li><a href="styles-pricingtables.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="styles-pricingtables.php#">Portfolio</a>
									<ul>
								...
								<li><a href="styles-pricingtables.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="styles-pricingtables.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="styles-pricingtables.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="styles-pricingtables.php#">PAGES</a>
							<ul>
						...
						<li><a href="styles-pricingtables.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="styles-pricingtables.php#">HOME</a></li>
							<li>STYLES</li>
					...
					<div class="span6">
						<div class="header-titles">
							<h2>PRICING TABLES DESIGNS</h2>
							<h4>These are used for displaying price offers</h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
		...
		<section id="content">
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span12">
							<h1 class="page-title">Pricing Tables Designs</h1>
							<h2 class="subtitle">Welcome to KALLYAS Template, a wonderful and premium product for multipurpose websites</h2>


<!-- ////// start examples -->

<h2>Pricing table - Red Skin</h2>
<div class="row-fluid pricing_table no-space">

	<div class="span3">
		<div class="pr_table_col" data-color="red">
			<div class="tb_header">
				<h4 class="ttitle">STARTER</h4>
				<div class="price">
					<p>$6.99<span>per month</span></p>
				</div>
			</div>
			<ul class="tb_content">
				<li>2 Users</li>
			...
			<div class="signin">
				<a class="btn" href="styles-pricingtables.php#">ORDER NOW</a>
			</div>
	...
	<div class="span3">
		<div class="pr_table_col highlight" data-color="red">
			<div class="tb_header">
				<h4 class="ttitle">STANDARD</h4>
				<div class="price">
					<p>$9.99<span>per month</span></p>
				</div>
			</div>
			<ul class="tb_content">
				<li>5 Users</li>
	...
	<div class="span3">
		<div class="pr_table_col" data-color="red">
			<div class="tb_header">
				<h4 class="ttitle">PROFESSIONAL</h4>
				<div class="price">
					<p>$13.99<span>per month</span></p>
				</div>
			</div>
			<ul class="tb_content">
				<li>10 Users</li>
	...
	<div class="span3">
		<div class="pr_table_col" data-color="red">
			<div class="tb_header">
				<h4 class="ttitle">ULTRA</h4>
				<div class="price">
					<p>$99.99<span>per month</span></p>
				</div>
			</div>
			<ul class="tb_content">
...
<h2>Pricing table with Caption Column</h2>
<div class="row-fluid pricing_table no-space">

	<div class="span3">
		<div class="pr_table_col caption_column" data-color="red">
			<div class="tb_header">
				choose plan
			</div>
			<ul class="tb_content">
				<li>Users count</li>
				<li>Workspaces Count</li>
				<li># Clients</li>
				<li>Storage</li>
				<li>Max file size</li>
				<li>-</li>
				<li>Tech Support</li>
				<li data-rel="tooltip" title="Nulla dui augue, pretium ac pulvinar ac, molestie ac libero. Praesent sodales convallis nunc, at lacinia tellus ultrices non.">High Security</li>
			</ul>
...
<h2>Pricing table - Blue Skin with Rounded corners</h2>
<div class="row-fluid pricing_table no-space rounded-corners">

	<div class="span3">
		<div class="pr_table_col" data-color="blue">
			<div class="tb_header">
				<h4 class="ttitle">STARTER</h4>
				<div class="price">
					<p>$6.99<span>per month</span></p>
	...
	<div class="span3">
		<div class="pr_table_col highlight" data-color="blue">
			<div class="tb_header">
				<h4 class="ttitle">STANDARD</h4>
				<div class="price">
					<p>$9.99<span>per month</span></p>
...
<h2>Pricing table - Green Skin</h2>
<div class="row-fluid pricing_table no-space">

	<div class="span3">
		<div class="pr_table_col" data-color="green">
			<div class="tb_header">
				<h4 class="ttitle">STARTER</h4>
				<div class="price">
					<p>$6.99<span>per month</span></p>
	...
	<div class="span3">
		<div class="pr_table_col highlight" data-color="green">
			<div class="tb_header">
				<h4 class="ttitle">STANDARD</h4>
				<div class="price">
					<p>$9.99<span>per month</span></p>
...
<h2>Pricing table - Turquoise Skin</h2>
<div class="row-fluid pricing_table no-space">

	<div class="span3">
		<div class="pr_table_col" data-color="turquoise">
			<div class="tb_header">
				<h4 class="ttitle">STARTER</h4>
				<div class="price">
					<p>$6.99<span>per month</span></p>
	...
	<div class="span3">
		<div class="pr_table_col highlight" data-color="turquoise">
			<div class="tb_header">
				<h4 class="ttitle">STANDARD</h4>
				<div class="price">
					<p>$9.99<span>per month</span></p>
...
<h2>Pricing table - Orange Skin</h2>
<div class="row-fluid pricing_table no-space">
	...
	<div class="span3">
		<div class="pr_table_col highlight" data-color="orange">
			<div class="tb_header">
				<h4 class="ttitle">STANDARD</h4>
				<div class="price">
					<p>$9.99<span>per month</span></p>
...
<h2>Pricing table - Purple Skin</h2>
<div class="row-fluid pricing_table no-space">

	<div class="span3">
		<div class="pr_table_col" data-color="purple">
			<div class="tb_header">
				<h4 class="ttitle">STARTER</h4>
				<div class="price">
					<p>$6.99<span>per month</span></p>
	...
	<div class="span3">
		<div class="pr_table_col highlight" data-color="purple">
			<div class="tb_header">
				<h4 class="ttitle">STANDARD</h4>
				<div class="price">
					<p>$9.99<span>per month</span></p>
...
<h2>Pricing table - Yellow Skin</h2>
<div class="row-fluid pricing_table no-space">

	<div class="span3">
		<div class="pr_table_col" data-color="yellow">
			<div class="tb_header">
				<h4 class="ttitle">STARTER</h4>
				<div class="price">
					<p>$6.99<span>per month</span></p>
	...
	<div class="span3">
		<div class="pr_table_col highlight" data-color="yellow">
			<div class="tb_header">
				<h4 class="ttitle">STANDARD</h4>
				<div class="price">
					<p>$9.99<span>per month</span></p>
...
<h2>Pricing table - Green Lemon Skin</h2>
<div class="row-fluid pricing_table no-space">

	<div class="span3">
		<div class="pr_table_col" data-color="green_lemon">
			<div class="tb_header">
				<h4 class="ttitle">STARTER</h4>
				<div class="price">
					<p>$6.99<span>per month</span></p>
	...
	<div class="span3">
		<div class="pr_table_col highlight" data-color="green_lemon">
			<div class="tb_header">
				<h4 class="ttitle">STANDARD</h4>
				<div class="price">
					<p>$9.99<span>per month</span></p>
...
<h2>Pricing table - Dark Skin</h2>
<div class="row-fluid pricing_table no-space">

	<div class="span3">
		<div class="pr_table_col" data-color="dark">
			<div class="tb_header">
				<h4 class="ttitle">STARTER</h4>
				<div class="price">
					<p>$6.99<span>per month</span></p>
	...
	<div class="span3">
		<div class="pr_table_col highlight" data-color="dark">
			<div class="tb_header">
				<h4 class="ttitle">STANDARD</h4>
				<div class="price">
					<p>$9.99<span>per month</span></p>
...
<h2>Pricing table - Light Skin with normal spaces</h2>
<div class="row-fluid pricing_table">

	<div class="span3">
		<div class="pr_table_col" data-color="light">
			<div class="tb_header">
				<h4 class="ttitle">STARTER</h4>
				<div class="price">
					<p>$6.99<span>per month</span></p>
	...
	<div class="span3">
		<div class="pr_table_col highlight" data-color="light">
			<div class="tb_header">
				<h4 class="ttitle">STANDARD</h4>
				<div class="price">
					<p>$9.99<span>per month</span></p>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="styles-pricingtables.php#">Curabitur iaculis</a></li>
					<li><a href="styles-pricingtables.php#">Parturient montes</a></li>
					<li><a href="styles-pricingtables.php#">Vulputate magna</a></li>
					<li><a href="styles-pricingtables.php#">Cum sociis natoque</a></li>
					<li><a href="styles-pricingtables.php#">Nulla varius commodo</a></li>
					<li><a href="styles-pricingtables.php#">Parturient montes</a></li>
					<li><a href="styles-pricingtables.php#">Vulputate magna</a></li>
					<li><a href="styles-pricingtables.php#">Cum sociis natoque</a></li>
					<li><a href="styles-pricingtables.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="styles-pricingtables.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="styles-pricingtables.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="styles-pricingtables.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="styles-pricingtables.php#">Facebook</a></li>
						<li class="social-envato"><a href="styles-pricingtables.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="styles-pricingtables.php#" id="totop">TOP</a>
