	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="slider-circularcontent-default.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="slider-circularcontent-default.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="slider-circularcontent-default.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="slider-circularcontent-default.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="slider-circularcontent-default.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="slider-circularcontent-default.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="slider-circularcontent-default.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="slider-circularcontent-default.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="slider-circularcontent-default.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="slider-circularcontent-default.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="slider-circularcontent-default.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="slider-circularcontent-default.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="slider-circularcontent-default.php#">French</a></li>
								<li><a href="slider-circularcontent-default.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="slider-circularcontent-default.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="slider-circularcontent-default.php#">SLIDERS</a>
							<ul>
								<li><a href="slider-circularcontent-default.php#">Main Slider</a>
									<ul>
						...
						<li><a href="slider-circularcontent-default.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="slider-circularcontent-default.php#">Portfolio</a>
									<ul>
								...
								<li><a href="slider-circularcontent-default.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="slider-circularcontent-default.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="slider-circularcontent-default.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="slider-circularcontent-default.php#">PAGES</a>
							<ul>
						...
						<li><a href="slider-circularcontent-default.php#">STYLES</a>
							<ul>
                    ...
                    <div class="ca-wrapper">
                        ...
                        <div class="ca-item ca-item-1">
                            <div class="ca-item-main">
                                ...
                                <div class="ca-icon">
                                	<img src="images/sliders/circular_carousel/imac.jpg" alt="">
                                </div>
                                <h3>An awesome new product</h3>
                                <h4>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec lectus ligula, condimentum sed interdum atpulv inar nec nisi. Nunc suscipit euismod auctor.</h4>
                                <a href="slider-circularcontent-default.php#" class="ca-more">MORE <span class="icon-chevron-right icon-white"></span></a>
                                <span class="ca-starting">starting from <strong>$299</strong></span>
                            </div><!-- end ca-item-main -->
                            <div class="ca-content-wrapper">
                                <div class="ca-content">
                                    <h6>YES, AN AWESOME NEW PRODUCT</h6>
                                    <a href="slider-circularcontent-default.php#" class="ca-close"><span class="icon-remove"></span></a>
                                    ...
                                    <a href="slider-circularcontent-default.php#">Read more</a>
                                </div>
                        ...
                        <div class="ca-item ca-item-2">
                            <div class="ca-item-main">
                                ...
                                <div class="ca-icon">
                                	<img src="images/sliders/circular_carousel/ipad2.jpg" alt="">
                                </div>
                                <h3>An awesome new product</h3>
                                <h4>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec lectus ligula, condimentum sed interdum atpulv inar nec nisi. Nunc suscipit euismod auctor.</h4>
                                <a href="slider-circularcontent-default.php#" class="ca-more">MORE <span class="icon-chevron-right icon-white"></span></a>
                            ...
                            <div class="ca-content-wrapper">
                                <div class="ca-content">
									...
									<ul class="links">
                                        ...
                                        <li><a href="slider-circularcontent-default.php#"><span class="icon-shopping-cart icon-white"></span>add to cart</a></li>
                                        <li><a href="slider-circularcontent-default.php#"><span class="icon-plus-sign icon-white"></span>more details</a></li>
									</ul>
                                </div> 
                            </div><!-- end ca-content-wrapper -->
                        </div><!-- end ca-item -->
                        ...
                        <div class="ca-item ca-item-3">
                            <div class="ca-item-main">
                                ...
                                <div class="ca-icon">
                                	<img src="images/sliders/circular_carousel/macbook-pro2.jpg" alt="">
                                </div>
                                <h3>An awesome new product</h3>
                                <h4>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec lectus ligula, condimentum sed interdum atpulv inar nec nisi. Nunc suscipit euismod auctor.</h4>
                                <a href="slider-circularcontent-default.php#" class="ca-more">MORE <span class="icon-chevron-right icon-white"></span></a>
                        ...
                        <div class="ca-item ca-item-4">
                            <div class="ca-item-main">
                                ...
                                <div class="ca-icon">
                                	<img src="images/sliders/circular_carousel/iphone-4s.jpg" alt="">
                                </div>
                                <h3>An awesome new product</h3>
                                <h4>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec lectus ligula, condimentum sed interdum atpulv inar nec nisi. Nunc suscipit euismod auctor.</h4>
                                <a href="slider-circularcontent-default.php#" class="ca-more">MORE <span class="icon-chevron-right icon-white"></span></a>
                        ...
                        <div class="ca-item ca-item-5">
                            <div class="ca-item-main">
                                ...
                                <div class="ca-icon">
                                	<img src="images/sliders/circular_carousel/mac_mini.jpg" alt="">
                                </div>
                                <h3>An awesome new product</h3>
                                <h4>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec lectus ligula, condimentum sed interdum atpulv inar nec nisi. Nunc suscipit euismod auctor.</h4>
                                <a href="slider-circularcontent-default.php#" class="ca-more">MORE <span class="icon-chevron-right icon-white"></span></a>
		...
		<div id="action_box" data-arrowpos="center">
			<div class="container">
				<div class="row">
					...
					<div class="span4 align-center">
						<a href="slider-circularcontent-default.php#" class="btn">JOIN OUR NEWSLETTER</a>
					</div>
				</div>
			</div>
		</div><!-- end action box -->        
			...
			<div class="container">
				...
				<div class="row image-boxes imgboxes_style1">
                    <div class="span4 box">
						<a href="slider-circularcontent-default.php#" class="hoverBorder">
				...
				<div class="row recentwork_carousel default-style">
					<div class="span3">
						...
						<div class="controls">
							<a href="slider-circularcontent-default.php#" class="prev"><span class="icon-chevron-left"></span></a>
							<a href="slider-circularcontent-default.php#" class="complete"><span class="icon-th"></span></a>
							<a href="slider-circularcontent-default.php#" class="next"><span class="icon-chevron-right"></span></a>
						</div>
					</div>
					<div class="span9">
						<ul id="recent_works1" class="fixclear">
							<li>
								<a href="slider-circularcontent-default.php#">
									<span class="hover">
				...
				<div class="row">
					...
					<div class="span2">
						<a href="slider-circularcontent-default.php#" class="circlehover with-symbol" data-size="" data-position="top-left" data-align="right">
				...
				<div class="row">
					<div class="span12">
						<div class="latest_posts acc-style">
							...
							<a href="slider-circularcontent-default.php#" class="viewall">VIEW ALL -</a>
							<div class="css3accordion">
								<ul>
									<li>
										<div class="inner-acc">
											<a href="slider-circularcontent-default.php#" class="thumb hoverBorder">
												<img src="images/site_images/img1.jpg" alt="">
											</a>
											<div class="content">
									...
									<li>
										<div class="inner-acc">
											<a href="slider-circularcontent-default.php#" class="thumb hoverBorder plus">
												<img src="images/site_images/img2.jpg" alt="">
											</a>
											<div class="content">
												<em>03 October 2012 by Admin, in Entertanment</em>
			...
			<div class="gray-area">
				<div class="container">
					...
					<div class="span7">
						...
						<a href="slider-circularcontent-default.php#" class="hoverBorder pull-right" style="margin-left:20px;"><img src="images/site_images/img6.jpg" alt=""></a>
					...
					<div class="span12">
						<div class="process_steps fixclear">
							<div class="step intro">
								...
								<a href="slider-circularcontent-default.php#">MORE ABOUT US +</a>
							</div><!-- end step -->
				...
				<div class="row partners_carousel">
					...
					<div class="span10">
						<ul id="partners_carousel" class="fixclear">
							<li><a href="slider-circularcontent-default.php#"><img src="images/partners/css3.png" alt="" /></a></li>
							<li><a href="slider-circularcontent-default.php#"><img src="images/partners/html5.png" alt="" /></a></li>
							<li><a href="slider-circularcontent-default.php#"><img src="images/partners/joomla.png" alt="" /></a></li>
							<li><a href="slider-circularcontent-default.php#"><img src="images/partners/wordpress.png" alt="" /></a></li>
							<li><a href="slider-circularcontent-default.php#"><img src="images/partners/themeforest.png" alt="" /></a></li>
							<li><a href="slider-circularcontent-default.php#"><img src="images/partners/jquery.png" alt="" /></a></li>
						</ul>
					</div>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="slider-circularcontent-default.php#">Curabitur iaculis</a></li>
					<li><a href="slider-circularcontent-default.php#">Parturient montes</a></li>
					<li><a href="slider-circularcontent-default.php#">Vulputate magna</a></li>
					<li><a href="slider-circularcontent-default.php#">Cum sociis natoque</a></li>
					<li><a href="slider-circularcontent-default.php#">Nulla varius commodo</a></li>
					<li><a href="slider-circularcontent-default.php#">Parturient montes</a></li>
					<li><a href="slider-circularcontent-default.php#">Vulputate magna</a></li>
					<li><a href="slider-circularcontent-default.php#">Cum sociis natoque</a></li>
					<li><a href="slider-circularcontent-default.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="slider-circularcontent-default.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="slider-circularcontent-default.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="slider-circularcontent-default.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="slider-circularcontent-default.php#">Facebook</a></li>
						<li class="social-envato"><a href="slider-circularcontent-default.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="slider-circularcontent-default.php#" id="totop">TOP</a>
