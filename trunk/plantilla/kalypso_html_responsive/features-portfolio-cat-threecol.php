...
<head>
	<title>PORTFOLIO CATEGORY - THREE COLUMNS | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="features-portfolio-cat-threecol.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="features-portfolio-cat-threecol.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="features-portfolio-cat-threecol.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="features-portfolio-cat-threecol.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="features-portfolio-cat-threecol.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="features-portfolio-cat-threecol.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="features-portfolio-cat-threecol.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="features-portfolio-cat-threecol.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="features-portfolio-cat-threecol.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="features-portfolio-cat-threecol.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="features-portfolio-cat-threecol.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="features-portfolio-cat-threecol.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="features-portfolio-cat-threecol.php#">French</a></li>
								<li><a href="features-portfolio-cat-threecol.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="features-portfolio-cat-threecol.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="features-portfolio-cat-threecol.php#">SLIDERS</a>
							<ul>
								<li><a href="features-portfolio-cat-threecol.php#">Main Slider</a>
									<ul>
						...
						<li><a href="features-portfolio-cat-threecol.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="features-portfolio-cat-threecol.php#">Portfolio</a>
									<ul>
								...
								<li><a href="features-portfolio-cat-threecol.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="features-portfolio-cat-threecol.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="features-portfolio-cat-threecol.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="features-portfolio-cat-threecol.php#">PAGES</a>
							<ul>
						...
						<li><a href="features-portfolio-cat-threecol.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="features-portfolio-cat-threecol.php#">HOME</a></li>
							<li>FEATURES</li>
							<li>PORTFOLIO</li>
					...
					<div class="span6">
						<div class="header-titles">
							<h2>PORTFOLIO CATEGORY LAYOUT</h2>
			...
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row hg-portfolio">
						<div class="span12">
							<h1 class="page-title">Portfolio - Category layout</h1>
							...
							<div class="row">
								<div class="span4">
									<div class="img-intro">
										<a href="images/portfolio_images/ptf1.jpg" data-rel="prettyPhoto"  data-type="image" class="hoverLink" >
											<img src="php_helpers/timthumb.php?src=images%252Fportfolio_images%252Fptf1.jpg&amp;w=570" alt="Sollicitudin vitae, sodales in odio"  />
										</a>
									</div><!-- img intro -->
									<h4 class="title">
										<a href="http://hogash-demos.com/kalypso_html_responsive/images/img1.jpg" data-rel="prettyPhoto" >Sollicitudin vitae, sodales in odio</a>
									</h4>
								...
								<div class="span4">
									<div class="img-intro">
										<a href="pages-portfolioitem.php" data-type="link" class="hoverLink" >
											<img src="php_helpers/timthumb.php?src=images%252Fportfolio_images%252Fptf2.jpg&amp;w=570" alt=" Duis magna purus elementum"  />
										</a>
									</div><!-- img intro -->
									<h4 class="title">
										<a href="pages-portfolioitem.php" data-rel="prettyPhoto" >Duis magna purus elementum</a>
									</h4>
									<div class="pt-cat-desc">
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.</p>
										<p><strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit</strong>. Praesent mauris. Fusce nec tellus sed augue semper porta. Mauris massa. <strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit</strong>. Vestibulum lacinia arcu eget nulla.</p>
								...
								<div class="span4">
									<div class="img-intro">
										<a href="http://www.youtube.com/watch?v=g8evyE9TuYk" data-rel="prettyPhoto" data-type="video" class="hoverLink" >
											<img src="php_helpers/timthumb.php?src=images%252Fportfolio_images%252Fptf3.jpg&amp;w=570" alt="Vivamus mattis pharetra tellus"  />
										</a>
									</div><!-- img intro -->
									<h4 class="title">
										<a href="http://www.youtube.com/watch?v=g8evyE9TuYk" data-rel="prettyPhoto" >Vivamus mattis pharetra tellus</a>
									</h4>
									<div class="pt-cat-desc">
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.</p>
										<p><strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit</strong>. Praesent mauris. Fusce nec tellus sed augue semper porta. Mauris massa. <strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit</strong>. Vestibulum lacinia arcu eget nulla.</p>
							...
							<div class="row">
								...
								<div class="span4">
									<div class="img-intro">
										<a href="http://www.google.com" target="_blank" data-type="extlink" class="hoverLink" >
											<img src="php_helpers/timthumb.php?src=images%252Fportfolio_images%252Fptf4.jpg&amp;w=570" alt="Dolor sit amet consectetur adipiscing"  />
										</a>
									</div><!-- img intro -->
									<h4 class="title">
										<a href="http://www.google.com" target="_blank" >Dolor sit amet consectetur adipiscing</a>
									</h4>
									<div class="pt-cat-desc">
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.</p>
										<p><strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit</strong>. Praesent mauris. Fusce nec tellus sed augue semper porta. Mauris massa. <strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit</strong>. Vestibulum lacinia arcu eget nulla.</p>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="features-portfolio-cat-threecol.php#">Curabitur iaculis</a></li>
					<li><a href="features-portfolio-cat-threecol.php#">Parturient montes</a></li>
					<li><a href="features-portfolio-cat-threecol.php#">Vulputate magna</a></li>
					<li><a href="features-portfolio-cat-threecol.php#">Cum sociis natoque</a></li>
					<li><a href="features-portfolio-cat-threecol.php#">Nulla varius commodo</a></li>
					<li><a href="features-portfolio-cat-threecol.php#">Parturient montes</a></li>
					<li><a href="features-portfolio-cat-threecol.php#">Vulputate magna</a></li>
					<li><a href="features-portfolio-cat-threecol.php#">Cum sociis natoque</a></li>
					<li><a href="features-portfolio-cat-threecol.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="features-portfolio-cat-threecol.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="features-portfolio-cat-threecol.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="features-portfolio-cat-threecol.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="features-portfolio-cat-threecol.php#">Facebook</a></li>
						<li class="social-envato"><a href="features-portfolio-cat-threecol.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="features-portfolio-cat-threecol.php#" id="totop">TOP</a>
