...
<head>
	<title>Homepage 4 | KALLYAS Template</title>
		<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="homepage4.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="homepage4.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="homepage4.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="homepage4.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="homepage4.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="homepage4.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="homepage4.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="homepage4.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="homepage4.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="homepage4.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="homepage4.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="homepage4.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="homepage4.php#">French</a></li>
								<li><a href="homepage4.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="homepage4.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
...
(function($){ 
	$(document).ready(function(){
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="homepage4.php#">SLIDERS</a>
							<ul>
								<li><a href="homepage4.php#">Main Slider</a>
									<ul>
						...
						<li><a href="homepage4.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="homepage4.php#">Portfolio</a>
									<ul>
								...
								<li><a href="homepage4.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="homepage4.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="homepage4.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="homepage4.php#">PAGES</a>
							<ul>
						...
						<li><a href="homepage4.php#">STYLES</a>
							<ul>
        ...
        <div id="slideshow" class="gradient hasMargin">
                ...
                <div class="container">
                	<div class="static-content default-style">
                        ...
                        <div class="info_pop animated fadeBoxIn" data-arrow="top">
                        	<a href="homepage4.php#" class="buyit">BUY IT</a>
			...
			<div class="shadowUP"></div><div class="shadowUP"></div>
        </div><!-- end slideshow -->
		...
		<section id="content">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="span2">
						<a href="homepage4.php#" class="circlehover with-symbol" data-size="" data-position="top-left" data-align="right">
					...
					<div class="span7">
						...
						<div class="tabbable tabs_style1">
							<ul class="nav fixclear">
								<li class="active"><a href="homepage4.php#tabs1-pane1" data-toggle="tab">Some Tab #1</a></li>
								<li><a href="homepage4.php#tabs1-pane2" data-toggle="tab">Some Tab #2</a></li>
								<li><a href="homepage4.php#tabs1-pane3" data-toggle="tab">Some Tab #3</a></li>
							</ul>
				...
				<div class="row latest_posts default-style">
                    ...
                    <div class="span4 post">
						<a href="homepage4.php#" class="hoverBorder plus">
				...
				<div class="container">
					...
					<div class="span12">
						<div class="recentwork_carousel style2">
							...
							<div class="controls">
								<a href="homepage4.php#" class="prev"><span class="icon-chevron-left"></span></a>
								<a href="homepage4.php#" class="complete"><span class="icon-th"></span></a>
								<a href="homepage4.php#" class="next"><span class="icon-chevron-right"></span></a>
							</div>
					...
					<div class="span12">
						<div class="vertical_tabs">
							<div class="tabbable">
								<ul class="nav fixclear">
									<li class="active">
										<a href="homepage4.php#tabs_i2-pane1" data-toggle="tab">
										<span><span class="icon-comment icon-white"></span></span>
										CUSTOMER SUPPORT</a>
									</li>
									<li>
										<a href="homepage4.php#tabs_i2-pane2" data-toggle="tab">
										<span><span class="icon-book icon-white"></span></span>
										WELL DOCUMENTED</a>
									</li>
									<li>
										<a href="homepage4.php#tabs_i2-pane3" data-toggle="tab">
										<span><span class="icon-tint icon-white"></span></span>
										UNLIMITED COLORS</a>
									</li>
									<li>
										<a href="homepage4.php#tabs_i2-pane4" data-toggle="tab">
										<span><span class="icon-align-left icon-white"></span></span>
										CUSTOM SHORTCODES</a>
									</li>
									<li>
										<a href="homepage4.php#tabs_i2-pane5" data-toggle="tab">
				...
				<div class="row partners_carousel">
					...
					<div class="span10">
						<ul id="partners_carousel" class="fixclear">
							<li><a href="homepage4.php#"><img src="images/partners/css3.png" alt="" /></a></li>
							<li><a href="homepage4.php#"><img src="images/partners/html5.png" alt="" /></a></li>
							<li><a href="homepage4.php#"><img src="images/partners/joomla.png" alt="" /></a></li>
							<li><a href="homepage4.php#"><img src="images/partners/wordpress.png" alt="" /></a></li>
							<li><a href="homepage4.php#"><img src="images/partners/themeforest.png" alt="" /></a></li>
							<li><a href="homepage4.php#"><img src="images/partners/jquery.png" alt="" /></a></li>
						</ul>
					</div>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="homepage4.php#">Curabitur iaculis</a></li>
					<li><a href="homepage4.php#">Parturient montes</a></li>
					<li><a href="homepage4.php#">Vulputate magna</a></li>
					<li><a href="homepage4.php#">Cum sociis natoque</a></li>
					<li><a href="homepage4.php#">Nulla varius commodo</a></li>
					<li><a href="homepage4.php#">Parturient montes</a></li>
					<li><a href="homepage4.php#">Vulputate magna</a></li>
					<li><a href="homepage4.php#">Cum sociis natoque</a></li>
					<li><a href="homepage4.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="homepage4.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="homepage4.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="homepage4.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="homepage4.php#">Facebook</a></li>
						<li class="social-envato"><a href="homepage4.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="homepage4.php#" id="totop">TOP</a>
