...
<head>
	<title>PORTFOLIO CAROUSELS | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="features-portfolio-carousels.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="features-portfolio-carousels.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="features-portfolio-carousels.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="features-portfolio-carousels.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="features-portfolio-carousels.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="features-portfolio-carousels.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="features-portfolio-carousels.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="features-portfolio-carousels.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="features-portfolio-carousels.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="features-portfolio-carousels.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="features-portfolio-carousels.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="features-portfolio-carousels.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="features-portfolio-carousels.php#">French</a></li>
								<li><a href="features-portfolio-carousels.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="features-portfolio-carousels.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="features-portfolio-carousels.php#">SLIDERS</a>
							<ul>
								<li><a href="features-portfolio-carousels.php#">Main Slider</a>
									<ul>
						...
						<li><a href="features-portfolio-carousels.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="features-portfolio-carousels.php#">Portfolio</a>
									<ul>
								...
								<li><a href="features-portfolio-carousels.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="features-portfolio-carousels.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="features-portfolio-carousels.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="features-portfolio-carousels.php#">PAGES</a>
							<ul>
						...
						<li><a href="features-portfolio-carousels.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="features-portfolio-carousels.php#">HOME</a></li>
							<li>FEATURES</li>
							<li>PORTFOLIO</li>
							<li>CAROUSELS PORTFOLIO</li>
						</ul>
						<span id="current-date"></span>
					</div>
					<div class="span6">
						<div class="header-titles">
							<h2>PORTFOLIO CAROUSELS LAYOUT</h2>
			...
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row hg-portfolio ">
						<div class="span12">
							<h1 class="page-title">Portfolio - Carousels layout</h1>
							...
							<div class="row hg-portfolio-carousel">
								...
								<div class="span6">
									<div class="ptcontent">
										<h3 class="title">
											<a href="pages-portfolioitem.php">Sollicitudin vitae sodales in odio</a>
										</h3>
										<div class="pt-cat-desc">
											...
											<ul class="list-style2 cols-2 fixclear " >
										...
										<div class="itemLinks">
											<span>
												<a href="http://www.website-preview.com/" target="_blank" >Live Preview: www.website-preview.com</a>
											</span>
											<span class="seemore">
												<a href="pages-portfolioitem.php" >See more &rarr;</a>
											</span>
										</div><!-- end item links -->
								...
								<div class="span6">
									<div class="ptcarousel">
										<div class="controls">
											<a href="features-portfolio-carousels.php#" class="prev"><span class="icon-chevron-left icon-white"></span></a>
											<a href="features-portfolio-carousels.php#" class="next"><span class="icon-chevron-right icon-white"></span></a>
										</div>
										<ul id="ptcarousel1">
											<li>
												<a href="images/portfolio_images/ptf1.jpg" data-rel="prettyPhoto" >
													<img src="php_helpers/timthumb.php?src=images%252Fportfolio_images%252Fptf1.jpg&amp;w=570&amp;h=356&amp;zc=1" alt="Sollicitudin vitae sodales in odio"/>
												</a>
											</li>
											<li>
												<a href="images/portfolio_images/other/scottwills_cityscape.jpg" rel="prettyPhoto">
													<img src="php_helpers/timthumb.php?src=images%252Fportfolio_images%252Fother%252Fscottwills_cityscape.jpg&amp;w=570&amp;h=356&amp;zc=1" alt="Sollicitudin vitae sodales in odio" />
												</a>
											</li>
											<li>
												<a href="images/portfolio_images/other/scottwills_cityscape2.jpg" rel="prettyPhoto">
													<img src="php_helpers/timthumb.php?src=images%252Fportfolio_images%252Fother%252Fscottwills_cityscape2.jpg&amp;w=570&amp;h=356&amp;zc=1" alt="Sollicitudin vitae sodales in odio" />
												</a>
											</li>
											<li>
												<a href="images/portfolio_images/other/scottwills_crossing.jpg" rel="prettyPhoto">
													<img src="php_helpers/timthumb.php?src=images%252Fportfolio_images%252Fother%252Fscottwills_crossing.jpg&amp;w=570&amp;h=356&amp;zc=1" alt="Sollicitudin vitae sodales in odio" />
												</a>
											</li>
										</ul>
									</div><!-- end ptcarousel -->
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="features-portfolio-carousels.php#">Curabitur iaculis</a></li>
					<li><a href="features-portfolio-carousels.php#">Parturient montes</a></li>
					<li><a href="features-portfolio-carousels.php#">Vulputate magna</a></li>
					<li><a href="features-portfolio-carousels.php#">Cum sociis natoque</a></li>
					<li><a href="features-portfolio-carousels.php#">Nulla varius commodo</a></li>
					<li><a href="features-portfolio-carousels.php#">Parturient montes</a></li>
					<li><a href="features-portfolio-carousels.php#">Vulputate magna</a></li>
					<li><a href="features-portfolio-carousels.php#">Cum sociis natoque</a></li>
					<li><a href="features-portfolio-carousels.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="features-portfolio-carousels.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="features-portfolio-carousels.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="features-portfolio-carousels.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="features-portfolio-carousels.php#">Facebook</a></li>
						<li class="social-envato"><a href="features-portfolio-carousels.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="features-portfolio-carousels.php#" id="totop">TOP</a>
