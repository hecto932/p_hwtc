...
<head>
	<title>BLOG ITEM | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="pages-blogitem.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="pages-blogitem.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="pages-blogitem.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="pages-blogitem.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="pages-blogitem.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="pages-blogitem.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="pages-blogitem.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="pages-blogitem.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="pages-blogitem.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="pages-blogitem.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="pages-blogitem.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="pages-blogitem.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="pages-blogitem.php#">French</a></li>
								<li><a href="pages-blogitem.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="pages-blogitem.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="pages-blogitem.php#">SLIDERS</a>
							<ul>
								<li><a href="pages-blogitem.php#">Main Slider</a>
									<ul>
						...
						<li><a href="pages-blogitem.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="pages-blogitem.php#">Portfolio</a>
									<ul>
								...
								<li><a href="pages-blogitem.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="pages-blogitem.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="pages-blogitem.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="pages-blogitem.php#">PAGES</a>
							<ul>
						...
						<li><a href="pages-blogitem.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="pages-blogitem.php#">HOME</a></li>
							<li>PAGES</li>
							<li>BLOG ITEM</li>
						</ul>
					...
					<div class="span6">
						<div class="header-titles">
							<h2>Quis autem vel reprehenderit</h2>
							<h4>This is a typical blog item page</h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
		...
		<section id="content">
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span9">
							<h1 class="page-title">Quis autem vel reprehenderit</h1>
							...
							<div class="itemView clearfix eBlog">
								...
								<div class="itemHeader">
									<div class="post_details">
										<span class="itemAuthor">by <a rel="author" href="pages-blogitem.php#">Administrator</a></span>
										<span class="infSep"> / </span>
										<span class="itemDateCreated"><span class="icon-calendar"></span> Thursday, 14 June 2012</span>
										<span class="infSep"> / </span>
										<span class="itemCommentsBlock"></span>
										<span class="itemCategory"><span class="icon-folder-close"></span> Published in </span><a href="features-blog.php">Lifestyle</a>
									</div>
								</div><!-- end itemheader -->

								<div class="itemBody">
									<p><a href="pages-blogitem.php#" class="hoverBorder pull-left" style="margin-right: 20px;"><img src="images/blog_images/tribal-face-and-arms-hands.jpg" /></a></p>
								...
								<div class="itemTagsBlock">
									...
									<ul class="itemTags">
										<li><a href="pages-blogitem.php#">duis</a>, </li>
										<li><a href="pages-blogitem.php#">placerat</a>, </li>
										<li><a href="pages-blogitem.php#">dolor</a>, </li>
										<li><a href="pages-blogitem.php#">tristique</a>, </li>
									</ul>
									<div class="clear"></div>
								</div><!-- end Item tags -->
...
FOLLOW THIS TUTORIAL TO SIGN UP AND CREATE YOUR ACCOUNT ON DISQUS http://www.shoutmeloud.com/how-to-integrate-disqus-commenting-system-on-your-website.html
...
<div class="disqusForm">
	...
	<script type="text/javascript">
		//<![CDATA[
		var disqus_shortname = 'hogash'; // add your username here
	...
	<noscript>
		<a href="http://hogash.disqus.com/?url=ref">View the discussion thread.</a>
	</noscript>
	<div id="disqusFormFooter">
						...
						<div class="span3">
							<div id="sidebar" class="sidebar-right">
								...
								<div class="widget">
									...
									<ul class="menu">
										<li><a href="pages-blogitem.php#">Entertainment</a></li>
										<li><a href="pages-blogitem.php#">Tech</a></li>
										<li><a href="pages-blogitem.php#">Lifestyle</a></li>
									</ul><!-- end menu -->
								</div><!-- end widget -->
								...
								<div class="widget">
									...
									<ul class="menu">
										<li><a href="pages-blogitem.php#">July 2012 (6)</a></li>
										<li><a href="pages-blogitem.php#">June 2012 (12)</a></li>
										<li><a href="pages-blogitem.php#">May 2012 (3)</a></li>
										<li><a href="pages-blogitem.php#">April 2012 (2)</a></li>
										<li><a href="pages-blogitem.php#">March 2012 (2)</a></li>
										<li><a href="pages-blogitem.php#">February 2012 (5)</a></li>
										<li><a href="pages-blogitem.php#">January 2012 (4)</a></li>
									</ul><!-- end menu -->
								</div><!-- end widget -->
								...
								<div class="widget">
									...
									<div class="cloudBlock">
										<a href="pages-blogitem.php#" style="font-size:75%">dictum</a>
										<a href="pages-blogitem.php#" style="font-size:117%">dolor</a>
										<a href="pages-blogitem.php#" style="font-size:200%">duis</a>
										<a href="pages-blogitem.php#" style="font-size:75%">lacus</a>
										<a href="pages-blogitem.php#" style="font-size:159%">placerat</a>
										<a href="pages-blogitem.php#" style="font-size:117%">tristique</a>
										<div class="clear"></div>
									</div>
								</div><!-- end widget -->
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="pages-blogitem.php#">Curabitur iaculis</a></li>
					<li><a href="pages-blogitem.php#">Parturient montes</a></li>
					<li><a href="pages-blogitem.php#">Vulputate magna</a></li>
					<li><a href="pages-blogitem.php#">Cum sociis natoque</a></li>
					<li><a href="pages-blogitem.php#">Nulla varius commodo</a></li>
					<li><a href="pages-blogitem.php#">Parturient montes</a></li>
					<li><a href="pages-blogitem.php#">Vulputate magna</a></li>
					<li><a href="pages-blogitem.php#">Cum sociis natoque</a></li>
					<li><a href="pages-blogitem.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="pages-blogitem.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="pages-blogitem.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="pages-blogitem.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="pages-blogitem.php#">Facebook</a></li>
						<li class="social-envato"><a href="pages-blogitem.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="pages-blogitem.php#" id="totop">TOP</a>
