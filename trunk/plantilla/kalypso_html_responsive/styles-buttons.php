...
<head>
	<title>Buttons styles | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="styles-buttons.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="styles-buttons.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="styles-buttons.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="styles-buttons.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="styles-buttons.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="styles-buttons.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="styles-buttons.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="styles-buttons.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="styles-buttons.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="styles-buttons.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="styles-buttons.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="styles-buttons.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="styles-buttons.php#">French</a></li>
								<li><a href="styles-buttons.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="styles-buttons.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="styles-buttons.php#">SLIDERS</a>
							<ul>
								<li><a href="styles-buttons.php#">Main Slider</a>
									<ul>
						...
						<li><a href="styles-buttons.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="styles-buttons.php#">Portfolio</a>
									<ul>
								...
								<li><a href="styles-buttons.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="styles-buttons.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="styles-buttons.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="styles-buttons.php#">PAGES</a>
							<ul>
						...
						<li><a href="styles-buttons.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="styles-buttons.php#">HOME</a></li>
							<li>STYLES</li>
							<li>BUTTONS</li>
						</ul>
					...
					<div class="span6">
						<div class="header-titles">
							<h2>BUTTON DESIGN</h2>
							<h4>Regular HTML buttons with nice stylings</h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
		...
		<section id="content">
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span12">
							<h1 class="page-title">Button Designs</h1>
							<h2 class="subtitle">Welcome to KALLYAS Template, a wonderful and premium product for multipurpose websites</h2>
...
&lt;button class="btn btn-large btn-block" type="button"&gt;Block level button&lt;/button&gt;
	...
	<p class="bs-docs-example">
		<a href="styles-buttons.php#" class="btn btn-large btn-primary disabled">Primary link</a>
		<a href="styles-buttons.php#" class="btn btn-large disabled">Link</a>
	</p>
<pre class="prettyprint linenums">
...
&lt;button type="button" class="btn btn-large" disabled&gt;Button&lt;/button&gt;
	...
	<form class="bs-docs-example">
		<a class="btn" href="styles-buttons.php">Link</a>
...
&lt;input class="btn" type="submit" value="Submit"&gt;
	...
	<ul class="social-icons fixclear">
		<li class="social-twitter"><a href="styles-buttons.php#">Twitter</a></li>
		<li class="social-dribbble"><a href="styles-buttons.php#">Dribbble</a></li>
		<li class="social-facebook"><a href="styles-buttons.php#">Facebook</a></li>
		<li class="social-envato"><a href="styles-buttons.php#">Envato</a></li>
		<li class="social-flickr"><a href="styles-buttons.php#">flickr</a></li>
		<li class="social-forrst"><a href="styles-buttons.php#">forrst</a></li>
		<li class="social-gplus"><a href="styles-buttons.php#">gplus</a></li>
		<li class="social-gplus2"><a href="styles-buttons.php#">gplus2</a></li>
		<li class="social-icloud"><a href="styles-buttons.php#">icloud</a></li>
		<li class="social-lastfm"><a href="styles-buttons.php#">lastfm</a></li>
		<li class="social-linkedin"><a href="styles-buttons.php#">linkedin</a></li>
		<li class="social-myspace"><a href="styles-buttons.php#">myspace</a></li>
		<li class="social-paypal"><a href="styles-buttons.php#">paypal</a></li>
		<li class="social-piacasa"><a href="styles-buttons.php#">piacasa</a></li>
		<li class="social-pinterest"><a href="styles-buttons.php#">pinterest</a></li>
		<li class="social-reedit"><a href="styles-buttons.php#">reedit</a></li>
		<li class="social-rss"><a href="styles-buttons.php#">rss</a></li>
		<li class="social-skype"><a href="styles-buttons.php#">skype</a></li>
		<li class="social-stumbleupon"><a href="styles-buttons.php#">stumbleupon</a></li>
		<li class="social-tumblr"><a href="styles-buttons.php#">tumblr</a></li>
		<li class="social-vimeo"><a href="styles-buttons.php#">vimeo</a></li>
		<li class="social-wordpress"><a href="styles-buttons.php#">wordpress</a></li>
		<li class="social-yahoo"><a href="styles-buttons.php#">yahoo</a></li>
		<li class="social-youtube"><a href="styles-buttons.php#">youtube</a></li>
		<li class="social-blogger"><a href="styles-buttons.php#">blogger</a></li>
		<li class="social-deviantart"><a href="styles-buttons.php#">deviantart</a></li>
		<li class="social-digg"><a href="styles-buttons.php#">digg</a></li>
		<li class="social-foursquare"><a href="styles-buttons.php#">foursquare</a></li>
		<li class="social-friendfeed"><a href="styles-buttons.php#">friendfeed</a></li>
		<li class="social-mail"><a href="styles-buttons.php#">mail</a></li>
		<li class="social-html5"><a href="styles-buttons.php#">html5</a></li>
		<li class="social-technorati"><a href="styles-buttons.php#">technorati</a></li>
		<li class="social-soundcloud"><a href="styles-buttons.php#">soundcloud</a></li>
		<li class="social-quora"><a href="styles-buttons.php#">quora</a></li>
		<li class="social-bebo"><a href="styles-buttons.php#">bebo</a></li>
		<li class="social-aim"><a href="styles-buttons.php#">aim</a></li>
		<li class="social-gosquared"><a href="styles-buttons.php#">gosquared</a></li>
		<li class="social-dropbox"><a href="styles-buttons.php#">dropbox</a></li>
		<li class="social-github"><a href="styles-buttons.php#">github</a></li>
		<li class="social-spotify"><a href="styles-buttons.php#">spotify</a></li>
		<li class="social-apple"><a href="styles-buttons.php#">apple</a></li>
	</ul>
<pre class="prettyprint linenums">
&lt;ul class="social-icons fixclear"&gt;
...
<!-- ////// end examples -->
<link href="addons/prettify-code/prettify.css" rel="stylesheet">
<script src="addons/prettify-code/prettify.js"></script>
<script type="text/javascript">
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="styles-buttons.php#">Curabitur iaculis</a></li>
					<li><a href="styles-buttons.php#">Parturient montes</a></li>
					<li><a href="styles-buttons.php#">Vulputate magna</a></li>
					<li><a href="styles-buttons.php#">Cum sociis natoque</a></li>
					<li><a href="styles-buttons.php#">Nulla varius commodo</a></li>
					<li><a href="styles-buttons.php#">Parturient montes</a></li>
					<li><a href="styles-buttons.php#">Vulputate magna</a></li>
					<li><a href="styles-buttons.php#">Cum sociis natoque</a></li>
					<li><a href="styles-buttons.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="styles-buttons.php#">sales@yourwebsite.com</a></p>
    ...
    <a href="styles-buttons.php#" id="totop">TOP</a>
