	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="index.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="index.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="index.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="index.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="index.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="index.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="index.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="index.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="index.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="index.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="index.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="index.php#">English <span class="icon-ok"></span></a></li>
				...
				<!-- search -->
				<div id="search">
					<a href="index.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="index.php#">SLIDERS</a>
							<ul>
								<li><a href="index.php#">Main Slider</a>
									<ul>
						...
						<li><a href="index.php#">FEATURES</a>
							<ul>
								...
								<li><a href="index.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="index.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="index.php#">Holiday Slides</a>
									<ul>
		...
		<div id="slideshow" class="gradient">
			...
			<div class = "iosSlider">
				...
				<div class="slider">
                    ...
                    <div class = "item">
						<img src="images/sliders/iosslider/slide1.jpg" alt="" /><!-- slide image -->
                        <div class="caption style1">
                        	<h2 class="main_title">AUTUMN 2012<br>COLLECTION</h2>
							<h3 class="title_big">20% DISCOUNT</h3>
							<a href="index.php#" class="more"><img src="sliders/iosslider/arr01.png" alt=""></a>
							<h4 class="title_small">FOR THE PRODUCTS IN OUR NEWEST COLLECTION</h4>
                        </div>
					</div><!-- end item -->
                    
					<div class = "item">
                        <img src="images/sliders/iosslider/slide2.jpg" alt="" />
					...
					<div class = "item">
						<img src="images/sliders/iosslider/slide3.jpg" alt="" />
                        <div class="caption style1">
			...
			<div class="container">
				<div class="row">
					...
					<div class="span4 align-center">
						<a href="index.php#" class="btn">JOIN OUR NEWSLETTER</a>
					</div>
				</div>
			</div>
		</div><!-- end action box -->        
			...
			<div class="container">
				...
				<div class="row recentwork_carousel default-style">
					<div class="span3">
						...
						<div class="controls">
							<a href="index.php#" class="prev"><span class="icon-chevron-left"></span></a>
							<a href="index.php#" class="complete"><span class="icon-th"></span></a>
							<a href="index.php#" class="next"><span class="icon-chevron-right"></span></a>
						</div>
					</div>
					<div class="span9">
				...
				<div class="row">
					...
					<div class="span2">
						<a href="index.php#" class="circlehover with-symbol" data-size="" data-position="top-left" data-align="right">
				...
				<div class="row">
					<div class="span12">
						<div class="latest_posts acc-style">
							...
							<a href="index.php#" class="viewall">VIEW ALL -</a>
							<div class="css3accordion">
								<ul>
									<li>
										<div class="inner-acc">
											<a href="index.php#" class="thumb hoverBorder">
												<img src="images/site_images/img1.jpg" alt="">
											</a>
											<div class="content">
									...
									<li>
										<div class="inner-acc">
											<a href="index.php#" class="thumb hoverBorder plus">
												<img src="images/site_images/img2.jpg" alt="">
											</a>
											<div class="content">
												<em>03 October 2012 by Admin, in Entertanment</em>
			...
			<div class="gray-area">
				<div class="container">
					...
					<div class="span7">
						...
						<a href="index.php#" class="hoverBorder pull-right" style="margin-left:20px;"><img src="images/site_images/img6.jpg" alt=""></a>
					...
					<div class="span12">
						<div class="process_steps fixclear">
							<div class="step intro">
								...
								<a href="index.php#">MORE ABOUT US +</a>
							</div><!-- end step -->
				...
				<div class="row partners_carousel">
					...
					<div class="span10">
						<ul id="partners_carousel" class="fixclear">
							<li><a href="index.php#"><img src="images/partners/css3.png" alt="" /></a></li>
							<li><a href="index.php#"><img src="images/partners/html5.png" alt="" /></a></li>
							<li><a href="index.php#"><img src="images/partners/joomla.png" alt="" /></a></li>
							<li><a href="index.php#"><img src="images/partners/wordpress.png" alt="" /></a></li>
							<li><a href="index.php#"><img src="images/partners/themeforest.png" alt="" /></a></li>
							<li><a href="index.php#"><img src="images/partners/jquery.png" alt="" /></a></li>
						</ul>
					</div>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="index.php#">Curabitur iaculis</a></li>
					<li><a href="index.php#">Parturient montes</a></li>
					<li><a href="index.php#">Vulputate magna</a></li>
					<li><a href="index.php#">Cum sociis natoque</a></li>
					<li><a href="index.php#">Nulla varius commodo</a></li>
					<li><a href="index.php#">Parturient montes</a></li>
					<li><a href="index.php#">Vulputate magna</a></li>
					<li><a href="index.php#">Cum sociis natoque</a></li>
					<li><a href="index.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="index.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="index.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="index.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="index.php#">Facebook</a></li>
						<li class="social-envato"><a href="index.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="index.php#" id="totop">TOP</a>
