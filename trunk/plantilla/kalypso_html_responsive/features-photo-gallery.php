...
<head>
	<title>PHOTO GALLERY | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="features-photo-gallery.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="features-photo-gallery.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="features-photo-gallery.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="features-photo-gallery.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="features-photo-gallery.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="features-photo-gallery.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="features-photo-gallery.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="features-photo-gallery.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="features-photo-gallery.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="features-photo-gallery.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="features-photo-gallery.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="features-photo-gallery.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="features-photo-gallery.php#">French</a></li>
								<li><a href="features-photo-gallery.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="features-photo-gallery.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="features-photo-gallery.php#">SLIDERS</a>
							<ul>
								<li><a href="features-photo-gallery.php#">Main Slider</a>
									<ul>
						...
						<li><a href="features-photo-gallery.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="features-photo-gallery.php#">Portfolio</a>
									<ul>
								...
								<li><a href="features-photo-gallery.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="features-photo-gallery.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="features-photo-gallery.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="features-photo-gallery.php#">PAGES</a>
							<ul>
						...
						<li><a href="features-photo-gallery.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="features-photo-gallery.php#">HOME</a></li>
							<li>FEATURES</li>
							<li>PHOTO GALLERY</li>
						</ul>
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span12">
							...
							<ul class="photo_gallery"><li><a href="images/gallery/first/1318580_14776034.jpg" rel="prettyPhoto[gal]" class="hoverBorder"><img src="php_helpers/timthumb.php?src=%252Fkalypso_html_responsive%252Fimages%252Fgallery%252Ffirst%252F1318580_14776034.jpg&amp;w=155&amp;h=115&amp;zc=0" alt=""></a></li><li><a href="images/gallery/first/1279604_94436320.jpg" rel="prettyPhoto[gal]" class="hoverBorder"><img src="php_helpers/timthumb.php?src=%252Fkalypso_html_responsive%252Fimages%252Fgallery%252Ffirst%252F1279604_94436320.jpg&amp;w=155&amp;h=115&amp;zc=0" alt=""></a></li><li><a href="images/gallery/first/1327554_20192784.jpg" rel="prettyPhoto[gal]" class="hoverBorder"><img src="php_helpers/timthumb.php?src=%252Fkalypso_html_responsive%252Fimages%252Fgallery%252Ffirst%252F1327554_20192784.jpg&amp;w=155&amp;h=115&amp;zc=0" alt=""></a></li><li><a href="images/gallery/first/1328085_34480513.jpg" rel="prettyPhoto[gal]" class="hoverBorder"><img src="php_helpers/timthumb.php?src=%252Fkalypso_html_responsive%252Fimages%252Fgallery%252Ffirst%252F1328085_34480513.jpg&amp;w=155&amp;h=115&amp;zc=0" alt=""></a></li><li><a href="images/gallery/first/1313570_48029144.jpg" rel="prettyPhoto[gal]" class="hoverBorder"><img src="php_helpers/timthumb.php?src=%252Fkalypso_html_responsive%252Fimages%252Fgallery%252Ffirst%252F1313570_48029144.jpg&amp;w=155&amp;h=115&amp;zc=0" alt=""></a></li><li><a href="images/gallery/first/1286619_74215091.jpg" rel="prettyPhoto[gal]" class="hoverBorder"><img src="php_helpers/timthumb.php?src=%252Fkalypso_html_responsive%252Fimages%252Fgallery%252Ffirst%252F1286619_74215091.jpg&amp;w=155&amp;h=115&amp;zc=0" alt=""></a></li><li><a href="images/gallery/first/1278049_55160781.jpg" rel="prettyPhoto[gal]" class="hoverBorder"><img src="php_helpers/timthumb.php?src=%252Fkalypso_html_responsive%252Fimages%252Fgallery%252Ffirst%252F1278049_55160781.jpg&amp;w=155&amp;h=115&amp;zc=0" alt=""></a></li><li><a href="images/gallery/first/1334642_51574102.jpg" rel="prettyPhoto[gal]" class="hoverBorder"><img src="php_helpers/timthumb.php?src=%252Fkalypso_html_responsive%252Fimages%252Fgallery%252Ffirst%252F1334642_51574102.jpg&amp;w=155&amp;h=115&amp;zc=0" alt=""></a></li><li><a href="images/gallery/first/1322067_77979827.jpg" rel="prettyPhoto[gal]" class="hoverBorder"><img src="php_helpers/timthumb.php?src=%252Fkalypso_html_responsive%252Fimages%252Fgallery%252Ffirst%252F1322067_77979827.jpg&amp;w=155&amp;h=115&amp;zc=0" alt=""></a></li><li><a href="images/gallery/first/1289914_71810168.jpg" rel="prettyPhoto[gal]" class="hoverBorder"><img src="php_helpers/timthumb.php?src=%252Fkalypso_html_responsive%252Fimages%252Fgallery%252Ffirst%252F1289914_71810168.jpg&amp;w=155&amp;h=115&amp;zc=0" alt=""></a></li><li><a href="images/gallery/first/1322735_31850794.jpg" rel="prettyPhoto[gal]" class="hoverBorder"><img src="php_helpers/timthumb.php?src=%252Fkalypso_html_responsive%252Fimages%252Fgallery%252Ffirst%252F1322735_31850794.jpg&amp;w=155&amp;h=115&amp;zc=0" alt=""></a></li></ul>							
							...
							<!-- as you can see the image's src are added with the help of timthumb.php to create the thumbnails -->
								<li>
									<a data-rel="prettyPhoto" href="images/gallery/second/1336635_63765576.jpg" title="Simple Image" class="hoverBorder">
										<img alt="" src="php_helpers/timthumb.php?src=..%252Fimages%252Fgallery%252Fsecond%252F1336635_63765576.jpg&amp;w=155&amp;h=115&amp;zc=0">
									</a>
								</li>
								
								<!-- to add a video icon, add the class "video" -->
								<li>
									<a data-rel="prettyPhoto[flash]" href="images/flv/sample.swf?width=620&amp;height=375" title="Flash Media" class="hoverBorder">
										<img alt="" src="php_helpers/timthumb.php?src=..%252Fimages%252Fgallery%252Fsecond%252F1336342_22583242.jpg&amp;w=155&amp;h=115&amp;zc=0">
									</a>
								</li>
								
								<li>
									<a data-rel="prettyPhoto[iframes]" href="php_helpers/player.php?video=..%252Fimages%252Fflv%252Fanimation.flv&amp;iframe=true&amp;width=620&amp;height=375" title="FLV Video" class="hoverBorder">
										<img alt="" src="php_helpers/timthumb.php?src=..%252Fimages%252Fgallery%252Fsecond%252F1336882_90276791.jpg&amp;w=155&amp;h=115&amp;zc=0">
									</a>
								</li>
								
								<li>
									<a data-rel="prettyPhoto" href="http://www.youtube.com/watch?v=OHUpQZIylVc" title="YouTube Video" class="hoverBorder">
										<img alt="" src="php_helpers/timthumb.php?src=..%252Fimages%252Fgallery%252Fsecond%252F1336633_65751997.jpg&amp;w=155&amp;h=115&amp;zc=0">
									</a>
								</li>
								
								<li>
									<a data-rel="prettyPhoto" href="http://vimeo.com/5233789" title="Vimeo Video" class="hoverBorder">
										<img alt="" src="php_helpers/timthumb.php?src=..%252Fimages%252Fgallery%252Fsecond%252F1336338_84064705.jpg&amp;w=155&amp;h=115&amp;zc=0">
									</a>
								</li>
							</ul>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="features-photo-gallery.php#">Curabitur iaculis</a></li>
					<li><a href="features-photo-gallery.php#">Parturient montes</a></li>
					<li><a href="features-photo-gallery.php#">Vulputate magna</a></li>
					<li><a href="features-photo-gallery.php#">Cum sociis natoque</a></li>
					<li><a href="features-photo-gallery.php#">Nulla varius commodo</a></li>
					<li><a href="features-photo-gallery.php#">Parturient montes</a></li>
					<li><a href="features-photo-gallery.php#">Vulputate magna</a></li>
					<li><a href="features-photo-gallery.php#">Cum sociis natoque</a></li>
					<li><a href="features-photo-gallery.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="features-photo-gallery.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="features-photo-gallery.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="features-photo-gallery.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="features-photo-gallery.php#">Facebook</a></li>
						<li class="social-envato"><a href="features-photo-gallery.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="features-photo-gallery.php#" id="totop">TOP</a>
