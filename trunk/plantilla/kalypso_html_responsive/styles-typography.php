...
<head>
	<title>Typography | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="styles-typography.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="styles-typography.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="styles-typography.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="styles-typography.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="styles-typography.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="styles-typography.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="styles-typography.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="styles-typography.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="styles-typography.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="styles-typography.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="styles-typography.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="styles-typography.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="styles-typography.php#">French</a></li>
								<li><a href="styles-typography.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="styles-typography.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="styles-typography.php#">SLIDERS</a>
							<ul>
								<li><a href="styles-typography.php#">Main Slider</a>
									<ul>
						...
						<li><a href="styles-typography.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="styles-typography.php#">Portfolio</a>
									<ul>
								...
								<li><a href="styles-typography.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="styles-typography.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="styles-typography.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="styles-typography.php#">PAGES</a>
							<ul>
						...
						<li><a href="styles-typography.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="styles-typography.php#">HOME</a></li>
							<li>STYLES</li>
							<li>TYPOGRAPHY</li>
						</ul>
					...
					<div class="span6">
						<div class="header-titles">
							<h2>TYPOGRAPHY</h2>
							<h4>Fundamental HTML elements styled and enhanced</h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
		...
		<section id="content">
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span12">
							<h1 class="page-title">Typography and other Html elements</h1>
...
&lt;i class="icon-search icon-white"&gt;&lt;/i&gt;
	...
	<div class="bs-docs-example">
		<div class="btn-toolbar">
			<div class="btn-group">
				<a class="btn" href="styles-typography.php#"><i class="icon-align-left"></i></a>
				<a class="btn" href="styles-typography.php#"><i class="icon-align-center"></i></a>
				<a class="btn" href="styles-typography.php#"><i class="icon-align-right"></i></a>
				<a class="btn" href="styles-typography.php#"><i class="icon-align-justify"></i></a>
			</div>
		</div>
	</div>
	...
	<div class="page-header">
          ...
          <div class="bs-docs-example tooltip-demo">
            <p class="muted" style="margin-bottom: 0;">Tight pants next level keffiyeh <a href="styles-typography.php#" rel="tooltip" title="Default tooltip">you probably</a> haven't heard of them. Photo booth beard raw denim letterpress vegan messenger bag stumptown. Farm-to-table seitan, mcsweeney's fixie sustainable quinoa 8-bit american apparel <a href="styles-typography.php#" rel="tooltip" title="Another tooltip">have a</a> terry richardson vinyl chambray. Beard stumptown, cardigans banh mi lomo thundercats. Tofu biodiesel williamsburg marfa, four loko mcsweeney's cleanse vegan chambray. A really ironic artisan <a href="styles-typography.php#" rel="tooltip" title="Another one here too">whatever keytar</a>, scenester farm-to-table banksy Austin <a href="styles-typography.php#" rel="tooltip" title="The last tip!">twitter handle</a> freegan cred raw denim single-origin coffee viral.
            </p>
          </div>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="styles-typography.php#">Curabitur iaculis</a></li>
					<li><a href="styles-typography.php#">Parturient montes</a></li>
					<li><a href="styles-typography.php#">Vulputate magna</a></li>
					<li><a href="styles-typography.php#">Cum sociis natoque</a></li>
					<li><a href="styles-typography.php#">Nulla varius commodo</a></li>
					<li><a href="styles-typography.php#">Parturient montes</a></li>
					<li><a href="styles-typography.php#">Vulputate magna</a></li>
					<li><a href="styles-typography.php#">Cum sociis natoque</a></li>
					<li><a href="styles-typography.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="styles-typography.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="styles-typography.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="styles-typography.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="styles-typography.php#">Facebook</a></li>
						<li class="social-envato"><a href="styles-typography.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="styles-typography.php#" id="totop">TOP</a>
