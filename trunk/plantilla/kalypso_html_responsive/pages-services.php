...
<head>
	<title>SERVICES | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="pages-services.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="pages-services.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="pages-services.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="pages-services.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="pages-services.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="pages-services.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="pages-services.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="pages-services.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="pages-services.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="pages-services.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="pages-services.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="pages-services.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="pages-services.php#">French</a></li>
								<li><a href="pages-services.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="pages-services.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="pages-services.php#">SLIDERS</a>
							<ul>
								<li><a href="pages-services.php#">Main Slider</a>
									<ul>
						...
						<li><a href="pages-services.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="pages-services.php#">Portfolio</a>
									<ul>
								...
								<li><a href="pages-services.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="pages-services.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="pages-services.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="pages-services.php#">PAGES</a>
							<ul>
						...
						<li><a href="pages-services.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="pages-services.php#">HOME</a></li>
							<li>PAGES</li>
							<li>SERVICES</li>
						</ul>
					...
					<div class="span6">
						<div class="header-titles">
							...
							<h4>These are our services that we're prowdly doing.</h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
		...
		<section id="content">
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="span2">
						<a href="pages-services.php#" class="circlehover with-symbol" data-size="" data-position="top-left" data-align="right">
...
Morbi in ipsum sit amet pede facilisis laoreet. Donec lacus nunc, viverra nec, blandit vel, egestas et, augue. </div>
								...
								<div class="span7">
									...
									<div class="tabbable tabs_style1">
										<ul class="nav fixclear">
											<li class="active"><a href="pages-services.php#tabs1-pane1" data-toggle="tab">Some Tab #1</a></li>
											<li><a href="pages-services.php#tabs1-pane2" data-toggle="tab">Some Tab #2</a></li>
											<li><a href="pages-services.php#tabs1-pane3" data-toggle="tab">Some Tab #3</a></li>
										</ul>
							...
							<div class="row feature_box default_style">
								<div class="span12">
									<h4 class="smallm_title"><span>OUR SERVICES // STYLE 4</span></h4>
								</div>
								<div class="span3">
									<p><strong>There are plenty reasons why!!</strong></p>
									<p><em>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur.. <a href="pages-services.php#">continue reading</a></em></p>
								</div>
								<div class="span3">
									<div class="box">
							...
							<div class="row">
					<div class="span4">
						<a href="pages-services.php#" class="hover-box fixclear">
					...
					<div class="span4">
						<a href="pages-services.php#" class="hover-box centered fixclear">
							<h3>WE'RE HIRING!</h3>
					...
					<div class="span4">
						<a href="pages-services.php#" class="hover-box fixclear">
							...
							<div class="row feature_box style2">
								<div class="span12">
									<h4 class="smallm_title centered bigger"><span>OUR SERVICES // STYLE 5</span></h4>
								</div>
								<div class="span3">
									<div class="box">
							...
							<div class="row feature_box style3">
								<div class="span12">
									<h4 class="smallm_title centered bigger"><span>OUR SERVICES // STYLE 6</span></h4>
								</div>
								<div class="span3">
									<div class="box">
										<h4 class="title">CUSTOMER SUPPORT</h4>
					...
					<div class="span12">
						<div class="vertical_tabs">
							<div class="tabbable">
								<ul class="nav fixclear">
									<li class="active">
										<a href="pages-services.php#tabs_i2-pane1" data-toggle="tab">
										<span><span class="icon-comment icon-white"></span></span>
										CUSTOMER SUPPORT</a>
									</li>
									<li>
										<a href="pages-services.php#tabs_i2-pane2" data-toggle="tab">
										<span><span class="icon-book icon-white"></span></span>
										WELL DOCUMENTED</a>
									</li>
									<li>
										<a href="pages-services.php#tabs_i2-pane3" data-toggle="tab">
										<span><span class="icon-tint icon-white"></span></span>
										UNLIMITED COLORS</a>
									</li>
									<li>
										<a href="pages-services.php#tabs_i2-pane4" data-toggle="tab">
										<span><span class="icon-align-left icon-white"></span></span>
										CUSTOM SHORTCODES</a>
									</li>
									<li>
										<a href="pages-services.php#tabs_i2-pane5" data-toggle="tab">
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="pages-services.php#">Curabitur iaculis</a></li>
					<li><a href="pages-services.php#">Parturient montes</a></li>
					<li><a href="pages-services.php#">Vulputate magna</a></li>
					<li><a href="pages-services.php#">Cum sociis natoque</a></li>
					<li><a href="pages-services.php#">Nulla varius commodo</a></li>
					<li><a href="pages-services.php#">Parturient montes</a></li>
					<li><a href="pages-services.php#">Vulputate magna</a></li>
					<li><a href="pages-services.php#">Cum sociis natoque</a></li>
					<li><a href="pages-services.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="pages-services.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="pages-services.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="pages-services.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="pages-services.php#">Facebook</a></li>
						<li class="social-envato"><a href="pages-services.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="pages-services.php#" id="totop">TOP</a>
