...
<head>
	<title>Homepage 6 | KALLYAS Template</title>
		<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="homepage6.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="homepage6.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="homepage6.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="homepage6.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="homepage6.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="homepage6.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="homepage6.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="homepage6.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="homepage6.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="homepage6.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="homepage6.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="homepage6.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="homepage6.php#">French</a></li>
								<li><a href="homepage6.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="homepage6.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="homepage6.php#">SLIDERS</a>
							<ul>
								<li><a href="homepage6.php#">Main Slider</a>
									<ul>
						...
						<li><a href="homepage6.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="homepage6.php#">Portfolio</a>
									<ul>
								...
								<li><a href="homepage6.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="homepage6.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="homepage6.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="homepage6.php#">PAGES</a>
							<ul>
						...
						<li><a href="homepage6.php#">STYLES</a>
							<ul>
                ...
                <div class="container">
                	<div class="static-content default-style">
                        ...
                        <div class="info_pop animated fadeBoxIn" data-arrow="top">
                        	<a href="homepage6.php#" class="buyit">BUY IT</a>
			...
			<div class="container">
				<div class="row">
					...
					<div class="span4 align-center">
						<a href="homepage6.php#" class="btn">JOIN OUR NEWSLETTER</a>
					</div>
				</div>
			</div>
		</div><!-- end action box -->        
		<section id="content">
			...
			<div class="container">
				...
				<div class="row image-boxes imgboxes_style1">
                    <div class="span4 box">
						<a href="homepage6.php#" class="hoverBorder">
			...
			<div class="gray-area">
				<div class="container">
					...
					<div class="row">
						...
						<div class="span6 feature_box default_style">
							<div class="row">
								<div class="span6">
									<h3 class="m_title">WHY CHOOSE THIS THEME</h3>
								</div>
			...
			<div class="container">
						...
						<div class="span12">
							<div class="process_steps fixclear">
								<div class="step intro">
									...
									<a href="homepage6.php#">MORE ABOUT US +</a>
								</div><!-- end step -->
				...
				<div class="row partners_carousel">
						<div class="span2">
							...
							<div class="controls">
								<a href="homepage6.php#" class="prev"><span class="icon-chevron-left"></span></a>
								<a href="homepage6.php#" class="next"><span class="icon-chevron-right"></span></a>
							</div>
						</div>
						<div class="span10">
							<ul id="partners_carousel" class="fixclear">
								<li><a href="homepage6.php#"><img src="images/partners/css3.png" alt="" /></a></li>
								<li><a href="homepage6.php#"><img src="images/partners/html5.png" alt="" /></a></li>
								<li><a href="homepage6.php#"><img src="images/partners/joomla.png" alt="" /></a></li>
								<li><a href="homepage6.php#"><img src="images/partners/wordpress.png" alt="" /></a></li>
								<li><a href="homepage6.php#"><img src="images/partners/themeforest.png" alt="" /></a></li>
								<li><a href="homepage6.php#"><img src="images/partners/jquery.png" alt="" /></a></li>
							</ul>
						</div>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="homepage6.php#">Curabitur iaculis</a></li>
					<li><a href="homepage6.php#">Parturient montes</a></li>
					<li><a href="homepage6.php#">Vulputate magna</a></li>
					<li><a href="homepage6.php#">Cum sociis natoque</a></li>
					<li><a href="homepage6.php#">Nulla varius commodo</a></li>
					<li><a href="homepage6.php#">Parturient montes</a></li>
					<li><a href="homepage6.php#">Vulputate magna</a></li>
					<li><a href="homepage6.php#">Cum sociis natoque</a></li>
					<li><a href="homepage6.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="homepage6.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="homepage6.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="homepage6.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="homepage6.php#">Facebook</a></li>
						<li class="social-envato"><a href="homepage6.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="homepage6.php#" id="totop">TOP</a>
