...
<head>
	<title>SITEMAP | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="features-sitemap.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="features-sitemap.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="features-sitemap.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="features-sitemap.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="features-sitemap.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="features-sitemap.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="features-sitemap.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="features-sitemap.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="features-sitemap.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="features-sitemap.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="features-sitemap.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="features-sitemap.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="features-sitemap.php#">French</a></li>
								<li><a href="features-sitemap.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="features-sitemap.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="features-sitemap.php#">SLIDERS</a>
							<ul>
								<li><a href="features-sitemap.php#">Main Slider</a>
									<ul>
						...
						<li><a href="features-sitemap.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="features-sitemap.php#">Portfolio</a>
									<ul>
								...
								<li><a href="features-sitemap.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="features-sitemap.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="features-sitemap.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="features-sitemap.php#">PAGES</a>
							<ul>
						...
						<li><a href="features-sitemap.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="features-sitemap.php#">HOME</a></li>
							<li>FEATURES</li>
							<li>SITEMAP</li>
						</ul>
								...
								<ul>
									...
									<li><a href="features-sitemap.php#">SLIDERS</a>
										<ul>
											...
											<li><a href="slider-fancy.php">Fancy Slider</a></li>
											<li><a href="slider-creative.php">Creative Slider</a></li>
											<li><a href="slider-circularcontent-default.php">Circular Content</a>
												<ul>
													<li><a href="slider-circularcontent-default.php">Default Style</a></li>
													<li><a href="slider-circularcontent-alternative.php">Alternative Style</a></li>
												</ul>
									...
									<li><a href="features-sitemap.php#">FEATURES</a>
										<ul>
											...
											<li><a href="features-grid-positions.php">Grid Positions</a></li>
											<li><a href="features-sitemap.php">Sitemap</a></li>
											<li><a href="http://hogash-demos.com/kalypso_html_responsive/features-holiday-slides.php">Holiday Slides</a></li>
											<li><a href="features-animated-header.php">Animated Header</a></li>
										</ul>
									</li>
									<li><a href="shop.php">SHOP</a></li>
									<li><a href="features-sitemap.php#">PAGES</a>
										<ul>
											...
											<li><a href="pages-rightsidebar.php">Right sidebar</a></li>
											<li><a href="pages-offline.php">Offline / Coming soon</a></li>
											<li><a href="pages-historic.php">Historic</a></li>
											<li><a href="pages-testimonials.php">Testimonials</a></li>
											<li><a href="pages-404.php">404 Error</a></li>
											<li><a href="pages-portfolioitem.php">Portfolio Item</a></li>
											<li><a href="pages-blogitem.php">Blog Item</a></li> 
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="features-sitemap.php#">Curabitur iaculis</a></li>
					<li><a href="features-sitemap.php#">Parturient montes</a></li>
					<li><a href="features-sitemap.php#">Vulputate magna</a></li>
					<li><a href="features-sitemap.php#">Cum sociis natoque</a></li>
					<li><a href="features-sitemap.php#">Nulla varius commodo</a></li>
					<li><a href="features-sitemap.php#">Parturient montes</a></li>
					<li><a href="features-sitemap.php#">Vulputate magna</a></li>
					<li><a href="features-sitemap.php#">Cum sociis natoque</a></li>
					<li><a href="features-sitemap.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="features-sitemap.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="features-sitemap.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="features-sitemap.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="features-sitemap.php#">Facebook</a></li>
						<li class="social-envato"><a href="features-sitemap.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="features-sitemap.php#" id="totop">TOP</a>
