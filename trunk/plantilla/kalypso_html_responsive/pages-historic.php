...
<head>
	<title>HISTORIC PAGE | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="pages-historic.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="pages-historic.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="pages-historic.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="pages-historic.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="pages-historic.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="pages-historic.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="pages-historic.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="pages-historic.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="pages-historic.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="pages-historic.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="pages-historic.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="pages-historic.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="pages-historic.php#">French</a></li>
								<li><a href="pages-historic.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="pages-historic.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="pages-historic.php#">SLIDERS</a>
							<ul>
								<li><a href="pages-historic.php#">Main Slider</a>
									<ul>
						...
						<li><a href="pages-historic.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="pages-historic.php#">Portfolio</a>
									<ul>
								...
								<li><a href="pages-historic.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="pages-historic.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="pages-historic.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="pages-historic.php#">PAGES</a>
							<ul>
						...
						<li><a href="pages-historic.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="pages-historic.php#">HOME</a></li>
							<li>PAGES</li>
							<li>HISTORIC</li>
						</ul>
					...
					<div class="span6">
						<div class="header-titles">
							<h2>OUR COMPANY'S HISTORIC</h2>
							<h4>A brief timeline of moments that marked our company.</h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
								...
								<div class="span12 timeline_bar">
									<div class="row">
										<div class="span12 end_timeline">
											<span>2000 &rsaquo; ESTABLISHMENT</span>
										</div>
										<div class="span6">
											<div class="timeline_box">
												<div class="date">2001</div>
												<h4 class="htitle">The beginning of the road</h4>
										...
										<div class="span6 offset6" data-align="right">
											<div class="timeline_box">
												...
												<h4 class="htitle">Got our first award</h4>
												<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec porttitor erat viverra justo fringilla ultricies. Fusce dignissim libero in neque feugiat quis laoreet magna vulputate. Phasellus vestibulum, dolor eu molestie tincidunt, purus leo fermentum erat, vel hendrerit mauris massa sed erat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec porttitor erat viverra justo fringilla ultricies. Fusce dignissim libero in neque feugiat quis laoreet magna vulputate. Phasellus vestibulum, dolor eu molestie tincidunt, purus leo fermentum erat, vel hendrerit mauris massa sed erat.</p>
											</div><!-- end timeline box -->
										</div>
										<div class="span6">
											<div class="timeline_box">
												...
												<h4 class="htitle">Merged with another company</h4>
										...
										<div class="span6 offset6" data-align="right">
											<div class="timeline_box">
												...
												<h4 class="htitle">A very succsessful company</h4>
												<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec porttitor erat viverra justo fringilla ultricies. Fusce dignissim libero in neque feugiat quis laoreet magna vulputate. Phasellus vestibulum, dolor eu molestie tincidunt, purus leo fermentum erat, vel hendrerit mauris massa sed erat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec porttitor erat viverra justo fringilla ultricies. </p>
											</div><!-- end timeline box -->
										</div>
										<div class="span12 end_timeline">
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="pages-historic.php#">Curabitur iaculis</a></li>
					<li><a href="pages-historic.php#">Parturient montes</a></li>
					<li><a href="pages-historic.php#">Vulputate magna</a></li>
					<li><a href="pages-historic.php#">Cum sociis natoque</a></li>
					<li><a href="pages-historic.php#">Nulla varius commodo</a></li>
					<li><a href="pages-historic.php#">Parturient montes</a></li>
					<li><a href="pages-historic.php#">Vulputate magna</a></li>
					<li><a href="pages-historic.php#">Cum sociis natoque</a></li>
					<li><a href="pages-historic.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="pages-historic.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="pages-historic.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="pages-historic.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="pages-historic.php#">Facebook</a></li>
						<li class="social-envato"><a href="pages-historic.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="pages-historic.php#" id="totop">TOP</a>
