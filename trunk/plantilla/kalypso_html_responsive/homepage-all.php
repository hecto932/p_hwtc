...
<head>
	<title>Homepage All | KALLYAS Template</title>
		<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="homepage-all.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="homepage-all.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="homepage-all.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="homepage-all.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="homepage-all.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="homepage-all.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="homepage-all.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="homepage-all.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="homepage-all.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="homepage-all.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="homepage-all.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="homepage-all.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="homepage-all.php#">French</a></li>
								<li><a href="homepage-all.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="homepage-all.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="homepage-all.php#">SLIDERS</a>
							<ul>
								<li><a href="homepage-all.php#">Main Slider</a>
									<ul>
						...
						<li><a href="homepage-all.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="homepage-all.php#">Portfolio</a>
									<ul>
								...
								<li><a href="homepage-all.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="homepage-all.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="homepage-all.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="homepage-all.php#">PAGES</a>
							<ul>
						...
						<li><a href="homepage-all.php#">STYLES</a>
							<ul>
                ...
                <div class="container">
                	<div class="static-content simple">
						...
						<div class="row">
							<div class="span12">
                                <h2>HELLO!</h2>
                                <h3>Welcome to <strong>KALLYAS Template</strong>, a wonderful and <strong class="stronger" data-rel="tooltip" data-placement="top" title="MEGA PREMIUM ACTUALLY" data-animation="true">premium</strong> product for <strong>multipurpose websites</strong></h3>
                                <h4 class="can_be_used">I CAN BE USED FOR: <span>PRESENTATION WEBSITES, SHOPS, ONLINE CATALOGUES OR OTHER WEBSITES</span></h4>
                                <a href="homepage-all.php#" class="btn btn-large btn-flat">BUY ME</a><span class="line"></span>
							</div>
						</div><!-- end row -->
		...
		<section id="content">
			...
			<div class="container">
				...
				<div class="row image-boxes imgboxes_style1">
                    <div class="span4 box">
						<a href="homepage-all.php#" class="hoverBorder">
				...
				<div class="row">
					...
					<div class="span5">
						<h4 class="m_title">WHY CHOOSE US</h4>
					...
					<div class="span7">
						...
						<div class="tabbable tabs_style1">
							<ul class="nav fixclear">
								<li class="active"><a href="homepage-all.php#tabs1-pane1" data-toggle="tab">Some Tab #1</a></li>
								<li><a href="homepage-all.php#tabs1-pane2" data-toggle="tab">Some Tab #2</a></li>
								<li><a href="homepage-all.php#tabs1-pane3" data-toggle="tab">Some Tab #3</a></li>
							</ul>
							<div class="tab-content">
								<div class="tab-pane active" id="tabs1-pane1">
									<img src="images/site_images/img5.jpg" alt="" class="pull-left" style="margin:0 15px 0 0;">
				...
				<div class="row image-boxes imgboxes_style2">
                    <div class="span3 box">
						<a href="homepage-all.php#" class="slidingDetails">
							<img src="images/site_images/img1.jpg" alt="">
							<div class="details">
					...
					<div class="span3 box">
						<a href="homepage-all.php#" class="slidingDetails">
							<img src="images/site_images/img4.jpg" alt="">
							<div class="details">
								<h4>HTML5 &amp; CSS3</h4>
								<p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum.</p>
							</div>
                ...
                </div><!-- end row // img_boxes style2 -->
				
				<div class="row partners_carousel">
					<div class="span2">
						<h5 class="title"><span>OUR PARTNERS // TEHNOLOGIES USED</span></h5>
						<div class="controls">
							<a href="homepage-all.php#" class="prev"><span class="icon-chevron-left"></span></a>
							<a href="homepage-all.php#" class="next"><span class="icon-chevron-right"></span></a>
						</div>
					</div>
					<div class="span10">
						<ul id="partners_carousel" class="fixclear">
							<li><a href="homepage-all.php#"><img src="images/partners/css3.png" alt="" /></a></li>
							<li><a href="homepage-all.php#"><img src="images/partners/html5.png" alt="" /></a></li>
							<li><a href="homepage-all.php#"><img src="images/partners/joomla.png" alt="" /></a></li>
							<li><a href="homepage-all.php#"><img src="images/partners/wordpress.png" alt="" /></a></li>
							<li><a href="homepage-all.php#"><img src="images/partners/themeforest.png" alt="" /></a></li>
							<li><a href="homepage-all.php#"><img src="images/partners/jquery.png" alt="" /></a></li>
						</ul>
					</div>
				...
				<div class="row">
					<div class="span12">
						<div class="infobox1">
							<h3 class="m_title">KALLYAS Template IS AN ALL IN ONE PRODUCT WITH LOTS OF GOODIES AND FEATURES</h3>
							<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium</p>
						</div>
					</div>
				</div><!-- end row // infobox1 -->
				
				<div class="row">
					<div class="span12">
						<div class="infobox2">
							<a href="homepage-all.php#" class="btn btn-large btn-inverse">BUY THIS TEMPLATE</a>
							<h3 class="m_title">KALLYAS Template IS AN ALL IN ONE PRODUCT WITH LOTS OF GOODIES AND FEATURES</h3>
							<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium</p>
						</div>
					</div>
				</div><!-- end row // infobox2 -->
				
				<div class="row feature_box default_style">
					<div class="span12">
						<h4 class="smallm_title"><span>WHY CHOOSE THIS THEME</span></h4>
					</div>
					<div class="span3">
						<p><strong>There are plenty reasons why!!</strong></p>
						<p><em>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur.. <a href="homepage-all.php#">continue reading</a></em></p>
					</div>
					<div class="span3">
						<div class="box">
							<h4 class="title"><img src="images/icons/featured_boxes/ico-01.png" alt=""> WELL DOCUMENTED</h4>
							<p>Documentation include with explanations for most of the options.</p>
						</div>
						<div class="box">
							<h4 class="title"><img src="images/icons/featured_boxes/ico-04.png" alt=""> MULTILANGUAGE READY</h4>
							<p>You can install languages and extend the website's languages.</p>
						</div>
					</div>
					<div class="span3">
						<div class="box">
							<h4 class="title"><img src="images/icons/featured_boxes/ico-02.png" alt=""> UNLIMITED COLORS</h4>
							<p>With just a few clicks you can add any color you want.</p>
						</div>
						<div class="box">
							<h4 class="title"><img src="images/icons/featured_boxes/ico-05.png" alt=""> HTML5 &amp; CSS3</h4>
							<p>Built with modern technologies like HTML5 and CSS3.</p>
						</div>
					</div>
					<div class="span3">
						<div class="box">
							<h4 class="title"><img src="images/icons/featured_boxes/ico-03.png" alt=""> CUSTOM SHORTCODES</h4>
							<p>Great custom shortcodes which are ment to ease up your work.</p>
						</div>
						<div class="box">
							<h4 class="title"><img src="images/icons/featured_boxes/ico-06.png" alt=""> HIGHLY CUSTOMIZABLE</h4>
							<p>This template includes lots of customizations and combinations.</p>
						</div>
					</div>
				</div><!-- end row // feature_box default_style -->
				...
				</div><!-- end row // feature_box style3 -->
				...
				<div class="row latest_posts default-style">
                    ...
                    <div class="span4 post">
						<a href="homepage-all.php#" class="hoverBorder plus">
							<img src="images/site_images/img1.jpg" alt="">
							<h6>Read more +</h6>
						</a>
						<em>03 October 2012 by Admin, in Entertanment</em>
                        <h3 class="m_title">Sed ut perspiciatis unde omnis</h3>
                    </div><!-- end span -->
					...
					<div class="span4 post">
						...
						<em>03 October 2012 by Admin, in Entertanment</em>
                        <h3 class="m_title">Nemo enim ipsam voluptatem quia voluptas sit aspernatur </h3>
                    </div><!-- end span -->
					...
					<div class="span4 post">
						...
						<em>03 October 2012 by Admin, in Entertanment</em>
                        <h3 class="m_title"> Neque porro quisquam est, qui dolorem</h3>
                    </div><!-- end span -->
					
                </div><!-- end row // latest_posts default-style -->
				
				<div class="row">
					<div class="span8">
						<div class=" latest_posts style2">
							<h3 class="m_title">LATEST POSTS</h3>
							<a href="homepage-all.php#" class="viewall">VIEW ALL -</a>
							<ul class="posts">
								<li class="post">
									<div class="details">
										<span class="date">10/03/2012</span>
										<span class="cat">in Entertainment</span>
									</div>
									<h4 class="title">Sed ut perspiciatis unde omnis</h4>
									<div class="text">Vivamus ut molestie nulla. Aenean vel tortor velit. Morbi quis varius tortor. Quisque sit amet leo purus, eget acc lorem. Curabitur fringilla ipsum id quam lacinia venenatis. Nullam facilisis mattis lacus, ut dapibus risus congue vitae. Suspendisse potenti. Nunc sodales dolor at justo posuere vitae pretium magna rhoncus. Sed quis velitget diam condimentum tempus…</div>
								</li>
								<li class="post">
									<div class="details">
										<span class="date">10/03/2012</span>
									...
									<h4 class="title">Nemo enim ipsam voluptatem quia voluptas sit aspernatur </h4>
									<div class="text">Vivamus ut molestie nulla. Aenean vel tortor velit. Morbi quis varius tortor. Quisque sit amet leo purus, eget acc lorem. Curabitur fringilla ipsum id quam lacinia venenatis. Nullam facilisis mattis lacus, ut dapibus risus congue vitae. Suspendisse potenti. Nunc sodales dolor at justo posuere vitae pretium magna rhoncus. Sed quis velitget diam condimentum tempus…</div>
								</li>
							</ul>
					...
					<div class="span4">
						<div class=" latest_posts style3">
							...
							<ul class="posts">
								<li class="post">
									<a href="homepage-all.php#" class="hoverBorder pull-left"><img src="images/post-thumb1.jpg" alt=""></a>
									<h4 class="title">Sed ut perspiciatis unde omnis</h4>
									<div class="text">Vivamus ut molestie nulla. Aenean vel tortor velit. Morbi quis varius tortor. Quisque sit amet.</div>
								</li>
								<li class="post">
									<a href="homepage-all.php#" class="hoverBorder pull-left"><img src="images/post-thumb1.jpg" alt=""></a>
									<h4 class="title">Sed ut perspiciatis unde omnis</h4>
						...
						<div class="latest_posts acc-style">
							...
							<div class="css3accordion">
								<ul>
									<li>
										<div class="inner-acc">
											<a href="homepage-all.php#" class="thumb hoverBorder">
												<img src="images/site_images/img1.jpg" alt="">
											</a>
											<div class="content">
												<em>03 October 2012 by Admin, in Entertanment</em>
												...
												<a href="homepage-all.php#">READ MORE +</a>
											</div>
										</div>
									</li>
									...
									<li>
										<div class="inner-acc">
											<a href="homepage-all.php#" class="thumb hoverBorder plus">
												<img src="images/site_images/img2.jpg" alt="">
											</a>
											<div class="content">
												<em>03 October 2012 by Admin, in Entertanment</em>
				...
				</div><!-- end row // latest_posts acc-style -->
					...
					<div class="span12">
						<div class="process_steps fixclear">
							<div class="step intro">
								...
								<a href="homepage-all.php#">MORE ABOUT US +</a>
							</div><!-- end step -->
				...
				<div class="row recentwork_carousel default-style">
					<div class="span3">
						...
						<div class="controls">
							<a href="homepage-all.php#" class="prev"><span class="icon-chevron-left"></span></a>
							<a href="homepage-all.php#" class="complete"><span class="icon-th"></span></a>
							<a href="homepage-all.php#" class="next"><span class="icon-chevron-right"></span></a>
						</div>
					</div>
					<div class="span9">
				...
				</div><!-- end row // recentwork_carousel default-style -->
				...
				<div class="row">
					<div class="span12">
						<div class="recentwork_carousel style2">
							...
							<ul id="recent_works2" class="fixclear">
								<li>
									<a href="homepage-all.php#">
										<img src="images/site_images/recent_works/work1.jpg" alt="" />
										<div class="details">
								...
								<li>
									<a href="homepage-all.php#">
										<img src="images/site_images/recent_works/work5.jpg" alt="" />
										<div class="details">
											<span class="plus">+</span>
											<h4>Business cards project</h4>
											<span>Graphic Design</span>
						...
						</div><!-- end recent projects style2 -->
					</div>
				</div><!-- end row // recentwork_carousel style2 -->
				
				<div class="row">
					<div class="span12">
						<h3 class="m_title">OK! HERE'S HOW IT WORK</h3>
					</div>
					<div class="span4">
						<div class="gobox">
							<h4>Suspendisse porttitor faucibus</h4>
							<p>Suspendisse porttitor faucibus nunc, quis accumsan arcu posuere vel. Cras scelerisque, nulla a accumsan vestibulum, risus nunc mollis nisl, eu pulvinar justo nisl.</p>
						</div>
					</div>
					<div class="span4">
						<div class="gobox">
							<h4> Neque porro quisquam est</h4>
							<p>Suspendisse porttitor faucibus nunc, quis accumsan arcu posuere vel. Cras scelerisque, nulla a accumsan vestibulum, risus nunc mollis nisl, eu pulvinar.</p>
						</div>
					</div>
					<div class="span4">
						<div class="gobox ok ">
							...
							<h4>APPLY NOW!</h4>
							<p>Neque porro quisquam est Cras scelerisque, nulla a accumsan.</p>
						</div>
					</div>
				</div><!-- end row // goboxes -->
			...
			<div class="gray-area">
				<div class="container">
					<div class="row">
						<div class="span3">
							<div class="info-text">
								<strong>Temporibus autem</strong> quibusdam et aut officiis debitis aut.
							</div><!-- end // info-text-->
						</div>
						<div class="span3">
							<div class="testimonials-carousel">
								<h3 class="m_title">CLIENTS</h3>
								<div class="controls">
									<a href="homepage-all.php#" class="prev"><span class="icon-chevron-left"></span></a>
									<a href="homepage-all.php#" class="next"><span class="icon-chevron-right"></span></a>
								</div>
								<ul id="testimonials_carousel" class="fixclear">
									<li>
										<blockquote>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.</blockquote>
										<h5>Paul Simon // General Manager</h5>
									</li>
									<li>
										<blockquote>Suspendisse porttitor faucibus nunc, quis accumsan arcu posuere vel. Cras scelerisque, nulla a accumsan vestibulum, risus nunc mollis nisl, eu pulvinar.</blockquote>
										<h5>George Flint // Strategic Manager</h5>
									</li>
								</ul>
						...
						<div class="span3">
							<div class="flickrfeed loading">
								<h3 class="m_title">FLICKR FEED</h3>
								<ul class="flickr_feeds fixclear"></ul>
							</div><!-- end // flickrfeed -->
						</div>
						<div class="span3">
							<h4 class="circle_title"><span>WHO</span> WE ARE</h4>
							<p>Cras ut sem eget diam vehicula commod ut porttitor nibh.</p>
			...
			<div class="container">
				...
				<div class="row">
					<div class="span4">
						<a href="homepage-all.php#" class="hover-box fixclear">
							<img src="images/icons/hover-boxes/ico-getquote.png" alt="">
							<h3>GET A QUOTE!</h3>
					...
					<div class="span4">
						<a href="homepage-all.php#" class="hover-box centered fixclear">
							<h3>WE'RE HIRING!</h3>
							<h4>WEBDEVELOPER WANTED</h4>
							<p>Please send your cv’s on jobs@mywebsite.com</p>
						</a>
					</div>
					<div class="span4">
						<a href="homepage-all.php#" class="hover-box fixclear">
				...
				<div class="row">
					...
					<div class="span2">
						<a href="homepage-all.php#" class="circlehover with-symbol" data-size="" data-position="top-left" data-align="right">
							<span class="text">FIND OUT MORE</span>
							<span class="symbol"><img src="images/ok.png" alt=""></span>
						</a>
					</div>
				</div><!-- end row // circle hover -->
				
				<div class="row">
					<div class="span7">
						<h3 class="m_title">WELCOME TO KALLYAS Template</h3>
						<a href="homepage-all.php#" class="hoverBorder pull-right" style="margin-left:20px;"><img src="images/site_images/img6.jpg" alt=""></a>
...
Curabitur fringilla ipsum id quam lacinia venenatis.</p>
					...
					<div class="span12">
						<div class="screenshot-box fixclear">
							<div class="thescreenshot">
								<div class="controls"><a href="homepage-all.php#" class="prev"></a><a href="homepage-all.php#" class="next"></a></div>
								<ul id="screenshot-carousel" class="fixclear">
									<li><img src="images/site_images/scr-carousel/img1.jpg" alt=""></li>
									<li><img src="images/site_images/scr-carousel/img2.jpg" alt=""></li>
								</ul>
							</div>
							<div class="left-side">
								<h3 class="title">KALLYAS Template is an all in one product with lots of goodies and modern features.</h3>
								<ul class="features">
									<li>
										<h4>SHORTCODE SYSTEM</h4>
										<span>Built for easing up your work</span>
									</li>
									<li>
										<h4>UNLIMITED COLORS</h4>
										<span>You can personalize the theme’s colors</span>
									</li>
									<li>
										<h4>HIGHLY CUSTOMIZABLE</h4>
										<span>With lot's of different features.</span>
									</li>
								</ul>
								<a href="homepage-all.php#" class="btn btn-large btn-flat redbtn">BUY THIS TEMPLATE ~ 15$</a>
							</div>
							
						</div><!-- end screenshot-box -->
					</div>
				</div><!-- end row // screenshotbox -->
				
				<div class="row testimonials_fader">
					<div class="span3">
						<h3 class="m_title">TESTIMONIALS</h3>
						<p>What do our Customers saying about us?</p>
					</div>
					<div class="span9">
						<ul id="testimonials_fader" class="fixclear">
							<li>
								...
								<h6>Paul Simon // General Manager</h6>
							</li>
							<li>
								<blockquote>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum.</blockquote>
								<h6>Andrew Smith // Strategic Coordinator</h6>
							</li>
						</ul>
					</div>
				...
				</div><!-- end row // testimonials boxes -->
					...
					<div class="span12">
						<div class="vertical_tabs">
							<div class="tabbable">
								<ul class="nav fixclear">
									<li class="active">
										<a href="homepage-all.php#tabs_i2-pane1" data-toggle="tab">
										<span><span class="icon-comment icon-white"></span></span>
										CUSTOMER SUPPORT</a>
									</li>
									<li>
										<a href="homepage-all.php#tabs_i2-pane2" data-toggle="tab">
										<span><span class="icon-book icon-white"></span></span>
										WELL DOCUMENTED</a>
									</li>
									<li>
										<a href="homepage-all.php#tabs_i2-pane3" data-toggle="tab">
										<span><span class="icon-tint icon-white"></span></span>
										UNLIMITED COLORS</a>
									</li>
									<li>
										<a href="homepage-all.php#tabs_i2-pane4" data-toggle="tab">
										<span><span class="icon-align-left icon-white"></span></span>
										CUSTOM SHORTCODES</a>
									</li>
									<li>
										<a href="homepage-all.php#tabs_i2-pane5" data-toggle="tab">
										<span><span class="icon-wrench icon-white"></span></span>
										HIGHLY CUSTOMISABLE</a>
									</li>
								</ul>
								<div class="tab-content">
									<div class="tab-pane active" id="tabs_i2-pane1">
										<h4>Support is given through a well organized forum</h4>
										<img src="images/site_images/support.jpg" alt="" class="pull-right" style="margin:0 0 0 15px;">
				...
				<div class="row">
					<div class="span12">
						<h3 class="mb_title"><img src="images/icons/ico-stats.png" alt=""> STATS</h3>
					</div>
					<div class="span3">
						<div class="statbox">
					...
					<div class="span3">
						<div class="statbox">
							<img src="images/icons/stats/ico-code-lines.png" alt="">
							<h4>2500+</h4>
							<h6>CODE LINES THIS MONTH</h6>
						</div>
					</div>
					<div class="span3">
						<div class="statbox">
							<img src="images/icons/stats/ico-working-hours.png" alt="">
							<h4>1400+</h4>
							<h6>WORKING HOURS THIS YEAR</h6>
						</div>
					</div>
					<div class="span3">
						<div class="statbox">
	...
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="homepage-all.php#">Curabitur iaculis</a></li>
					<li><a href="homepage-all.php#">Parturient montes</a></li>
					<li><a href="homepage-all.php#">Vulputate magna</a></li>
					<li><a href="homepage-all.php#">Cum sociis natoque</a></li>
					<li><a href="homepage-all.php#">Nulla varius commodo</a></li>
					<li><a href="homepage-all.php#">Parturient montes</a></li>
					<li><a href="homepage-all.php#">Vulputate magna</a></li>
					<li><a href="homepage-all.php#">Cum sociis natoque</a></li>
					<li><a href="homepage-all.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="homepage-all.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="homepage-all.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="homepage-all.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="homepage-all.php#">Facebook</a></li>
						<li class="social-envato"><a href="homepage-all.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
	...
	<a href="homepage-all.php#" id="totop">TOP</a>
...
<link rel="stylesheet" href="css/template.css.php?src=..%252Faddons%252Fdemo_panel%252Fdemo_panel" type="text/css" />
