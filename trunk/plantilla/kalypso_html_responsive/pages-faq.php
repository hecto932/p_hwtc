...
<head>
	<title>FAQ | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="pages-faq.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="pages-faq.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="pages-faq.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="pages-faq.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="pages-faq.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="pages-faq.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="pages-faq.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="pages-faq.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="pages-faq.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="pages-faq.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="pages-faq.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="pages-faq.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="pages-faq.php#">French</a></li>
								<li><a href="pages-faq.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="pages-faq.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="pages-faq.php#">SLIDERS</a>
							<ul>
								<li><a href="pages-faq.php#">Main Slider</a>
									<ul>
						...
						<li><a href="pages-faq.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="pages-faq.php#">Portfolio</a>
									<ul>
								...
								<li><a href="pages-faq.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="pages-faq.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="pages-faq.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="pages-faq.php#">PAGES</a>
							<ul>
						...
						<li><a href="pages-faq.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="pages-faq.php#">HOME</a></li>
							<li>PAGES</li>
							<li>FAQ</li>
						</ul>
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span12">
							...
							<p>Select one of the above questions to find out it's answer. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc congue neque felis, non elementum metus. Duis laoreet ante vitae tortor imperdiet euismod. Morbi mollis pharetra consequat. Curabitur a est purus. </p>
							
							<h3>GENERAL QUESTIONS</h3>
							
							<div class="acc-group style3">
								<button data-toggle="collapse" data-target="#acc4" class="collapsed">Vivamus ut molestie nulla. Aenean vel tortor velit.</button>
							...
							<div class="acc-group style3">
								<button data-toggle="collapse" data-target="#acc5" class="collapsed">Duis aute irure dolor in reprehenderit in voluptate.</button>
							...
							<div class="acc-group style3">
								<button data-toggle="collapse" data-target="#acc6" class="collapsed">Neque porro quisquam est qui dolorem.</button>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="pages-faq.php#">Curabitur iaculis</a></li>
					<li><a href="pages-faq.php#">Parturient montes</a></li>
					<li><a href="pages-faq.php#">Vulputate magna</a></li>
					<li><a href="pages-faq.php#">Cum sociis natoque</a></li>
					<li><a href="pages-faq.php#">Nulla varius commodo</a></li>
					<li><a href="pages-faq.php#">Parturient montes</a></li>
					<li><a href="pages-faq.php#">Vulputate magna</a></li>
					<li><a href="pages-faq.php#">Cum sociis natoque</a></li>
					<li><a href="pages-faq.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="pages-faq.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="pages-faq.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="pages-faq.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="pages-faq.php#">Facebook</a></li>
						<li class="social-envato"><a href="pages-faq.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="pages-faq.php#" id="totop">TOP</a>
