...
<head>
	<title>About us | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="about-us.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="about-us.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="about-us.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="about-us.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="about-us.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="about-us.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="about-us.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="about-us.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="about-us.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="about-us.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="about-us.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="about-us.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="about-us.php#">French</a></li>
								<li><a href="about-us.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="about-us.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="about-us.php#">SLIDERS</a>
							<ul>
								<li><a href="about-us.php#">Main Slider</a>
									<ul>
						...
						<li><a href="about-us.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="about-us.php#">Portfolio</a>
									<ul>
								...
								<li><a href="about-us.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="about-us.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="about-us.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="about-us.php#">PAGES</a>
							<ul>
						...
						<li><a href="about-us.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					...
					<div class="span6">
						<div class="header-titles">
							<h2>ABOUT US</h2>
							<h4>Learn more about us and our company</h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
						...
						<div class="span12">
							...
							<div id="skills_diagram">
								<div class="legend">
									<h4>Legend:</h4>
									<ul class="skills">
										<li data-percent="95" style="background-color:#97BE0D;">JavaScript</li>
										<li data-percent="90" style="background-color:#D84F5F;">CSS3</li>
										<li data-percent="80" style="background-color:#88B8E6;">HTML5</li>
										<li data-percent="53" style="background-color:#BEDBE9;">PHP</li>
										<li data-percent="45" style="background-color:#EDEBEE;">MySQL</li>
									</ul><!-- end the skills -->
								</div>
								<div id="thediagram" data-width="600" data-height="600" data-maincolor="#193340" data-maintext="Skills" data-fontsize="20px Arial" data-textcolor="#ffffff"></div>
								<script type="text/javascript" src="http://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
								<script type="text/javascript" src="addons/raphael_diagram/init.js"></script>
							</div><!-- end skills diagram -->
							
							<p><a href="about-us.php#" class="hoverBorder pull-left" style="margin-right: 15px; margin-bottom: 12px;"><img src="images/aboutus.jpg" width="200" height="134" alt="About us"  /></a></p>
							...
							<blockquote>
								...
								<small>BRIAN NUNN - <cite title="Source Title">Company CEO</cite></small>
							</blockquote>
							<p></p>
						</div>
					</div><!-- end row -->
							...
							<div class="vertical_tabs">
								<div class="tabbable">
									<ul class="nav fixclear">
										<li class="active">
											<a href="about-us.php#tabs_i2-pane1" data-toggle="tab">
											<span><span class="icon-comment icon-white"></span></span>
											CUSTOMER SUPPORT</a>
										</li>
										<li>
											<a href="about-us.php#tabs_i2-pane2" data-toggle="tab">
											<span><span class="icon-book icon-white"></span></span>
											WELL DOCUMENTED</a>
										</li>
										<li>
											<a href="about-us.php#tabs_i2-pane3" data-toggle="tab">
											<span><span class="icon-tint icon-white"></span></span>
											UNLIMITED COLORS</a>
										</li>
										<li>
											<a href="about-us.php#tabs_i2-pane4" data-toggle="tab">
											<span><span class="icon-align-left icon-white"></span></span>
											CUSTOM SHORTCODES</a>
										</li>
										<li>
											<a href="about-us.php#tabs_i2-pane5" data-toggle="tab">
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="about-us.php#">Curabitur iaculis</a></li>
					<li><a href="about-us.php#">Parturient montes</a></li>
					<li><a href="about-us.php#">Vulputate magna</a></li>
					<li><a href="about-us.php#">Cum sociis natoque</a></li>
					<li><a href="about-us.php#">Nulla varius commodo</a></li>
					<li><a href="about-us.php#">Parturient montes</a></li>
					<li><a href="about-us.php#">Vulputate magna</a></li>
					<li><a href="about-us.php#">Cum sociis natoque</a></li>
					<li><a href="about-us.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="about-us.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="about-us.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="about-us.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="about-us.php#">Facebook</a></li>
						<li class="social-envato"><a href="about-us.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="about-us.php#" id="totop">TOP</a>
