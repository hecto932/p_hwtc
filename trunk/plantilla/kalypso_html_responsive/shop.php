...
<head>
	<title>SHOP | KALLYAS Template</title>
		<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="shop.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="shop.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="shop.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="shop.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="shop.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="shop.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="shop.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="shop.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="shop.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="shop.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="shop.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="shop.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="shop.php#">French</a></li>
								<li><a href="shop.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="shop.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="shop.php#">SLIDERS</a>
							<ul>
								<li><a href="shop.php#">Main Slider</a>
									<ul>
						...
						<li><a href="shop.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="shop.php#">Portfolio</a>
									<ul>
								...
								<li><a href="shop.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="shop.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="shop.php#">Holiday Slides</a>
									<ul>
				...
				<div class="slider">
                    ...
                    <div class = "item">
                        ...
                        <div class="caption style1">
							...
							<a href="shop.php#" class="more"><img src="sliders/iosslider/arr01.png" alt=""></a>
			...
			<div class="container">
				<div class="row">
					...
					<div class="span4 align-center">
						<a href="shop.php#" class="btn">JOIN OUR NEWSLETTER</a>
					</div>
				</div>
			</div>
		</div><!-- end action box -->        
		<section id="content">
			<div class="container">
				...
				<div class="row offer-banners">
					<div class="span12">
						<h3 class="m_title">SOME OF OUR LATEST OFFERS</h3>
					</div>

					<div class="span4">
						<a href="shop.php#" class="hoverBorder"><img src="images/offers/bnr1.jpg" alt=""></a>
					</div>
					<div class="span5">
						<a href="shop.php#" class="hoverBorder"><img src="images/offers/bnr2.jpg" alt=""></a>
					</div>
					<div class="span3">
						<a href="shop.php#" class="hoverBorder"><img src="images/offers/bnr3.jpg" alt=""></a>
						<a href="shop.php#" class="hoverBorder"><img src="images/offers/bnr4.jpg" alt=""></a>
					</div>
					
				</div><!-- end row // offer banners -->	
						...
						<div class="shop-latest">
							...
							<div class="tabbable">
								...
								<ul class="nav fixclear">
									<li class="active"><a href="shop.php#tabpan1" data-toggle="tab">LATEST PRODUCTS</a></li>
									<li><a href="shop.php#tabpan2" data-toggle="tab">BEST SELLING PRODUCTS</a></li>
								</ul>
								...
								<div class="tab-content">
									<div class="tab-pane active" id="tabpan1">
										...
										<div class="shop-latest-carousel">
											<ul id="latest_products">
												<li>
													<div class="product-list-item">
														...
														<div class="image">
															<a href="pages-productitem.php"><img src="images/shop_images/img1.png" alt=""></a>
														</div>
														<div class="details fixclear">
															<h3>SOME AWESOME PRODUCT</h3>
															<p class="desc">Lorem ipsum dolor sit amet, sectetuer adipiscing elit....</p>
															<div class="actions">
																<a href="shop.php#">ADD TO CART</a>
																<a href="pages-productitem.php">MORE INFO</a>
															</div>
															<div class="price">
																<span>$129,99</span>
																<small>$199</small>
												...
												<li>
													<div class="product-list-item">
														<span class="hover"></span>
														<div class="image">
															<a href="pages-productitem.php"><img src="images/shop_images/img2.png" alt=""></a>
														</div>
														<div class="details fixclear">
															<h3>SOME AWESOME PRODUCT</h3>
															<p class="desc">Lorem ipsum dolor sit amet, sectetuer adipiscing elit....</p>
												...
												<li>
													<div class="product-list-item promo-new">
														<span class="hover"></span>
														<div class="image">
															<a href="pages-productitem.php"><img src="images/shop_images/img3.png" alt=""></a>
														</div>
														<div class="details fixclear">
															<h3>SOME AWESOME PRODUCT</h3>
															<p class="desc">Lorem ipsum dolor sit amet, sectetuer adipiscing elit....</p>
												...
												<li>
													<div class="product-list-item promo-sale">
														<span class="hover"></span>
														<div class="image">
															<a href="pages-productitem.php"><img src="images/shop_images/img4.png" alt=""></a>
														</div>
														<div class="details fixclear">
															<h3>SOME AWESOME PRODUCT</h3>
															<p class="desc">Lorem ipsum dolor sit amet, sectetuer adipiscing elit....</p>
												...
												<li>
													<div class="product-list-item">
														<span class="hover"></span>
														<div class="image">
															<a href="pages-productitem.php"><img src="images/shop_images/img5.png" alt=""></a>
														</div>
														<div class="details fixclear">
															<h3>SOME AWESOME PRODUCT</h3>
															<p class="desc">Lorem ipsum dolor sit amet, sectetuer adipiscing elit....</p>
											...
											<div class="controls">
												<a href="shop.php#" class="prev"><span class="icon-chevron-left"></span></a>
												<a href="shop.php#" class="next"><span class="icon-chevron-right"></span></a>
											</div>
											<div class="clear"></div>
				...
				<div class="row">
					<div class="span8">
						<h3 class="m_title">LIMITED OFFERS</h3>
						<div class="limited-offers-carousel fixclear">
							<ul id="limited_offers">
								<li data-discount="35%">
									<div class="image"><img src="php_helpers/timthumb.php?src=images%252Fshop_images%252Fimg1.png&amp;h=90&amp;zc=1" alt=""></div>
									<h5><a href="pages-productitem.php">MP3 Player</a></h5>
									<h6>$129,99</h6>
								</li>
								<li data-discount="20%">
									<div class="image"><img src="php_helpers/timthumb.php?src=images%252Fshop_images%252Fimg1.png&amp;h=90&amp;zc=1" alt=""></div>
					...
					<div class="span4">
						<div class="adbox video">
							<img src="images/cool-ad.jpg" alt="">
							<div class="video_trigger_container">
								<a class="playVideo" data-rel="prettyPhoto" href="http://vimeo.com/51882148?width=80%&amp;height=80%"></a>
								CHECK OUT THIS AD
							</div><!-- end video div -->
						</div>
					</div>
				...
				<div class="row partners_carousel">
					<div class="span2">
						<h4 class="m_title">SHOP BY BRAND</h5>
						<div class="controls">
							<a href="shop.php#" class="prev"><span class="icon-chevron-left"></span></a>
							<a href="shop.php#" class="next"><span class="icon-chevron-right"></span></a>
						</div>
					...
					<div class="span10">
						<ul id="partners_carousel" class="fixclear">
							<li><a href="shop.php#"><img src="images/partners/css3.png" alt="" /></a></li>
							<li><a href="shop.php#"><img src="images/partners/html5.png" alt="" /></a></li>
							<li><a href="shop.php#"><img src="images/partners/joomla.png" alt="" /></a></li>
							<li><a href="shop.php#"><img src="images/partners/wordpress.png" alt="" /></a></li>
							<li><a href="shop.php#"><img src="images/partners/themeforest.png" alt="" /></a></li>
							<li><a href="shop.php#"><img src="images/partners/jquery.png" alt="" /></a></li>
						</ul>
					</div>
				...
				<div class="row shop-features">
					...
					<div class="span3">
						<div class="shop-feature">
							<img src="images/shop_images/icons/shop-icon1.png" alt="">
							<h4>31 DAYS</h4>
							<h5>RETURN POLICY</h5>
						</div><!-- end shop feature -->
					</div>
					<div class="span3">
						<div class="shop-feature">
							<img src="images/shop_images/icons/shop-icon2.png" alt="">
							<h4>FREE AND FAST</h4>
							<h5>DELIVERY</h5>
						</div><!-- end shop feature -->
					</div>
					<div class="span3">
						<div class="shop-feature">
							<img src="images/shop_images/icons/shop-icon3.png" alt="">
							<h4>BEST PRICE</h4>
							<h5>GUARANTEED</h5>
						</div><!-- end shop feature -->
					</div>
				</div><!-- end row // shop-features -->
			</div>
		</div><!-- end gray area -->
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="shop.php#">Curabitur iaculis</a></li>
					<li><a href="shop.php#">Parturient montes</a></li>
					<li><a href="shop.php#">Vulputate magna</a></li>
					<li><a href="shop.php#">Cum sociis natoque</a></li>
					<li><a href="shop.php#">Nulla varius commodo</a></li>
					<li><a href="shop.php#">Parturient montes</a></li>
					<li><a href="shop.php#">Vulputate magna</a></li>
					<li><a href="shop.php#">Cum sociis natoque</a></li>
					<li><a href="shop.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="shop.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="shop.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="shop.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="shop.php#">Facebook</a></li>
						<li class="social-envato"><a href="shop.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="shop.php#" id="totop">TOP</a>
...
;(function($) {
	$(window).load(function(){
		...
		$('#limited_offers').carouFredSel({
			...
			scroll: 1,
			auto: true,
			items: {width:158, visible: { min: 1, max: 4 } },
