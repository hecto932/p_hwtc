...
<head>
	<title>Accordion styles | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="styles-accordion.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="styles-accordion.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="styles-accordion.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="styles-accordion.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="styles-accordion.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="styles-accordion.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="styles-accordion.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="styles-accordion.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="styles-accordion.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="styles-accordion.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="styles-accordion.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="styles-accordion.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="styles-accordion.php#">French</a></li>
								<li><a href="styles-accordion.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="styles-accordion.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="styles-accordion.php#">SLIDERS</a>
							<ul>
								<li><a href="styles-accordion.php#">Main Slider</a>
									<ul>
						...
						<li><a href="styles-accordion.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="styles-accordion.php#">Portfolio</a>
									<ul>
								...
								<li><a href="styles-accordion.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="styles-accordion.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="styles-accordion.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="styles-accordion.php#">PAGES</a>
							<ul>
						...
						<li><a href="styles-accordion.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="styles-accordion.php#">HOME</a></li>
							<li>STYLES</li>
							<li>ACCORDION</li>
						</ul>
					...
					<div class="span6">
						<div class="header-titles">
							...
							<h4>Javascript Accordions with nice stylings</h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
		...
		<section id="content">
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span12">
							<h1 class="page-title">Accordions Designs</h1>
...
<!-- ////// start examples -->
	...
	<p>The example above has the <code>class="acc-group default-style"</code>, where <strong>default-style</strong> has the styling.</p>
...
&lt;div class=&quot;acc-group default-style&quot;&gt;
  &lt;button data-toggle=&quot;collapse&quot; data-target=&quot;#acc_ID&quot; class=&quot;collapsed&quot;&gt;.. Content of trigger ..&lt;/button&gt;
  &lt;div id=&quot;acc3&quot; class=&quot;collapse in&quot;&gt;
    &lt;div class=&quot;content&quot;&gt;
...
&lt;/div&gt;
	...
	<p>The example above has the <code>class="acc-group style2"</code>, where <strong>style2</strong> has the styling.</p>

	<div class="acc-group style2">
		<button data-toggle="collapse" data-target="#acc4" class="collapsed btn-link">Vivamus ut molestie nulla. Aenean vel tortor velit.</button>
	...
	<div class="acc-group style2">
		<button data-toggle="collapse" data-target="#acc5" class="collapsed btn-link">Duis aute irure dolor in reprehenderit in voluptate.</button>
	...
	<div class="acc-group style2">
		<button data-toggle="collapse" data-target="#acc6" class="collapsed btn-link">Neque porro quisquam est qui dolorem.</button>
	...
	<h2>Alternative styles:</h2>
	<p>The example above has the <code>class="acc-group style3"</code>, where <strong>style3</strong> has the styling.</p>

	<div class="acc-group style3">
		<button data-toggle="collapse" data-target="#acc7" class="collapsed">Vivamus ut molestie nulla. Aenean vel tortor velit.</button>
	...
	<div class="acc-group style3">
		<button data-toggle="collapse" data-target="#acc8" class="collapsed">Duis aute irure dolor in reprehenderit in voluptate.</button>
		<div id="acc8" class="collapse in">
			<div class="content">
				<p>Vivamus ut molestie nulla. Aenean vel tortor velit. Morbi quis varius tortor. Quisque sit amet leo purus, eget accumsan lorem.<br> Curabitur fringilla ipsum id quam lacinia venenatis. </p>
			</div><!-- end content -->
		</div>
	...
	<div class="acc-group style3">
		<button data-toggle="collapse" data-target="#acc9" class="collapsed">Neque porro quisquam est qui dolorem.</button>
		<div id="acc9" class="collapse in">
			<div class="content">
				<p>Vivamus ut molestie nulla. Aenean vel tortor velit. Morbi quis varius tortor. Quisque sit amet leo purus, eget accumsan lorem.<br> Curabitur fringilla ipsum id quam lacinia venenatis. </p>
			</div><!-- end content -->
		</div>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="styles-accordion.php#">Curabitur iaculis</a></li>
					<li><a href="styles-accordion.php#">Parturient montes</a></li>
					<li><a href="styles-accordion.php#">Vulputate magna</a></li>
					<li><a href="styles-accordion.php#">Cum sociis natoque</a></li>
					<li><a href="styles-accordion.php#">Nulla varius commodo</a></li>
					<li><a href="styles-accordion.php#">Parturient montes</a></li>
					<li><a href="styles-accordion.php#">Vulputate magna</a></li>
					<li><a href="styles-accordion.php#">Cum sociis natoque</a></li>
					<li><a href="styles-accordion.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="styles-accordion.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="styles-accordion.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="styles-accordion.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="styles-accordion.php#">Facebook</a></li>
						<li class="social-envato"><a href="styles-accordion.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="styles-accordion.php#" id="totop">TOP</a>
