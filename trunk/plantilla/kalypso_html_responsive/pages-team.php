...
<head>
	<title>TEAM | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="pages-team.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="pages-team.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="pages-team.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="pages-team.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="pages-team.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="pages-team.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="pages-team.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="pages-team.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="pages-team.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="pages-team.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="pages-team.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="pages-team.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="pages-team.php#">French</a></li>
								<li><a href="pages-team.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="pages-team.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="pages-team.php#">SLIDERS</a>
							<ul>
								<li><a href="pages-team.php#">Main Slider</a>
									<ul>
						...
						<li><a href="pages-team.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="pages-team.php#">Portfolio</a>
									<ul>
								...
								<li><a href="pages-team.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="pages-team.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="pages-team.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="pages-team.php#">PAGES</a>
							<ul>
						...
						<li><a href="pages-team.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="pages-team.php#">HOME</a></li>
							<li>PAGES</li>
							<li>TEAM</li>
						</ul>
					...
					<div class="span6">
						<div class="header-titles">
							<h2>OUR TEAM</h2>
							<h4>This is our wonderful team</h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
		...
		<section id="content">
			<div class="container">
				...
				<div id="mainbody">
							...
							<div class="row">
								<div class="span3">
									<div class="team_member">
										<a href="pages-team.php#" class="grayHover">
											<img src="images/team/team1.jpg" alt="">
										</a>
										<h4>CAROL NUNN</h4>
										<h6>Art Director &amp; CFO</h6>
										<div class="details">
											<div class="desc">
												<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
												<p>Email: carol.nunn@thedomain.com<br>
												Phone: 44 555 33 66</p>
											</div>
											<ul class="social-icons colored fixclear">
												<li class="social-twitter"><a href="pages-team.php#">Twitter</a></li>
												<li class="social-dribbble"><a href="pages-team.php#">Dribbble</a></li>
												<li class="social-facebook"><a href="pages-team.php#">Facebook</a></li>
											</ul>
										</div><!-- end details -->
									</div><!-- end team_member -->
								</div>
								<div class="span3">
									<div class="team_member">
										...
										<h4>BRIAN NUNN</h4>
										<h6>Strategic Manager &amp; CFO</h6>
										<div class="details">
											<div class="desc">
												<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
												<p>Email: brian.nunn@thedomain.com<br>
												Phone: 44 555 33 66</p>
											</div>
											<ul class="social-icons colored fixclear">
												<li class="social-twitter"><a href="pages-team.php#">Twitter</a></li>
												<li class="social-gplus"><a href="pages-team.php#">gplus</a></li>
												<li class="social-facebook"><a href="pages-team.php#">Facebook</a></li>
											</ul>
										</div><!-- end details -->
									</div><!-- end team_member -->
								...
								<div class="span3">
									<div class="team_member">
										...
										<div class="details">
											<div class="desc">
												<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
												<p>Email: carolyn.james@thedomain.com<br>
												Phone: 44 555 33 66</p>
											</div>
											<ul class="social-icons colored fixclear">
												<li class="social-twitter"><a href="pages-team.php#">Twitter</a></li>
												<li class="social-skype"><a href="pages-team.php#">skype</a></li>
											</ul>
										</div><!-- end details -->
									</div><!-- end team_member -->
								</div>
								<div class="span3">
									<div class="team_member">
										...
										<h4>GERALDO WALKER</h4>
										<h6>Project Manager</h6>
										<div class="details">
											<div class="desc">
												<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
												<p>Email: geraldo.walker@thedomain.com<br>
												Phone: 44 555 33 66</p>
											</div>
											<ul class="social-icons colored fixclear">
												<li class="social-twitter"><a href="pages-team.php#">Twitter</a></li>
												<li class="social-wordpress"><a href="pages-team.php#">wordpress</a></li>
												<li class="social-apple"><a href="pages-team.php#">apple</a></li>
											</ul>
										</div><!-- end details -->
									</div><!-- end team_member -->
								</div>
							...
							<div class="row">
								<div class="span3">
									<div class="team_member">
										...
										<div class="details">
											<div class="desc">
												<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
												<p>Email: warren.mathis@thedomain.com<br>
												Phone: 44 555 33 66</p>
											</div>
											<ul class="social-icons colored fixclear">
												<li class="social-twitter"><a href="pages-team.php#">Twitter</a></li>
								...
								<div class="span3">
									<div class="team_member">
										...
										<div class="details">
											<div class="desc">
												<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
												<p>Email: cheri.roberts@thedomain.com<br>
												Phone: 44 555 33 66</p>
											</div>
											<ul class="social-icons colored fixclear">
												<li class="social-twitter"><a href="pages-team.php#">Twitter</a></li>
								...
								<div class="span3">
									<div class="team_member">
										...
										<h4>JESSICA VERNON</h4>
										<h6>Office Manager</h6>
										<div class="details">
											<div class="desc">
												<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
												<p>Email: jessica.vernon@thedomain.com<br>
												Phone: 44 555 33 66</p>
											</div>
											<ul class="social-icons colored fixclear">
												<li class="social-twitter"><a href="pages-team.php#">Twitter</a></li>
								...
								<div class="span3">
									<div class="team_member">
										<a href="pages-team.php#" class="grayHover">
											<img src="images/team/team8.jpg" alt="">
										</a>
										<h4>ALDO JOHNSON</h4>
										<h6>Code Master</h6>
										<div class="details">
											<div class="desc">
												<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
												<p>Email: aldo.johnson@thedomain.com<br>
												Phone: 44 555 33 66</p>
											</div>
											<ul class="social-icons colored fixclear">
												<li class="social-twitter"><a href="pages-team.php#">Twitter</a></li>
												<li class="social-github"><a href="pages-team.php#">github</a></li>
											</ul>
										</div><!-- end details -->
									</div><!-- end team_member -->
								</div>
					...
					<div class="row">
						<div class="span12">
							<h4 class="smallm_title centered bigger"><span>THIS IS OUR FANCY OFFICE</span></h4>
						</div>
						<div class="span4">
							<a href="images/team/office/office1.jpg" class="hoverBorder" rel="prettyPhoto"><img src="php_helpers/timthumb.php?src=images%252Fteam%252Foffice%252Foffice1.jpg&amp;w=370" alt=""></a>
						</div>
						<div class="span4">
							<a href="images/team/office/office2.jpg" class="hoverBorder" rel="prettyPhoto"><img src="php_helpers/timthumb.php?src=images%252Fteam%252Foffice%252Foffice2.jpg&amp;w=370" alt=""></a>
						</div>
						<div class="span4">
							<a href="images/team/office/office3.jpg" class="hoverBorder" rel="prettyPhoto"><img src="php_helpers/timthumb.php?src=images%252Fteam%252Foffice%252Foffice3.jpg&amp;w=370" alt=""></a>
						</div>
					</div>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="pages-team.php#">Curabitur iaculis</a></li>
					<li><a href="pages-team.php#">Parturient montes</a></li>
					<li><a href="pages-team.php#">Vulputate magna</a></li>
					<li><a href="pages-team.php#">Cum sociis natoque</a></li>
					<li><a href="pages-team.php#">Nulla varius commodo</a></li>
					<li><a href="pages-team.php#">Parturient montes</a></li>
					<li><a href="pages-team.php#">Vulputate magna</a></li>
					<li><a href="pages-team.php#">Cum sociis natoque</a></li>
					<li><a href="pages-team.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="pages-team.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-dribbble"><a href="pages-team.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="pages-team.php#">Facebook</a></li>
						<li class="social-envato"><a href="pages-team.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="pages-team.php#" id="totop">TOP</a>
