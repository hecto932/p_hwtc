...
<head>
	<title>Circular Content Carousel - Default | KALLYAS Template</title>
		<meta charset="utf-8">
...
<!-- Start Circular Content Carousel code -->
	...
	<link rel="stylesheet" type="text/css" href="sliders/circular_content_carousel/css/circular_content_carousel_alternative.css" />
	<style type="text/css">
	.ca-item-1 .background {background-image:url(images/sliders/circular_carousel_alternative/pic1.jpg);}
	.ca-item-1 .title_circle {right: 15px; top: 170px;} 
	
	.ca-item-2 .background {background-image:url(images/sliders/circular_carousel_alternative/pic2.jpg);}
	.ca-item-2 .title_circle {left: 10px; top: 200px;}
	
	.ca-item-3 .background {background-image:url(images/sliders/circular_carousel_alternative/pic3.jpg);}
	.ca-item-3 .title_circle {left: 190px; top: 180px;}
	
	.ca-item-4 .background {background-image:url(images/sliders/circular_carousel_alternative/pic4.jpg);}
	.ca-item-4 .title_circle {right: 15px; top: 270px;}
	
	.ca-item-5 .background {background-image:url(images/sliders/circular_carousel_alternative/pic5.jpg);}
	.ca-item-5 .title_circle {left: 190px; top: 180px;}
	</style>
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="slider-circularcontent-alternative.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="slider-circularcontent-alternative.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="slider-circularcontent-alternative.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="slider-circularcontent-alternative.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="slider-circularcontent-alternative.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="slider-circularcontent-alternative.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="slider-circularcontent-alternative.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="slider-circularcontent-alternative.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="slider-circularcontent-alternative.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="slider-circularcontent-alternative.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="slider-circularcontent-alternative.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="slider-circularcontent-alternative.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="slider-circularcontent-alternative.php#">French</a></li>
								<li><a href="slider-circularcontent-alternative.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="slider-circularcontent-alternative.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="slider-circularcontent-alternative.php#">SLIDERS</a>
							<ul>
								<li><a href="slider-circularcontent-alternative.php#">Main Slider</a>
									<ul>
						...
						<li><a href="slider-circularcontent-alternative.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="slider-circularcontent-alternative.php#">Portfolio</a>
									<ul>
								...
								<li><a href="slider-circularcontent-alternative.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="slider-circularcontent-alternative.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="slider-circularcontent-alternative.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="slider-circularcontent-alternative.php#">PAGES</a>
							<ul>
						...
						<li><a href="slider-circularcontent-alternative.php#">STYLES</a>
							<ul>
                    ...
                    <div class="ca-wrapper">
                        ...
                        <div class="ca-item ca-item-1">
                            <div class="ca-item-main">
                                ...
                                <div class="title_circle" data-position="top-left" data-size="medium">
									<span>AN <strong>AWESOME</strong> PRODUCT HERE</span>
								</div>
                                <a href="slider-circularcontent-alternative.php#" class="ca-more">MORE <span class="icon-chevron-right icon-white"></span></a>
                                <span class="ca-starting">starting from <strong>$299</strong></span>
                            </div><!-- end ca-item-main -->
                            <div class="ca-content-wrapper">
                                <div class="ca-content">
                                    <h6>YES, AN AWESOME NEW PRODUCT</h6>
                                    <a href="slider-circularcontent-alternative.php#" class="ca-close"><span class="icon-remove"></span></a>
                                    <div class="ca-content-text">
                                        <p><img src="http://www.placehold.it/280x168"  class="img-polaroid pull-left" style="margin:0 20px 10px 0" alt=""> Donec adipiscing diam non augue suscipit in vulputate ligula vestibulum. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Aliquam vehicula vulputate scelerisque. Sed nec sodales sem.</p>
                                        <p> Morbi pharetra viverra congue. Donec imperdiet eleifend varius. Quisque turpis tellus, imperdiet vel mollis quis, adipiscing sit amet est. Sed suscipit urna non felis mollis aliquam quis id lacus. Curabitur ut est vitae ante rutrum mollis id vitae nisi.</p>
                                        <p>Mauris malesuada erat a magna egestas rutrum id at diam. Nulla pharetra lacinia est, at rhoncus dui dapibus eu. Aliquam sit amet diam libero. Integer urna dui, ultricies ac suscipit vitae, convallis ut tellus. Etiam ut justo nibh. </p>
                                        <p>Donec adipiscing diam non augue suscipit in vulputate ligula vestibulum. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Aliquam vehicula vulputate scelerisque. Sed nec sodales sem.</p>
                                    </div>
                                    <ul>
                                        <li><a href="slider-circularcontent-alternative.php#">Read more</a></li>
                        ...
                        <div class="ca-item ca-item-2">
                            <div class="ca-item-main">
								...
								<div class="title_circle" data-position="top-right">
									<span>AN <strong>AWESOME</strong> PRODUCT HERE</span>
								</div>
                                <a href="slider-circularcontent-alternative.php#" class="ca-more">MORE <span class="icon-chevron-right icon-white"></span></a>
                                <span class="ca-starting">starting from <strong>$299</strong></span>
                            ...
                            <div class="ca-content-wrapper">
                                <div class="ca-content">
									...
									<ul class="links">
                                        ...
                                        <li><a href="slider-circularcontent-alternative.php#"><span class="icon-shopping-cart icon-white"></span>add to cart</a></li>
                                        <li><a href="slider-circularcontent-alternative.php#"><span class="icon-plus-sign icon-white"></span>more details</a></li>
									</ul>
                                </div> 
                            </div><!-- end ca-content-wrapper -->
                        </div><!-- end ca-item -->
                        ...
                        <div class="ca-item ca-item-3">
                            <div class="ca-item-main">
								...
								<div class="title_circle" data-position="top-left" data-size="small">
									<span>AN <strong>AWESOME</strong> PRODUCT HERE</span>
								</div>
                                <a href="slider-circularcontent-alternative.php#" class="ca-more">MORE <span class="icon-chevron-right icon-white"></span></a>
                                <span class="ca-starting">starting from <strong>$299</strong></span>
                            ...
                            <div class="ca-content-wrapper">
                                <div class="ca-content">
                                    ...
                                    <a href="slider-circularcontent-alternative.php#" class="ca-close"><span class="icon-remove"></span></a>
                                    <div class="ca-content-text">
                                        <p>Donec adipiscing diam non augue suscipit in vulputate ligula vestibulum. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Aliquam vehicula vulputate scelerisque. Sed nec sodales sem. Morbi pharetra viverra congue. Donec imperdiet eleifend varius. Quisque turpis tellus, imperdiet vel mollis quis, adipiscing sit amet est. Sed suscipit urna non felis mollis aliquam quis id lacus. Curabitur ut est vitae ante rutrum mollis id vitae nisi.</p>
                                        <p>Mauris malesuada erat a magna egestas rutrum id at diam. Nulla pharetra lacinia est, at rhoncus dui dapibus eu. Aliquam sit amet diam libero. Integer urna dui, ultricies ac suscipit vitae, convallis ut tellus. Etiam ut justo nibh. </p>
                                    </div>
                                    <ul>
                                        <li><a href="slider-circularcontent-alternative.php#">Read more</a></li>
                        ...
                        <div class="ca-item ca-item-4">
                            <div class="ca-item-main">
								...
								<div class="title_circle" data-position="bottom-left" data-size="small">
									<span>AN <strong>AWESOME</strong> PRODUCT HERE</span>
								</div>
                                <a href="slider-circularcontent-alternative.php#" class="ca-more">MORE <span class="icon-chevron-right icon-white"></span></a>
                                <span class="ca-starting">starting from <strong>$299</strong></span>
		...
		<div id="action_box" data-arrowpos="center">
			<div class="container">
				<div class="row">
					...
					<div class="span4 align-center">
						<a href="slider-circularcontent-alternative.php#" class="btn">JOIN OUR NEWSLETTER</a>
					</div>
				</div>
			</div>
		</div><!-- end action box -->        
			...
			<div class="container">
				...
				<div class="row image-boxes imgboxes_style1">
                    <div class="span4 box">
						<a href="slider-circularcontent-alternative.php#" class="hoverBorder">
				...
				<div class="row recentwork_carousel default-style">
					<div class="span3">
						...
						<div class="controls">
							<a href="slider-circularcontent-alternative.php#" class="prev"><span class="icon-chevron-left"></span></a>
							<a href="slider-circularcontent-alternative.php#" class="complete"><span class="icon-th"></span></a>
							<a href="slider-circularcontent-alternative.php#" class="next"><span class="icon-chevron-right"></span></a>
						</div>
					</div>
					<div class="span9">
						<ul id="recent_works1" class="fixclear">
							<li>
								<a href="slider-circularcontent-alternative.php#">
									<span class="hover">
				...
				<div class="row">
					...
					<div class="span2">
						<a href="slider-circularcontent-alternative.php#" class="circlehover with-symbol" data-size="" data-position="top-left" data-align="right">
				...
				<div class="row">
					<div class="span12">
						<div class="latest_posts acc-style">
							...
							<a href="slider-circularcontent-alternative.php#" class="viewall">VIEW ALL -</a>
							<div class="css3accordion">
								<ul>
									<li>
										<div class="inner-acc">
											<a href="slider-circularcontent-alternative.php#" class="thumb hoverBorder">
												<img src="images/site_images/img1.jpg" alt="">
											</a>
											<div class="content">
												...
												<a href="slider-circularcontent-alternative.php#">READ MORE +</a>
											</div>
										</div>
									</li>
									...
									<li>
										<div class="inner-acc">
											<a href="slider-circularcontent-alternative.php#" class="thumb hoverBorder plus">
												<img src="images/site_images/img2.jpg" alt="">
											</a>
											<div class="content">
												<em>03 October 2012 by Admin, in Entertanment</em>
			...
			<div class="gray-area">
				<div class="container">
					...
					<div class="span7">
						...
						<a href="slider-circularcontent-alternative.php#" class="hoverBorder pull-right" style="margin-left:20px;"><img src="images/site_images/img6.jpg" alt=""></a>
					...
					<div class="span12">
						<div class="process_steps fixclear">
							<div class="step intro">
								...
								<a href="slider-circularcontent-alternative.php#">MORE ABOUT US +</a>
							</div><!-- end step -->
				...
				<div class="row partners_carousel">
					...
					<div class="span10">
						<ul id="partners_carousel" class="fixclear">
							<li><a href="slider-circularcontent-alternative.php#"><img src="images/partners/css3.png" alt="" /></a></li>
							<li><a href="slider-circularcontent-alternative.php#"><img src="images/partners/html5.png" alt="" /></a></li>
							<li><a href="slider-circularcontent-alternative.php#"><img src="images/partners/joomla.png" alt="" /></a></li>
							<li><a href="slider-circularcontent-alternative.php#"><img src="images/partners/wordpress.png" alt="" /></a></li>
							<li><a href="slider-circularcontent-alternative.php#"><img src="images/partners/themeforest.png" alt="" /></a></li>
							<li><a href="slider-circularcontent-alternative.php#"><img src="images/partners/jquery.png" alt="" /></a></li>
						</ul>
					</div>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="slider-circularcontent-alternative.php#">Curabitur iaculis</a></li>
					<li><a href="slider-circularcontent-alternative.php#">Parturient montes</a></li>
					<li><a href="slider-circularcontent-alternative.php#">Vulputate magna</a></li>
					<li><a href="slider-circularcontent-alternative.php#">Cum sociis natoque</a></li>
					<li><a href="slider-circularcontent-alternative.php#">Nulla varius commodo</a></li>
					<li><a href="slider-circularcontent-alternative.php#">Parturient montes</a></li>
					<li><a href="slider-circularcontent-alternative.php#">Vulputate magna</a></li>
					<li><a href="slider-circularcontent-alternative.php#">Cum sociis natoque</a></li>
					<li><a href="slider-circularcontent-alternative.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="slider-circularcontent-alternative.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="slider-circularcontent-alternative.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="slider-circularcontent-alternative.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="slider-circularcontent-alternative.php#">Facebook</a></li>
						<li class="social-envato"><a href="slider-circularcontent-alternative.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="slider-circularcontent-alternative.php#" id="totop">TOP</a>
