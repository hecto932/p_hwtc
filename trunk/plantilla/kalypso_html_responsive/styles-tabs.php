...
<head>
	<title>Tabs styles | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="styles-tabs.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="styles-tabs.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="styles-tabs.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="styles-tabs.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="styles-tabs.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="styles-tabs.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="styles-tabs.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="styles-tabs.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="styles-tabs.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="styles-tabs.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="styles-tabs.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="styles-tabs.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="styles-tabs.php#">French</a></li>
								<li><a href="styles-tabs.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="styles-tabs.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="styles-tabs.php#">SLIDERS</a>
							<ul>
								<li><a href="styles-tabs.php#">Main Slider</a>
									<ul>
						...
						<li><a href="styles-tabs.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="styles-tabs.php#">Portfolio</a>
									<ul>
								...
								<li><a href="styles-tabs.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="styles-tabs.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="styles-tabs.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="styles-tabs.php#">PAGES</a>
							<ul>
						...
						<li><a href="styles-tabs.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="styles-tabs.php#">HOME</a></li>
							<li>STYLES</li>
							<li>TABS</li>
						</ul>
					...
					<div class="span6">
						<div class="header-titles">
							<h2>TABS DESIGN</h2>
							<h4>Javascript Tabs with nice stylings</h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
		...
		<section id="content">
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span12">
							<h1 class="page-title">Tabs Designs</h1>
...
<!-- ////// start examples -->
	...
	<h2>Example tabs</h2>
	<p>Add quick, dynamic tab functionality to transiton through panes of local content.</p>
	<p>The example above has the <code>class="tabbable tabs_style1"</code>, where <strong>tabbable</strong> triggers the tables and <strong>tabs_style1</strong> has the styling.</p>

	<div class="tabbable tabs_style1">
		<ul class="nav fixclear">
			<li class="active"><a href="styles-tabs.php#tabs1-pane1" data-toggle="tab">Some Tab #1</a></li>
			<li><a href="styles-tabs.php#tabs1-pane2" data-toggle="tab">Some Tab #2</a></li>
			<li><a href="styles-tabs.php#tabs1-pane3" data-toggle="tab">Some Tab #3</a></li>
		</ul>
...
&lt;div class=&quot;tabbable tabs_style1&quot;&gt;
  ...
  &lt;div class=&quot;tab-content&quot;&gt;
      &lt;div class=&quot;tab-pane active&quot; id=&quot;tabs1-pane1&quot;&gt;
        &lt;p&gt;.. contents of tab1 ..&lt;/p&gt;
      &lt;/div&gt;
      &lt;div class=&quot;tab-pane&quot; id=&quot;tabs1-pane2&quot;&gt;
        &lt;p&gt;.. contents of tab2 ..&lt;/p&gt;
      &lt;/div&gt;
      &lt;div class=&quot;tab-pane&quot; id=&quot;tabs1-pane3&quot;&gt;
        &lt;p&gt;.. contents of tab3 ..&lt;/p&gt;
      &lt;/div&gt;
  &lt;/div&gt;
&lt;/div&gt;
</pre>
	...
	<p>The example above has the <code>class="tabbable tabs_style2"</code>, where <strong>tabbable</strong> triggers the tables and <strong>tabs_style2</strong> has the styling.</p>

	<div class="tabbable tabs_style2">
		<ul class="nav fixclear">
			<li class="active"><a href="styles-tabs.php#tabs2-pane1" data-toggle="tab">Some Tab #1</a></li>
			<li><a href="styles-tabs.php#tabs2-pane2" data-toggle="tab">Some Tab #2</a></li>
			<li><a href="styles-tabs.php#tabs2-pane3" data-toggle="tab">Some Tab #3</a></li>
		</ul>
		<div class="tab-content">
	...
	<h2>Alternative styles</h2>
	<p>The example above has the <code>class="tabbable tabs_style3"</code>, where <strong>tabbable</strong> triggers the tables and <strong>tabs_style3</strong> has the styling.</p>

	<div class="tabbable tabs_style3">
		<ul class="nav fixclear">
			<li class="active"><a href="styles-tabs.php#tabs3-pane1" data-toggle="tab">Some Tab #1</a></li>
			<li><a href="styles-tabs.php#tabs3-pane2" data-toggle="tab">Some Tab #2</a></li>
			<li><a href="styles-tabs.php#tabs3-pane3" data-toggle="tab">Some Tab #3</a></li>
		</ul>
		<div class="tab-content">
			<div class="tab-pane active" id="tabs3-pane1">
				<h4>Pane 1 Content</h4>
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse euismod congue bibendum. Aliquam erat volutpat. Phasellus eget justo lacus. Vivamus pharetra ullamcorper massa, nec ultricies metus gravida egestas. Duis congue viverra arcu, ac aliquet turpis rutrum a.</p>
			</div>
			<div class="tab-pane" id="tabs3-pane2">
				<h4>Pane 2 Content</h4>
				<p>Phasellus eget justo lacus. Vivamus pharetra ullamcorper massa, nec ultricies metus gravida egestas. Duis congue viverra arcu, ac aliquet turpis rutrum a. Donec semper vestibulum dapibus. Integer et sollicitudin metus. Vivamus at nisi turpis.</p>
			</div>
			<div class="tab-pane" id="tabs3-pane3">
				<h4>Pane 3 Content</h4>
				<p>Donec semper vestibulum dapibus. Integer et sollicitudin metus. Vivamus at nisi turpis. Phasellus vel tellus id felis cursus hendrerit. Suspendisse et arcu felis, ac gravida turpis. Suspendisse potenti. Ut porta rhoncus ligula, sed fringilla felis feugiat eget. In non purus quis elit iaculis tincidunt. Donec at ultrices est.</p>
			</div>
		</div><!-- /.tab-content -->
	...
	<h2>Alternative styles</h2>
	<p>The example above has the <code>class="tabbable tabs_style4"</code>, where <strong>tabbable</strong> triggers the tables and <strong>tabs_style4</strong> has the styling.</p>

	<div class="tabbable tabs_style4">
		<ul class="nav fixclear">
			<li class="active"><a href="styles-tabs.php#tabs4-pane1" data-toggle="tab">Some Tab #1</a></li>
			<li><a href="styles-tabs.php#tabs4-pane2" data-toggle="tab">Some Tab #2</a></li>
			<li><a href="styles-tabs.php#tabs4-pane3" data-toggle="tab">Some Tab #3</a></li>
		</ul>
		<div class="tab-content">
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="styles-tabs.php#">Curabitur iaculis</a></li>
					<li><a href="styles-tabs.php#">Parturient montes</a></li>
					<li><a href="styles-tabs.php#">Vulputate magna</a></li>
					<li><a href="styles-tabs.php#">Cum sociis natoque</a></li>
					<li><a href="styles-tabs.php#">Nulla varius commodo</a></li>
					<li><a href="styles-tabs.php#">Parturient montes</a></li>
					<li><a href="styles-tabs.php#">Vulputate magna</a></li>
					<li><a href="styles-tabs.php#">Cum sociis natoque</a></li>
					<li><a href="styles-tabs.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="styles-tabs.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="styles-tabs.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="styles-tabs.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="styles-tabs.php#">Facebook</a></li>
						<li class="social-envato"><a href="styles-tabs.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="styles-tabs.php#" id="totop">TOP</a>
