...
<head>
	<title>COMING SOON/OFFLINE PAGE | KALLYAS Template</title>
		<meta charset="utf-8">
...
<body class="offline-page">
	...
	fjs.parentNode.insertBefore(js, fjs);
		...
		<div class="containerbox">
			...
			<div class="content">
				<p>We are currently working on a new website and won't take long. Please don't forget to check out our tweets and to subscribe to be notified!</p>
				...
				<form action="pages-offline.php" name="mail_when_ready" id="mail_when_ready" method="post">
					<input type="text" name="email_address" placeholder="mail me when it's ready ..">
					<input type="submit" class="btn btn-danger" value="submit">
				</form>

				<ul class="social-icons">
					<li class="social-twitter"><a href="pages-offline.php#">Twitter</a></li>
					<li class="social-dribbble"><a href="pages-offline.php#">Dribbble</a></li>
					<li class="social-facebook"><a href="pages-offline.php#">Facebook</a></li>
					<li class="social-envato"><a href="pages-offline.php#">Envato</a></li>
				</ul>
				<div class="clear"></div>
			</div><!-- end content -->
			<div class="clear"></div>
