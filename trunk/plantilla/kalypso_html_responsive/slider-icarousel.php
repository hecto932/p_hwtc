...
<head>
	<title>iCarousel | KALLYAS Template</title>
		<meta charset="utf-8">
  ...
  (function() {
	...
	<!-- Start iCarousel styles -->
	<link rel="stylesheet" href="sliders/icarousel/css/icarousel.css" />
	<link rel="stylesheet" href="sliders/icarousel/css/demo3.css" />
	<!-- End iCarousel styles -->
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="slider-icarousel.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="slider-icarousel.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="slider-icarousel.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="slider-icarousel.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="slider-icarousel.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="slider-icarousel.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="slider-icarousel.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="slider-icarousel.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="slider-icarousel.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="slider-icarousel.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="slider-icarousel.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="slider-icarousel.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="slider-icarousel.php#">French</a></li>
								<li><a href="slider-icarousel.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="slider-icarousel.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
	...
	$(document).ready(function(){
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="slider-icarousel.php#">SLIDERS</a>
							<ul>
								<li><a href="slider-icarousel.php#">Main Slider</a>
									<ul>
						...
						<li><a href="slider-icarousel.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="slider-icarousel.php#">Portfolio</a>
									<ul>
								...
								<li><a href="slider-icarousel.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="slider-icarousel.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="slider-icarousel.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="slider-icarousel.php#">PAGES</a>
							<ul>
						...
						<li><a href="slider-icarousel.php#">STYLES</a>
							<ul>
        ...
        <div id="slideshow" class="gradient dark-gray">
			...
			<div class="carousel-container">
				<div id="icarousel">
					<a href="slider-icarousel.php#" class="slide">
						<img src="images/sliders/icarousel/photo1.jpg" />
						<h5><span>Just a title here</span></h5>
					</a>
					<img class="slide" src="images/sliders/icarousel/photo2.jpg" width="480" height="360" data-pausetime="1000" />
					<img class="slide" src="images/sliders/icarousel/photo3.jpg" width="480" height="360" data-pausetime="10000" />
					<img class="slide" src="images/sliders/icarousel/photo4.jpg" width="480" height="360" />
					<img class="slide" src="images/sliders/icarousel/photo5.jpg" width="480" height="360" />
					<img class="slide" src="images/sliders/icarousel/photo6.jpg" width="480" height="360" />
					<img class="slide" src="images/sliders/icarousel/photo7.jpg" width="480" height="360" />
				</div>
			</div>
		...
		<div id="action_box" data-arrowpos="center">
			<div class="container">
				<div class="row">
					...
					<div class="span4 align-center">
						<a href="slider-icarousel.php#" class="btn">JOIN OUR NEWSLETTER</a>
					</div>
				</div>
			</div>
		</div><!-- end action box -->        
			...
			<div class="container">
				...
				<div class="row image-boxes imgboxes_style1">
                    <div class="span4 box">
						<a href="slider-icarousel.php#" class="hoverBorder">
				...
				<div class="row recentwork_carousel default-style">
					<div class="span3">
						...
						<div class="controls">
							<a href="slider-icarousel.php#" class="prev"><span class="icon-chevron-left"></span></a>
							<a href="slider-icarousel.php#" class="complete"><span class="icon-th"></span></a>
							<a href="slider-icarousel.php#" class="next"><span class="icon-chevron-right"></span></a>
						</div>
					</div>
					<div class="span9">
						<ul id="recent_works1" class="fixclear">
							<li>
								<a href="slider-icarousel.php#">
									<span class="hover">
				...
				<div class="row">
					...
					<div class="span2">
						<a href="slider-icarousel.php#" class="circlehover with-symbol" data-size="" data-position="top-left" data-align="right">
				...
				<div class="row">
					<div class="span12">
						<div class="latest_posts acc-style">
							...
							<a href="slider-icarousel.php#" class="viewall">VIEW ALL -</a>
							<div class="css3accordion">
								<ul>
									<li>
										<div class="inner-acc">
											<a href="slider-icarousel.php#" class="thumb hoverBorder">
												<img src="images/site_images/img1.jpg" alt="">
											</a>
											<div class="content">
												...
												<a href="slider-icarousel.php#">READ MORE +</a>
											</div>
										</div>
									</li>
									...
									<li>
										<div class="inner-acc">
											<a href="slider-icarousel.php#" class="thumb hoverBorder plus">
												<img src="images/site_images/img2.jpg" alt="">
											</a>
											<div class="content">
												<em>03 October 2012 by Admin, in Entertanment</em>
			...
			<div class="gray-area">
				<div class="container">
					...
					<div class="span7">
						...
						<a href="slider-icarousel.php#" class="hoverBorder pull-right" style="margin-left:20px;"><img src="images/site_images/img6.jpg" alt=""></a>
					...
					<div class="span12">
						<div class="process_steps fixclear">
							<div class="step intro">
								...
								<a href="slider-icarousel.php#">MORE ABOUT US +</a>
							</div><!-- end step -->
				...
				<div class="row partners_carousel">
					...
					<div class="span10">
						<ul id="partners_carousel" class="fixclear">
							<li><a href="slider-icarousel.php#"><img src="images/partners/css3.png" alt="" /></a></li>
							<li><a href="slider-icarousel.php#"><img src="images/partners/html5.png" alt="" /></a></li>
							<li><a href="slider-icarousel.php#"><img src="images/partners/joomla.png" alt="" /></a></li>
							<li><a href="slider-icarousel.php#"><img src="images/partners/wordpress.png" alt="" /></a></li>
							<li><a href="slider-icarousel.php#"><img src="images/partners/themeforest.png" alt="" /></a></li>
							<li><a href="slider-icarousel.php#"><img src="images/partners/jquery.png" alt="" /></a></li>
						</ul>
					</div>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="slider-icarousel.php#">Curabitur iaculis</a></li>
					<li><a href="slider-icarousel.php#">Parturient montes</a></li>
					<li><a href="slider-icarousel.php#">Vulputate magna</a></li>
					<li><a href="slider-icarousel.php#">Cum sociis natoque</a></li>
					<li><a href="slider-icarousel.php#">Nulla varius commodo</a></li>
					<li><a href="slider-icarousel.php#">Parturient montes</a></li>
					<li><a href="slider-icarousel.php#">Vulputate magna</a></li>
					<li><a href="slider-icarousel.php#">Cum sociis natoque</a></li>
					<li><a href="slider-icarousel.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="slider-icarousel.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="slider-icarousel.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="slider-icarousel.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="slider-icarousel.php#">Facebook</a></li>
						<li class="social-envato"><a href="slider-icarousel.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="slider-icarousel.php#" id="totop">TOP</a>

<!--////////////////// Load JS Files -->

<!-- Start iCarousel code -->
	<script src="sliders/icarousel/js/raphael-min.js"></script>
	<script src="sliders/icarousel/js/jquery.mousewheel.js"></script>
	<script src="sliders/icarousel/js/icarousel.packed.js"></script>
	<script>
