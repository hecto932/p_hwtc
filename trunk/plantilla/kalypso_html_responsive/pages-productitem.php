...
<head>
	<title>PRODUCT ITEM | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="pages-productitem.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="pages-productitem.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="pages-productitem.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="pages-productitem.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="pages-productitem.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="pages-productitem.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="pages-productitem.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="pages-productitem.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="pages-productitem.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="pages-productitem.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="pages-productitem.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="pages-productitem.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="pages-productitem.php#">French</a></li>
								<li><a href="pages-productitem.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="pages-productitem.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="pages-productitem.php#">SLIDERS</a>
							<ul>
								<li><a href="pages-productitem.php#">Main Slider</a>
									<ul>
						...
						<li><a href="pages-productitem.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="pages-productitem.php#">Portfolio</a>
									<ul>
								...
								<li><a href="pages-productitem.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="pages-productitem.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="pages-productitem.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="pages-productitem.php#">PAGES</a>
							<ul>
						...
						<li><a href="pages-productitem.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="pages-productitem.php#">HOME</a></li>
							<li>PAGES</li>
							<li>PRODUCT ITEM</li>
						</ul>
					...
					<div class="span6">
						<div class="header-titles">
							<h2>PRODUCT ITEM</h2>
							<h4>This is a product page demo</h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
							...
							<div class="row product-page">
								...
								<div class="span4">
									<div class="product-gallery">
										<div class="big_image">
											<a href="images/shop_images/page/img1.jpg" rel="prettyPhoto"><img src="php_helpers/timthumb.php?src=..%252Fimages%252Fshop_images%252Fpage%252Fimg1.jpg&amp;w=260" alt="" /></a>
										</div>
										<ul class="thumbs">
											<li><a href="images/shop_images/page/img2.jpg" rel="prettyPhoto"><img src="php_helpers/timthumb.php?src=..%252Fimages%252Fshop_images%252Fpage%252Fimg2.jpg&amp;w=50&amp;h=50&amp;zc=1" alt="" /></a></li>
											<li><a href="images/shop_images/page/img3.jpg" rel="prettyPhoto"><img src="php_helpers/timthumb.php?src=..%252Fimages%252Fshop_images%252Fpage%252Fimg3.jpg&amp;w=50&amp;h=50&amp;zc=1" alt="" /></a></li>
											<li><a href="images/shop_images/page/img4.jpg" rel="prettyPhoto"><img src="php_helpers/timthumb.php?src=..%252Fimages%252Fshop_images%252Fpage%252Fimg4.jpg&amp;w=50&amp;h=50&amp;zc=1" alt="" /></a></li>
										</ul>
										<div class="clear"></div>
									</div>
								</div>
								...
								<div class="span5">
									<div class="main-data">
										<p class="name">iMac 27"</p>
										<p><strong>SKU:</strong> #95846; / <strong>In Stock:</strong> 5pcs. </p>
										...
										<p class="regular_price">Regular Price: <span>$1200</span></p>
										<p class="price">
											<span>$1056</span>
											<a href="pages-productitem.php#" class="to_wishlist">Add to wishlist &larr;</a>
										</p>
										<p>You Save: <strong>$144.00 (12%)</strong></p>
										<div class="to_cart">
											<div class="quantitiy">
											...
											<a href="pages-productitem.php#" class="addtocart btn btn-flat">ADD TO CART</a>
											<div class="clear"></div>
										</div>
									</div><!-- end main data -->
								</div>
								...
								<div class="span9">
									...
									<div class="tabbable tabs_style4">
										<ul class="nav fixclear">
											<li class="active"><a href="pages-productitem.php#shop-tab1" data-toggle="tab">Description</a></li>
											<li><a href="pages-productitem.php#shop-tab2" data-toggle="tab">Specifications</a></li>
											<li><a href="pages-productitem.php#shop-tab3" data-toggle="tab">Shipping</a></li>
										</ul>
					...
					<p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur sodales ligula in libero. Sed dignissim lacinia nunc. Curabitur tortor. Pellentesque nibh. Aenean quam. In scelerisque sem at dolor. <strong>Mauris massa</strong>. Maecenas mattis. Sed convallis tristique sem. Proin ut ligula vel nunc egestas porttitor. <strong>Curabitur tortor</strong>. Morbi lectus risus, iaculis vel, suscipit quis, luctus non, massa. Fusce ac turpis quis ligula lacinia aliquet. Mauris ipsum. </p>
											...
											<div class="tab-pane" id="shop-tab2">
												<table cellpadding="0" cellspacing="0" border="0" width="100%" class="table table-hover">
													...
													<tbody>
														<tr>
															<td width="30%">Class aptent taciti</td>
															<td width="70%">Sociosqu ad litora torquent per conubia nostra</td>
														</tr>
														<tr>
															<td>Sed dignissim</td>
															<td>Isque nisl felis, venenatis tristique, dignissim in, ultrices.</td>
														</tr>
														<tr>
															<td>Nulla metus </td>
															<td>Quisque cursus, metus vitae pharetra auctor, sem massa mattis.</td>
														</tr>
														<tr>
															<td>Nam nec ante</td>
															<td>Vestibulum ante ipsum primis in faucibus orci luctus vitae.</td>
														</tr>
														<tr>
															<td>Urna non tincidunt</td>
															<td>Nostra sociosqu ad litora torquent per conubia </td>
														</tr>
														<tr>
															<td>Ut fringilla</td>
															<td>Isque nisl felis, venenatis tristique, dignissim in, ultrices.</td>
														...
														<tr>
															...
															<td>Sed vulputate eleifend neque sed porttitor</td>
														</tr>
														<tr>
															<td>Inceptos himenaeos</td>
															<td>Curabitur dignissim placerat nisl, ut accumsan neque gravida eget.</td>
														</tr>
													</tbody>
												</table>
											</div>
						...
						<div class="span3">
							<div id="sidebar" class="sidebar-right">
								...
								<div class="widget">
									...
									<ul class="menu">
										<li><a href="pages-productitem.php#">Curabitur iaculis</a></li>
										<li><a href="pages-productitem.php#">Parturient montes</a></li>
										<li><a href="pages-productitem.php#">Vulputate magna</a></li>
										<li><a href="pages-productitem.php#">Cum sociis natoque</a></li>
										<li><a href="pages-productitem.php#">Nulla varius commodo</a></li>
										<li><a href="pages-productitem.php#">Parturient montes</a></li>
										<li><a href="pages-productitem.php#">Vulputate magna</a></li>
										<li><a href="pages-productitem.php#">Cum sociis natoque</a></li>
										<li><a href="pages-productitem.php#">Nulla varius commodo</a></li>
...
<footer id="footer">
		...
		<div class="row">
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="pages-productitem.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="pages-productitem.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="pages-productitem.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="pages-productitem.php#">Facebook</a></li>
						<li class="social-envato"><a href="pages-productitem.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="pages-productitem.php#" id="totop">TOP</a>
