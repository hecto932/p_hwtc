...
<head>
	<title>Homepage 2 | KALLYAS Template</title>
		<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="homepage2.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="homepage2.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="homepage2.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="homepage2.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="homepage2.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="homepage2.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="homepage2.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="homepage2.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="homepage2.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="homepage2.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="homepage2.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="homepage2.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="homepage2.php#">French</a></li>
								<li><a href="homepage2.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="homepage2.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
...
(function($){ 
	$(document).ready(function(){
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="homepage2.php#">SLIDERS</a>
							<ul>
								<li><a href="homepage2.php#">Main Slider</a>
									<ul>
						...
						<li><a href="homepage2.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="homepage2.php#">Portfolio</a>
									<ul>
								...
								<li><a href="homepage2.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="homepage2.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="homepage2.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="homepage2.php#">PAGES</a>
							<ul>
						...
						<li><a href="homepage2.php#">STYLES</a>
							<ul>
        ...
        <div id="slideshow" class="gradient">
			...
			<div class="bg-wrapper-image">
                <div class="container">
                	<div class="static-content default-style">
                        <h2 class="centered">HELLO!</h2>
                        <h3 class="centered">Welcome to <strong>KALLYAS Template</strong>, a wonderful and <strong class="stronger" data-rel="tooltip" data-placement="top" title="MEGA PREMIUM ACTUALLY" data-animation="true">premium</strong> product for <strong>multipurpose websites</strong></h3>
                        <div class="info_pop animated fadeBoxIn" data-arrow="top">
                        	<a href="homepage2.php#" class="buyit">BUY IT</a>
                            <h5 class="text"><strong>exclusive on</strong> themeforest.net</h5>
                            <div class="clear"></div>
                        </div>
                    </div>
                </div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="span4 align-center">
						<a href="homepage2.php#" class="btn">JOIN OUR NEWSLETTER</a>
					</div>
				</div>
			</div>
		</div><!-- end action box -->        
		<section id="content">
			<div class="container">
				...
				<div class="row image-boxes imgboxes_style2">
                    <div class="span4 box">
						<a href="homepage2.php#" class="slidingDetails">
                ...
                <div class="row feature_box default_style">
					...
					<div class="span3">
						...
						<p><em>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur.. <a href="homepage2.php#">continue reading</a></em></p>
					</div>
					<div class="span3">
						<div class="box">
				...
				<div class="row">
					<div class="span12">
						<div class="recentwork_carousel style2">
							...
							<div class="controls">
								<a href="homepage2.php#" class="prev"><span class="icon-chevron-left"></span></a>
								<a href="homepage2.php#" class="complete"><span class="icon-th"></span></a>
								<a href="homepage2.php#" class="next"><span class="icon-chevron-right"></span></a>
							</div>
					...
					<div class="row">
						...
						<div class="span4">
							<div class="flickrfeed">
								...
								<ul class="flickr_feeds fixclear" data-limit="8" data-size="small"></ul>
							</div><!-- end // flickrfeed -->
						</div>
						...
						<div class="span4">
							<div class=" latest_posts style3">
								...
								<a href="homepage2.php#" class="viewall">VIEW ALL -</a>
								<ul class="posts">
									<li class="post">
										<a href="homepage2.php#" class="hoverBorder pull-left"><img src="images/post-thumb1.jpg" alt=""></a>
					...
					<div class="span12">
						<div class="screenshot-box fixclear">
							<div class="thescreenshot">
								<div class="controls"><a href="homepage2.php#" class="prev"></a><a href="homepage2.php#" class="next"></a></div>
							...
							<div class="left-side">
								...
								<a href="homepage2.php#" class="btn btn-large btn-flat redbtn">BUY THIS TEMPLATE ~ 15$</a>
							</div>
				...
				<div class="row partners_carousel">
					...
					<div class="span10">
						<ul id="partners_carousel" class="fixclear">
							<li><a href="homepage2.php#"><img src="images/partners/css3.png" alt="" /></a></li>
							<li><a href="homepage2.php#"><img src="images/partners/html5.png" alt="" /></a></li>
							<li><a href="homepage2.php#"><img src="images/partners/joomla.png" alt="" /></a></li>
							<li><a href="homepage2.php#"><img src="images/partners/wordpress.png" alt="" /></a></li>
							<li><a href="homepage2.php#"><img src="images/partners/themeforest.png" alt="" /></a></li>
							<li><a href="homepage2.php#"><img src="images/partners/jquery.png" alt="" /></a></li>
						</ul>
					</div>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="homepage2.php#">Curabitur iaculis</a></li>
					<li><a href="homepage2.php#">Parturient montes</a></li>
					<li><a href="homepage2.php#">Vulputate magna</a></li>
					<li><a href="homepage2.php#">Cum sociis natoque</a></li>
					<li><a href="homepage2.php#">Nulla varius commodo</a></li>
					<li><a href="homepage2.php#">Parturient montes</a></li>
					<li><a href="homepage2.php#">Vulputate magna</a></li>
					<li><a href="homepage2.php#">Cum sociis natoque</a></li>
					<li><a href="homepage2.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="homepage2.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="homepage2.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="homepage2.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="homepage2.php#">Facebook</a></li>
						<li class="social-envato"><a href="homepage2.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="homepage2.php#" id="totop">TOP</a>
