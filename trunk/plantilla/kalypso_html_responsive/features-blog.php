...
<head>
	<title>BLOG | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="features-blog.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="features-blog.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="features-blog.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="features-blog.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="features-blog.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="features-blog.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="features-blog.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="features-blog.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="features-blog.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="features-blog.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="features-blog.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="features-blog.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="features-blog.php#">French</a></li>
								<li><a href="features-blog.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="features-blog.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="features-blog.php#">SLIDERS</a>
							<ul>
								<li><a href="features-blog.php#">Main Slider</a>
									<ul>
						...
						<li><a href="features-blog.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="features-blog.php#">Portfolio</a>
									<ul>
								...
								<li><a href="features-blog.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="features-blog.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="features-blog.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="features-blog.php#">PAGES</a>
							<ul>
						...
						<li><a href="features-blog.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="features-blog.php#">HOME</a></li>
							<li>FEATURES</li>
							<li>BLOG</li>
						</ul>
		...
		<section id="content">
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span9">
							 <p>This is just a demo blog page. It's not Wordpress or any other blogging platform. It's purpose is to serve as built-in styles or manual creating page with html.</p>
							 ...
							 <div class="itemListView clearfix eBlog">
								...
								<div class="itemList">
									...
									<div class="itemContainer">
										...
										<div class="itemHeader">
											<h3 class="itemTitle">
												<a href="pages-blogitem.php">Quis autem vel reprehenderit</a>
											</h3>
											<div class="post_details">
												<span class="catItemDateCreated"><span class="icon-calendar"></span> Thursday, 14 June 2012</span>
												<span class="catItemAuthor">by <a rel="author" href="features-blog.php#">Administrator</a></span>
											</div><!-- end post details -->
										</div><!-- end itemHeader -->
									
										<div class="itemBody">
											<div class="itemIntroText">
												<p><a href="features-blog.php#" class="hoverBorder pull-left" style="margin-right: 20px;"><img src="images/blog_images/tribal-face-and-arms-hands.jpg" border="0" alt=""  /></a>
											...
											<div class="itemReadMore">
												<a class="readMore" href="pages-blogitem.php">Read more...</a>
											</div><!-- end read more -->
											<div class="clear"></div>
										</div><!-- end Item BODY -->
										...
										<ul class="itemLinks clearfix">
											<li class="itemCategory">
												...
												<a href="features-blog.php#">Lifestyle</a>
											</li>
										</ul><!-- item links -->
										<div class="clear"></div>
										<div class="itemTagsBlock">
											...
											<ul class="itemTags">
												<li><a href="features-blog.php#">duis</a>, </li>
												<li><a href="features-blog.php#">placerat</a>, </li>
												<li><a href="features-blog.php#">dolor</a>, </li>
												<li><a href="features-blog.php#">tristique</a>, </li>
											</ul>
											<div class="clear"></div>
										</div><!-- end tags blocks -->
									...
									<div class="itemContainer">
										...
										<div class="itemHeader">
											<h3 class="itemTitle">
												<a href="pages-blogitem.php">Maecenas tempus</a>
											</h3>
											<div class="post_details">
												<span class="catItemDateCreated"><span class="icon-calendar"></span> Thursday, 14 June 2012</span>
												<span class="catItemAuthor">by <a rel="author" href="features-blog.php#">Administrator</a></span>
										...
										<div class="itemBody">
											<div class="itemIntroText">
												<p><a href="features-blog.php#" class="hoverBorder pull-left" style="margin-right: 20px;"><img class="shadow" src="images/blog_images/handsome-african-american-male.jpg" /></a></p>
												<p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot, which was created for the bliss of souls like mine.</p>
												<p>I am so happy, my dear friend, so absorbed in the exquisite sense of mere tranquil existence, that I neglect my talents. I should be incapable of drawing a single stroke at the present moment; and yet I feel that I never was a greater artist than now.</p>
												<p>When, while the lovely valley teems with vapour around me, and the meridian sun strikes the upper surface of the impenetrable foliage of my trees, and but a few stray gleams steal into the inner sanctuary, I throw myself down among the tall grass by the trickling stream; and, as I lie close to the earth, a thousand unknown plants are noticed by me: when I hear the buzz of the little world among the stalks, and grow familiar with the countless indescribable forms of the insects and flies, then I feel the presence of the Almighty, who formed us in his own image.</p>
											</div><!-- end Item Intro Text -->
										...
										<ul class="itemLinks clearfix">
											<li class="itemCategory">
												<span class="icon-folder-close"></span> 
												<span>Published in</span>
												<a href="features-blog.php#">TECH</a>
											</li>
										</ul><!-- item links -->
										<div class="clear"></div>
										<div class="itemTagsBlock">
									...
									<div class="itemContainer">
										...
										<div class="itemHeader">
											<h3 class="itemTitle">
												<a href="pages-blogitem.php">Aliquam lorem ante</a>
											</h3>
											<div class="post_details">
												<span class="catItemDateCreated"><span class="icon-calendar"></span> Thursday, 14 June 2012</span>
												<span class="catItemAuthor">by <a rel="author" href="features-blog.php#">Administrator</a></span>
										...
										<div class="itemBody">
											<div class="itemIntroText">
												<p><a href="features-blog.php#" class="hoverBorder pull-left" style="margin-right: 20px;"><img class="shadow" src="images/blog_images/pretty-young-woman-eating-an-apple.jpg" /></a></p>
												<p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot, which was created for the bliss of souls like mine.</p>
												<p>I am so happy, my dear friend, so absorbed in the exquisite sense of mere tranquil existence, that I neglect my talents. I should be incapable of drawing a single stroke at the present moment; and yet I feel that I never was a greater artist than now.</p>
												<p>When, while the lovely valley teems with vapour around me, and the meridian sun strikes the upper surface of the impenetrable foliage of my trees, and but a few stray gleams steal into the inner sanctuary, I throw myself down among the tall grass by the trickling stream; and, as I lie close to the earth, a thousand unknown plants are noticed by me: when I hear the buzz of the little world among the stalks, and grow familiar with the countless indescribable forms of the insects and flies, then I feel the presence of the Almighty, who formed us in his own image.</p>
											</div><!-- end Item Intro Text -->
									...
									<div class="itemContainer">
										...
										<div class="itemHeader">
											<h3 class="itemTitle">
												<a href="pages-blogitem.php">Donec quam felis, ultricies</a>
											</h3>
											<div class="post_details">
												<span class="catItemDateCreated"><span class="icon-calendar"></span> Thursday, 14 June 2012</span>
												<span class="catItemAuthor">by <a rel="author" href="features-blog.php#">Administrator</a></span>
										...
										<div class="itemBody">
											<div class="itemIntroText">
												<p><a href="features-blog.php#" class="hoverBorder pull-left" style="margin-right: 20px;"><img class="shadow" src="images/blog_images/blond-boxing-woman-in-black-punching-bag.jpg" /></a></p>
												<p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot, which was created for the bliss of souls like mine.</p>
												<p>I am so happy, my dear friend, so absorbed in the exquisite sense of mere tranquil existence, that I neglect my talents. I should be incapable of drawing a single stroke at the present moment; and yet I feel that I never was a greater artist than now.</p>
												<p>When, while the lovely valley teems with vapour around me, and the meridian sun strikes the upper surface of the impenetrable foliage of my trees, and but a few stray gleams steal into the inner sanctuary, I throw myself down among the tall grass by the trickling stream; and, as I lie close to the earth, a thousand unknown plants are noticed by me: when I hear the buzz of the little world among the stalks, and grow familiar with the countless indescribable forms of the insects and flies, then I feel the presence of the Almighty, who formed us in his own image.</p>
											</div><!-- end Item Intro Text -->
										...
										<ul class="itemLinks clearfix">
											<li class="itemCategory">
												<span class="icon-folder-close"></span> 
												<span>Published in</span>
												<a href="features-blog.php#">ENTERTAINMENT</a>
											</li>
										</ul><!-- item links -->
										<div class="clear"></div>
										<div class="itemTagsBlock">
									...
									<div class="itemContainer">
										...
										<div class="itemHeader">
											<h3 class="itemTitle">
												<a href="pages-blogitem.php">Aenean massa</a>
											</h3>
											<div class="post_details">
												<span class="catItemDateCreated"><span class="icon-calendar"></span> Thursday, 13 June 2012</span>
												<span class="catItemAuthor">by <a rel="author" href="features-blog.php#">Administrator</a></span>
											</div><!-- end post details -->
										</div><!-- end itemHeader -->
										...
										<div class="itemBody">
											<div class="itemIntroText">
												<p><a href="features-blog.php#" class="hoverBorder pull-left" style="margin-right: 20px;"><img class="shadow" src="images/blog_images/target-businessman.jpg" /></a></p>
												<p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot, which was created for the bliss of souls like mine.</p>
												<p>I am so happy, my dear friend, so absorbed in the exquisite sense of mere tranquil existence, that I neglect my talents. I should be incapable of drawing a single stroke at the present moment; and yet I feel that I never was a greater artist than now.</p>
												<p>When, while the lovely valley teems with vapour around me, and the meridian sun strikes the upper surface of the impenetrable foliage of my trees, and but a few stray gleams steal into the inner sanctuary, I throw myself down among the tall grass by the trickling stream; and, as I lie close to the earth, a thousand unknown plants are noticed by me: when I hear the buzz of the little world among the stalks, and grow familiar with the countless indescribable forms of the insects and flies, then I feel the presence of the Almighty, who formed us in his own image.</p>
											</div><!-- end Item Intro Text -->
								...
								<div class="pagination">
									<ul>
										...
										<li>
											<a title="2" href="features-blog.php#" class="pagenav">2</a>
										</li>
										<li>
											<a title="3" href="features-blog.php#" class="pagenav">3</a>
										</li>
										<li>
											<a title="4" href="features-blog.php#" class="pagenav">4</a>
										</li>
										<li class="pagination-next">
											<a title="Next" href="features-blog.php#" class="pagenav">Next</a>
										</li>
										<li class="pagination-end">
											<a title="End" href="features-blog.php#" class="pagenav">End</a>
										</li>
									</ul>
									<div class="clear"></div>
									Page 1 of 4
						...
						<div class="span3">
							<div id="sidebar" class="sidebar-right">
								...
								<div class="widget">
									...
									<ul class="menu">
										<li><a href="features-blog.php#">Entertainment</a></li>
										<li><a href="features-blog.php#">Tech</a></li>
										<li><a href="features-blog.php#">Lifestyle</a></li>
									</ul><!-- end menu -->
								</div><!-- end widget -->
								...
								<div class="widget">
									...
									<ul class="menu">
										<li><a href="features-blog.php#">July 2012 (6)</a></li>
										<li><a href="features-blog.php#">June 2012 (12)</a></li>
										<li><a href="features-blog.php#">May 2012 (3)</a></li>
										<li><a href="features-blog.php#">April 2012 (2)</a></li>
										<li><a href="features-blog.php#">March 2012 (2)</a></li>
										<li><a href="features-blog.php#">February 2012 (5)</a></li>
										<li><a href="features-blog.php#">January 2012 (4)</a></li>
									</ul><!-- end menu -->
								</div><!-- end widget -->
								...
								<div class="widget">
									...
									<div class="cloudBlock">
										<a href="features-blog.php#" style="font-size:75%">dictum</a>
										<a href="features-blog.php#" style="font-size:117%">dolor</a>
										<a href="features-blog.php#" style="font-size:200%">duis</a>
										<a href="features-blog.php#" style="font-size:75%">lacus</a>
										<a href="features-blog.php#" style="font-size:159%">placerat</a>
										<a href="features-blog.php#" style="font-size:117%">tristique</a>
										<div class="clear"></div>
									</div>
								</div><!-- end widget -->
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="features-blog.php#">Curabitur iaculis</a></li>
					<li><a href="features-blog.php#">Parturient montes</a></li>
					<li><a href="features-blog.php#">Vulputate magna</a></li>
					<li><a href="features-blog.php#">Cum sociis natoque</a></li>
					<li><a href="features-blog.php#">Nulla varius commodo</a></li>
					<li><a href="features-blog.php#">Parturient montes</a></li>
					<li><a href="features-blog.php#">Vulputate magna</a></li>
					<li><a href="features-blog.php#">Cum sociis natoque</a></li>
					<li><a href="features-blog.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="features-blog.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="features-blog.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="features-blog.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="features-blog.php#">Facebook</a></li>
						<li class="social-envato"><a href="features-blog.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="features-blog.php#" id="totop">TOP</a>
