...
<head>
	<title>Creative slider | KALLYAS Template</title>
		<meta charset="utf-8">
	...
	<link rel="stylesheet" href="css/template.css.php?src=bootstrap-..%252Faddons%252Fsuperfish_responsive%252Fsuperfish-template-updates-custom" type="text/css" />
  ...
  (function() {
...
</script>    <!-- REVOLUTION BANNER CSS SETTINGS -->
    ...
    <link rel="stylesheet" type="text/css" href="sliders/revolution_slider/css/creative_slider.css" media="screen" />
</head>
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="slider-creative.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="slider-creative.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="slider-creative.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="slider-creative.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="slider-creative.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="slider-creative.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
	...
	<div id="page_wrapper">
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<!-- logo -->
				<h1 id="logo"><a href="index.php"><img src="images/logo.png" alt="Kallyas HTML Template"></a></h1>

				<ul class="topnav navRight">
					<li><a href="slider-creative.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="slider-creative.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="slider-creative.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="slider-creative.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="slider-creative.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="slider-creative.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="slider-creative.php#">French</a></li>
								<li><a href="slider-creative.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="slider-creative.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="slider-creative.php#">SLIDERS</a>
							<ul>
								<li><a href="slider-creative.php#">Main Slider</a>
									<ul>
								...
								<li><a href="slider-static-content-default.php">Static Content</a>
									<ul>
										...
										<li><a href="slider-static-content-videobg.php">Style 8 / Video background</a></li><!-- http://www.teehanlax.com/ -->
						...
						<li><a href="slider-creative.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="slider-creative.php#">Portfolio</a>
									<ul>
								...
								<li><a href="slider-creative.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="slider-creative.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="slider-creative.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="slider-creative.php#">PAGES</a>
							<ul>
						...
						<li><a href="slider-creative.php#">STYLES</a>
							<ul>
        ...
        <div id="slideshow" class="nobg">
                ...
                <div class="fullwidthbanner">
                    <ul>
						...
						<li data-transition="fade">
                            <img src="images/sliders/creative_slider/slide1/bg.png" alt="">
                            
							<div class="caption fade" data-x="-70" data-y="100" data-speed="600" data-start="700" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide1/slide_bg.png" alt="">
							</div>
							<div class="caption fade para1" data-x="30" data-y="160" data-speed="600" data-start="1000" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide1/photos.png" alt="">
							</div>
							<div class="caption fade para2" data-x="30" data-y="160" data-speed="600" data-start="1700" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide1/likes.png" alt="">
							</div>
							<div class="caption sfb para3" data-x="290" data-y="260" data-speed="800" data-start="2500" data-easing="easeOutElastic">
								<img src="images/sliders/creative_slider/slide1/big_like.png" alt="">
							</div>
							<div class="caption lfb" data-x="165" data-y="290" data-speed="800" data-start="3000" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide1/do_you.png" alt="">
							</div>
							<div class="caption lfb para5" data-x="250" data-y="530" data-speed="800" data-start="3500" data-easing="easeOutExpo">
								<a href="slider-creative.php#">
									<img src="images/sliders/creative_slider/slide1/button.png" alt="">
								</a>
							</div>
                        </li><!-- end slide 1 -->
						
                        <li data-transition="fade">
                            <img src="images/sliders/creative_slider/slide2/bg.png" alt="">
                            
							<div class="caption fade" data-x="-70" data-y="100" data-speed="600" data-start="700" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide1/slide_bg.png" alt="">
							</div>
							<div class="caption fade para1" data-x="-60" data-y="160" data-speed="600" data-start="1000" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide2/symbols1.png" alt="">
							</div>
							<div class="caption fade para2" data-x="80" data-y="160" data-speed="600" data-start="1700" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide2/symbols2.png" alt="">
							</div>
							<div class="caption lft para3" data-x="340" data-y="340" data-speed="1000" data-start="2500" data-easing="easeOutBack">
								<img src="images/sliders/creative_slider/slide2/ipad_small.png" alt="">
							</div>
							<div class="caption lft para4" data-x="350" data-y="120" data-speed="1000" data-start="2800" data-easing="easeOutBack">
								<img src="images/sliders/creative_slider/slide2/ipad_medium.png" alt="">
							</div>
							<div class="caption lft para5" data-x="470" data-y="120" data-speed="1000" data-start="3200" data-easing="easeOutBack">
								<img src="images/sliders/creative_slider/slide2/ipad_big.png" alt="">
							</div>
							<div class="caption lfb" data-x="-40" data-y="260" data-speed="600" data-start="3600" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide2/text.png" alt="">
							</div>
							<div class="caption lfb" data-x="-40" data-y="550" data-speed="600" data-start="4000" data-easing="easeOutExpo">
								<a href="slider-creative.php#">
									<img src="images/sliders/creative_slider/slide2/appstore.png" alt="">
								</a>
							</div>
						...
						<li data-transition="fade">
                            <img src="images/sliders/creative_slider/slide3/bg.png" alt="">
							
							<div class="caption fade" data-x="-70" data-y="100" data-speed="600" data-start="700" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide1/slide_bg.png" alt="">
							</div>
							<div class="caption fade para1" data-x="0" data-y="120" data-speed="600" data-start="1000" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide3/symbols1.png" alt="">
							</div>
							<div class="caption fade para2" data-x="60" data-y="140" data-speed="600" data-start="1600" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide3/symbols2.png" alt="">
							</div>
							<div class="caption lft para3" data-x="280" data-y="-10" data-speed="1000" data-start="2300" data-easing="easeOutBack">
								<img src="images/sliders/creative_slider/slide3/screenshot.png" alt="">
							</div>
							<div class="caption lfb" data-x="60" data-y="220" data-speed="600" data-start="3000" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide3/text.png" alt="">
							</div>
							<div class="caption lfb" data-x="90" data-y="410" data-speed="600" data-start="3700" data-easing="easeOutExpo">
								<a href="slider-creative.php#">
									<img src="images/sliders/creative_slider/slide3/button.png" alt="">
								</a>
							</div>
						</li><!-- end slide 3 -->
						
						<li data-transition="fade">
                            <img src="images/sliders/creative_slider/slide4/bg.png" alt="">
							
							<div class="caption fade" data-x="-110" data-y="90" data-speed="500" data-start="500" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide4/chalkdust.png" alt="">
							</div>
							
							<div class="caption fade" data-x="180" data-y="130" data-speed="500" data-start="800" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide4/title.png" alt="">
							</div>
							
							<div class="caption lfb" data-x="0" data-y="550" data-speed="600" data-start="1000" data-easing="easeOutBack">
								<a href="slider-creative.php#">
									<img src="images/sliders/creative_slider/slide4/icon1.png" alt="">
								</a>
							</div>
							
							<div class="caption lfb" data-x="320" data-y="550" data-speed="600" data-start="1100" data-easing="easeOutBack">
								<a href="slider-creative.php#">
									<img src="images/sliders/creative_slider/slide4/icon2.png" alt="">
								</a>
							</div>
							
							<div class="caption lfb" data-x="640" data-y="550" data-speed="600" data-start="1200" data-easing="easeOutBack">
								<a href="slider-creative.php#">
									<img src="images/sliders/creative_slider/slide4/icon3.png" alt="">
								</a>
							</div>
							
							<div class="caption fade para1" data-x="370" data-y="240" data-speed="600" data-start="1700" data-easing="easeOutBack">
								<img src="images/sliders/creative_slider/slide4/lightbulb.png" alt="">
							</div>
							
							<div class="caption lfb para2" data-x="220" data-y="210" data-speed="500" data-start="2300" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide4/arr_top_left.png" alt="">
							</div>
							
							<div class="caption lfl para3" data-x="220" data-y="330" data-speed="500" data-start="2400" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide4/arr_center_left.png" alt="">
							</div>
							
							<div class="caption lfb para4" data-x="220" data-y="450" data-speed="500" data-start="2500" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide4/arr_bottom_left.png" alt="">
							</div>
							
							<div class="caption lft para2" data-x="550" data-y="220" data-speed="500" data-start="2800" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide4/arr_top_right.png" alt="">
							</div>
							
							<div class="caption lfr para4" data-x="550" data-y="340" data-speed="500" data-start="2700" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide4/arr_center_right.png" alt="">
							</div>
							
							<div class="caption lfb para3" data-x="550" data-y="460" data-speed="500" data-start="2600" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide4/arr_bottom_right.png" alt="">
							</div>
							
						</li><!-- end slide 4 -->
						
						<li data-transition="fade">
                            <img src="images/sliders/creative_slider/slide5/bg.png" alt="">
							
							<div class="caption fade" data-x="-400" data-y="100" data-speed="600" data-start="700" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide5/slide-bg.png" alt="">
							</div>
							
							<div class="caption fade para1" data-x="200" data-y="100" data-speed="600" data-start="1000" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide5/icons1.png" alt="">
							</div>
							
							<div class="caption fade para2" data-x="200" data-y="100" data-speed="600" data-start="1300" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide5/icons2.png" alt="">
							</div>
							
							<div class="caption lfb para3" data-x="400" data-y="120" data-speed="600" data-start="1700" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide5/iphone.png" alt="">
							</div>
							
							<div class="caption lfb para3" data-x="720" data-y="120" data-speed="600" data-start="2200" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide5/iphone_arrow.png" alt="">
							</div>
							
							<div class="caption lfb" data-x="0" data-y="160" data-speed="600" data-start="2700" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide5/title.png" alt="">
							</div>
							
							<div class="caption lfb desc_text" data-x="0" data-y="350" data-speed="600" data-start="3400" data-easing="easeOutExpo">
								<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</p>
							</div>
							
							<div class="caption lfb" data-x="0" data-y="540" data-speed="600" data-start="4000" data-easing="easeOutExpo">
								<a href="slider-creative.php#">
									<img src="images/sliders/creative_slider/slide5/button.png" alt="">
								</a>
							</div>
						</li><!-- end slide 5 -->
						
						<li data-transition="fade">
                            <img src="images/sliders/creative_slider/slide6/bg.png" alt="">
                            
							<div class="caption fade" data-x="-70" data-y="100" data-speed="600" data-start="700" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide1/slide_bg.png" alt="">
							</div>
							
							<div class="caption fade" data-x="30" data-y="120" data-speed="600" data-start="1000" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide6/map.png" alt="">
							</div>
							<div class="caption lfb para3" data-x="580" data-y="210" data-speed="600" data-start="1700" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide6/monitor.png" alt="">
							</div>
							<div class="caption fade para2" data-x="560" data-y="190" data-speed="600" data-start="2000" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide6/layer2.png" alt="">
							</div>
							<div class="caption fade para1" data-x="520" data-y="170" data-speed="600" data-start="2300" data-easing="easeOutExpo">
								<img src="images/sliders/creative_slider/slide6/layer1.png" alt="">
							</div>
							
							<div class="caption lfb big_title_white" data-x="0" data-y="170" data-speed="600" data-start="2800" data-easing="easeOutExpo">
								<h3>Beautiful Apps &amp; Websites</h3>
							</div>
							
							<div class="caption lfb big_text_white" data-x="0" data-y="270" data-speed="600" data-start="3200" data-easing="easeOutExpo">
								<p>We devote serious effort in creating the best websites and mobile apps.</p>
								<p>We really like working with clients all over the world to discover and build dream products.</p>
							</div>
							
							<div class="caption lfb" data-x="310" data-y="550" data-speed="600" data-start="3700" data-easing="easeOutExpo">
								<a href="slider-creative.php#">
									<img src="images/sliders/creative_slider/slide6/button.png" alt="">
								</a>
							</div>
                        </li><!-- end slide 6 -->
			...
			<div class="container">
				...
				<div class="row image-boxes imgboxes_style1">
                    <div class="span4 box">
						<a href="slider-creative.php#" class="hoverBorder">
				...
				<div class="row recentwork_carousel default-style">
					<div class="span3">
						...
						<div class="controls">
							<a href="slider-creative.php#" class="prev"><span class="icon-chevron-left"></span></a>
							<a href="slider-creative.php#" class="complete"><span class="icon-th"></span></a>
							<a href="slider-creative.php#" class="next"><span class="icon-chevron-right"></span></a>
						</div>
					</div>
					<div class="span9">
				...
				<div class="row">
					...
					<div class="span2">
						<a href="slider-creative.php#" class="circlehover with-symbol" data-size="" data-position="top-left" data-align="right">
				...
				<div class="row">
					<div class="span12">
						<div class="latest_posts acc-style">
							...
							<a href="slider-creative.php#" class="viewall">VIEW ALL -</a>
							<div class="css3accordion">
								<ul>
									<li>
										<div class="inner-acc">
											<a href="slider-creative.php#" class="thumb hoverBorder">
												<img src="images/site_images/img1.jpg" alt="">
											</a>
											<div class="content">
												...
												<a href="slider-creative.php#">READ MORE +</a>
											</div>
										</div>
									</li>
									...
									<li>
										<div class="inner-acc">
											<a href="slider-creative.php#" class="thumb hoverBorder plus">
												<img src="images/site_images/img2.jpg" alt="">
											</a>
											<div class="content">
												<em>03 October 2012 by Admin, in Entertanment</em>
			...
			<div class="gray-area">
				<div class="container">
					...
					<div class="span7">
						...
						<a href="slider-creative.php#" class="hoverBorder pull-right" style="margin-left:20px;"><img src="images/site_images/img6.jpg" alt=""></a>
					...
					<div class="span12">
						<div class="process_steps fixclear">
							<div class="step intro">
								...
								<a href="slider-creative.php#">MORE ABOUT US +</a>
							</div><!-- end step -->
				...
				<div class="row partners_carousel">
					...
					<div class="span10">
						<ul id="partners_carousel" class="fixclear">
							<li><a href="slider-creative.php#"><img src="images/partners/css3.png" alt="" /></a></li>
							<li><a href="slider-creative.php#"><img src="images/partners/html5.png" alt="" /></a></li>
							<li><a href="slider-creative.php#"><img src="images/partners/joomla.png" alt="" /></a></li>
							<li><a href="slider-creative.php#"><img src="images/partners/wordpress.png" alt="" /></a></li>
							<li><a href="slider-creative.php#"><img src="images/partners/themeforest.png" alt="" /></a></li>
							<li><a href="slider-creative.php#"><img src="images/partners/jquery.png" alt="" /></a></li>
						</ul>
					</div>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="slider-creative.php#">Curabitur iaculis</a></li>
					<li><a href="slider-creative.php#">Parturient montes</a></li>
					<li><a href="slider-creative.php#">Vulputate magna</a></li>
					<li><a href="slider-creative.php#">Cum sociis natoque</a></li>
					<li><a href="slider-creative.php#">Nulla varius commodo</a></li>
					<li><a href="slider-creative.php#">Parturient montes</a></li>
					<li><a href="slider-creative.php#">Vulputate magna</a></li>
					<li><a href="slider-creative.php#">Cum sociis natoque</a></li>
					<li><a href="slider-creative.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="slider-creative.php#">sales@yourwebsite.com</a></p>
		...
		<div class="row">
			...
			<div class="span6">
								<div class="social-share"><img src="images/share.jpg" /></div>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="slider-creative.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="slider-creative.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="slider-creative.php#">Facebook</a></li>
						<li class="social-envato"><a href="slider-creative.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="slider-creative.php#" id="totop">TOP</a>
...
<script type="text/javascript" src="sliders/revolution_slider/js/parallax.js"></script>
<script type="text/javascript">
var tpj=jQuery;
tpj.noConflict();
...
<!-- end Carousels (by CarouFredSel) --><link rel="stylesheet" href="css/template.css.php?src=..%252Faddons%252Fdemo_panel%252Fdemo_panel" type="text/css" />
<script type="text/javascript" src="js/template.js.php?src=..%252Faddons%252Fdemo_panel%252Fdemo_panel-..%252Faddons%252Fdemo_panel%252Fjquery.miniColors.min-bootstrap-plugins-..%252Faddons%252Fsuperfish_responsive%252Fsuperfish_menu-kalypso_script-..%252Faddons%252Fprettyphoto%252Fjquery.prettyPhoto"></script>


<!-- DEMO PANEL - REMOVE IF YOU DON'T USE IT -->
	<div id="demo">

		<link type="text/css" rel="stylesheet" href="addons/demo_panel/jquery.miniColors.css" />
					...
					<tr>
						<td>
							...
							<ul class="color_suggestions">
								...
								<li style="background-color:#BAA507;" title="#BAA507"></li>
