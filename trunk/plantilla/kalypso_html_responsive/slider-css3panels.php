...
<head>
	<title>Full CSS3 Panels | KALLYAS Template</title>
		<meta charset="utf-8">
  ...
  (function() {
	...
	<!-- Start Css3 Panels styles -->
	<link href="sliders/css3panels/css3panels.css" rel="stylesheet" type="text/css" />
	
	<!-- End Css3 Panels styles -->
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="slider-css3panels.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="slider-css3panels.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="slider-css3panels.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="slider-css3panels.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="slider-css3panels.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="slider-css3panels.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="slider-css3panels.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="slider-css3panels.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="slider-css3panels.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="slider-css3panels.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="slider-css3panels.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="slider-css3panels.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="slider-css3panels.php#">French</a></li>
								<li><a href="slider-css3panels.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="slider-css3panels.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
	...
	$(document).ready(function(){
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="slider-css3panels.php#">SLIDERS</a>
							<ul>
								<li><a href="slider-css3panels.php#">Main Slider</a>
									<ul>
						...
						<li><a href="slider-css3panels.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="slider-css3panels.php#">Portfolio</a>
									<ul>
								...
								<li><a href="slider-css3panels.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="slider-css3panels.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="slider-css3panels.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="slider-css3panels.php#">PAGES</a>
							<ul>
						...
						<li><a href="slider-css3panels.php#">STYLES</a>
							<ul>
        ...
        <div id="slideshow" class="">
			...
			<div id="css3panels">
				...
				<div class="panel panel1 first">
					<div class="inner-panel">
						<img src="images/sliders/css3panels/slide1.jpg" alt="" class="main_image">
				...
				<div class="panel panel2">
					<div class="inner-panel">
						<img src="images/sliders/css3panels/slide2.jpg" alt="" class="main_image">
						<div class="caption">
							<h3 class="title">HERE'S A TITLE</h3>
						</div>
					</div>
				</div><!-- end panel -->
				...
				<div class="panel panel3">
					<div class="inner-panel">
						<img src="images/sliders/css3panels/slide3.jpg" alt="" class="main_image">
					</div>
				</div><!-- end panel -->
				
				<div class="panel panel4 last">
					<div class="inner-panel">
						<img src="images/sliders/css3panels/slide4.jpg" alt="" class="main_image">
		...
		<div id="action_box" data-arrowpos="center">
			<div class="container">
				<div class="row">
					...
					<div class="span4 align-center">
						<a href="slider-css3panels.php#" class="btn">JOIN OUR NEWSLETTER</a>
					</div>
				</div>
			</div>
		</div><!-- end action box -->        
			...
			<div class="container">
				...
				<div class="row image-boxes imgboxes_style1">
                    <div class="span4 box">
						<a href="slider-css3panels.php#" class="hoverBorder">
				...
				<div class="row recentwork_carousel default-style">
					<div class="span3">
						...
						<div class="controls">
							<a href="slider-css3panels.php#" class="prev"><span class="icon-chevron-left"></span></a>
							<a href="slider-css3panels.php#" class="complete"><span class="icon-th"></span></a>
							<a href="slider-css3panels.php#" class="next"><span class="icon-chevron-right"></span></a>
						</div>
					</div>
					<div class="span9">
						<ul id="recent_works1" class="fixclear">
							<li>
								<a href="slider-css3panels.php#">
									<span class="hover">
				...
				<div class="row">
					...
					<div class="span2">
						<a href="slider-css3panels.php#" class="circlehover with-symbol" data-size="" data-position="top-left" data-align="right">
				...
				<div class="row">
					<div class="span12">
						<div class="latest_posts acc-style">
							...
							<a href="slider-css3panels.php#" class="viewall">VIEW ALL -</a>
							<div class="css3accordion">
								<ul>
									<li>
										<div class="inner-acc">
											<a href="slider-css3panels.php#" class="thumb hoverBorder">
												<img src="images/site_images/img1.jpg" alt="">
											</a>
											<div class="content">
												...
												<a href="slider-css3panels.php#">READ MORE +</a>
											</div>
										</div>
									</li>
									...
									<li>
										<div class="inner-acc">
											<a href="slider-css3panels.php#" class="thumb hoverBorder plus">
												<img src="images/site_images/img2.jpg" alt="">
											</a>
											<div class="content">
												<em>03 October 2012 by Admin, in Entertanment</em>
			...
			<div class="gray-area">
				<div class="container">
					...
					<div class="span7">
						...
						<a href="slider-css3panels.php#" class="hoverBorder pull-right" style="margin-left:20px;"><img src="images/site_images/img6.jpg" alt=""></a>
					...
					<div class="span12">
						<div class="process_steps fixclear">
							<div class="step intro">
								...
								<a href="slider-css3panels.php#">MORE ABOUT US +</a>
							</div><!-- end step -->
				...
				<div class="row partners_carousel">
					...
					<div class="span10">
						<ul id="partners_carousel" class="fixclear">
							<li><a href="slider-css3panels.php#"><img src="images/partners/css3.png" alt="" /></a></li>
							<li><a href="slider-css3panels.php#"><img src="images/partners/html5.png" alt="" /></a></li>
							<li><a href="slider-css3panels.php#"><img src="images/partners/joomla.png" alt="" /></a></li>
							<li><a href="slider-css3panels.php#"><img src="images/partners/wordpress.png" alt="" /></a></li>
							<li><a href="slider-css3panels.php#"><img src="images/partners/themeforest.png" alt="" /></a></li>
							<li><a href="slider-css3panels.php#"><img src="images/partners/jquery.png" alt="" /></a></li>
						</ul>
					</div>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="slider-css3panels.php#">Curabitur iaculis</a></li>
					<li><a href="slider-css3panels.php#">Parturient montes</a></li>
					<li><a href="slider-css3panels.php#">Vulputate magna</a></li>
					<li><a href="slider-css3panels.php#">Cum sociis natoque</a></li>
					<li><a href="slider-css3panels.php#">Nulla varius commodo</a></li>
					<li><a href="slider-css3panels.php#">Parturient montes</a></li>
					<li><a href="slider-css3panels.php#">Vulputate magna</a></li>
					<li><a href="slider-css3panels.php#">Cum sociis natoque</a></li>
					<li><a href="slider-css3panels.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="slider-css3panels.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="slider-css3panels.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="slider-css3panels.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="slider-css3panels.php#">Facebook</a></li>
						<li class="social-envato"><a href="slider-css3panels.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="slider-css3panels.php#" id="totop">TOP</a>

<!--////////////////// Load JS Files -->

<!-- Start Css3 Panels code -->
<script src="sliders/css3panels/css3panels.js" type="text/javascript"></script>
<!-- End Css3 Panels code -->
