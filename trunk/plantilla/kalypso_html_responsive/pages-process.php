...
<head>
	<title>Process Page | KALLYAS Template</title>
	<meta charset="utf-8">
	...
	<div class="login_register_stuff hide"><!-- Login/Register Modal forms - hidded by default to be opened through modal -->
		<div id="login_panel">
			<div class="inner-container login-panel">
				...
				<form id="login_form" name="login_form" method="post">
					<a href="pages-process.php#" class="create_account" onClick="ppOpen('#register_panel', '280');">CREATE ACCOUNT</a>
					...
					<a href="pages-process.php#" class="login_facebook">login with facebook</a>
				</form>
				<div class="links"><a href="pages-process.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR USERNAME?</a> / <a href="pages-process.php#" onClick="ppOpen('#forgot_panel', '350');">FORGOT YOUR PASSWORD?</a></div>
			</div>
		</div><!-- end login panel -->
		...
		<div id="register_panel">
			<div class="inner-container register-panel">
				...
				<div class="links"><a href="pages-process.php#" onClick="ppOpen('#login_panel', '800');">ALREADY HAVE AN ACCOUNT?</a></div>
			</div>
		...
		<div id="forgot_panel">
			<div class="inner-container forgot-panel">
				...
				<div class="links"><a href="pages-process.php#" onClick="ppOpen('#login_panel', '800');">AAH, WAIT, I REMEMBER NOW!</a></div>
			</div>
		</div><!-- end register panel -->
		...
		<header id="header" class="style2">
			<div class="container">
				...
				<ul class="topnav navRight">
					<li><a href="pages-process.php#" id="open_sliding_panel">
							<span class="icon-remove-circle icon-white"></span> SUPPORT
						</a>
					</li>
					<li><a href="pages-process.php#login_panel" data-rel="prettyPhoto[login_panel]">LOGIN</a></li>
				</ul><!-- end topnav // right aligned -->

				<ul class="topnav navLeft">
					<li class="drop"><a href="pages-process.php#">MY CART</a>
						<div class="pPanel">
							<div class="inner">
								<span class="cart_details">3 items, Total of <strong>$599 USD</strong> <a href="pages-process.php#" class="checkout">Checkout <span class="icon-chevron-right"></span></a></span>
							</div>
						</div>
					</li>
					<li class="languages drop"><a href="pages-process.php#"><span class="icon-globe icon-white"></span> LANGUAGES</a>
						<div class="pPanel">
							<ul class="inner">
								<li class="active"><a href="pages-process.php#">English <span class="icon-ok"></span></a></li>
								<li><a href="pages-process.php#">French</a></li>
								<li><a href="pages-process.php#">German</a></li>
							</ul>
						</div>
					</li>
				...
				<!-- search -->
				<div id="search">
					<a href="pages-process.php#" class="searchBtn"><span class="icon-search icon-white"></span></a>
					<div class="search">
			...
			if(page == miHrefs) {
				...
				<nav id="main_menu">
					<ul class="sf-menu clearfix">
						...
						<li><a href="pages-process.php#">SLIDERS</a>
							<ul>
								<li><a href="pages-process.php#">Main Slider</a>
									<ul>
						...
						<li><a href="pages-process.php#">FEATURES</a>
							<ul>
								<li><a href="features-blog.php">Blog</a></li>
								<li><a href="pages-process.php#">Portfolio</a>
									<ul>
								...
								<li><a href="pages-process.php#">Lightbox (Prettyphoto)</a>
									<ul>
										...
										<li><a href="pages-process.php#transparent_panel" class="prettyPhoto_transparent">Transparent modal</a></li>
									</ul>
								</li>
								<li><a href="features-grid-positions.php">Grid Positions</a></li>
								<li><a href="features-sitemap.php">Sitemap</a></li>
								<li><a href="pages-process.php#">Holiday Slides</a>
									<ul>
						...
						<li><a href="pages-process.php#">PAGES</a>
							<ul>
						...
						<li><a href="pages-process.php#">STYLES</a>
							<ul>
				...
				<div class="row">
					<div class="span6">
						<ul class="breadcrumbs fixclear">
							<li><a href="pages-process.php#">HOME</a></li>
							<li>PAGES</li>
							<li>PROCESS</li>
						</ul>
					...
					<div class="span6">
						<div class="header-titles">
							<h2>PROCESS PAGE</h2>
							<h4>A page designed for displaying data in a process way.</h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
		...
		<section id="content">
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span12">
							<h1 class="page-title">Process Page</h1>
							
							<p>Below are several widgets to be used as "our process".</p>
								...
								<div class="span12">
									<div class="process_steps fixclear">
										<div class="step intro">
											...
											<a href="pages-process.php#">MORE ABOUT US +</a>
										</div><!-- end step -->
									...
									<div class="vertical_tabs">
										<div class="tabbable">
											<ul class="nav fixclear">
												<li class="active">
													<a href="pages-process.php#tabs_i2-pane1" data-toggle="tab">
													<span><span class="icon-comment icon-white"></span></span>
													CUSTOMER SUPPORT</a>
												</li>
												<li>
													<a href="pages-process.php#tabs_i2-pane2" data-toggle="tab">
													<span><span class="icon-book icon-white"></span></span>
													WELL DOCUMENTED</a>
												</li>
												<li>
													<a href="pages-process.php#tabs_i2-pane3" data-toggle="tab">
													<span><span class="icon-tint icon-white"></span></span>
													UNLIMITED COLORS</a>
												</li>
												<li>
													<a href="pages-process.php#tabs_i2-pane4" data-toggle="tab">
													<span><span class="icon-align-left icon-white"></span></span>
													CUSTOM SHORTCODES</a>
												</li>
												<li>
													<a href="pages-process.php#tabs_i2-pane5" data-toggle="tab">
							...
							<div class="row">
								<div class="span12">
									<h3 class="m_title">PROCESS STEPS</h3>
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span5">
				...
				<ul class="menu">
					<li><a href="pages-process.php#">Curabitur iaculis</a></li>
					<li><a href="pages-process.php#">Parturient montes</a></li>
					<li><a href="pages-process.php#">Vulputate magna</a></li>
					<li><a href="pages-process.php#">Cum sociis natoque</a></li>
					<li><a href="pages-process.php#">Nulla varius commodo</a></li>
					<li><a href="pages-process.php#">Parturient montes</a></li>
					<li><a href="pages-process.php#">Vulputate magna</a></li>
					<li><a href="pages-process.php#">Cum sociis natoque</a></li>
					<li><a href="pages-process.php#">Nulla varius commodo</a></li>
			...
			<div class="span3">
				<div class="contact-details">
					...
					Email: <a href="pages-process.php#">sales@yourwebsite.com</a></p>
			...
			<div class="span12">
				<div class="bottom fixclear">
					<ul class="social-icons fixclear">
						...
						<li class="social-twitter"><a href="pages-process.php#">Twitter</a></li>
						<li class="social-dribbble"><a href="pages-process.php#">Dribbble</a></li>
						<li class="social-facebook"><a href="pages-process.php#">Facebook</a></li>
						<li class="social-envato"><a href="pages-process.php#">Envato</a></li>
					</ul><!-- end social-icons -->
					<div class="copyright">
    ...
    <a href="pages-process.php#" id="totop">TOP</a>
