...
class Contacto_front extends MX_Controller {
	...
	function boletin_informativo()
	{
		$data['contenido_principal'] = $this->load->view('boletin_form', '', TRUE);
		$this->load->view('front/template', $data);
	}
	
	function boletin_email()
	{
		$data['contenido_principal'] = $this->load->view('boletin_slim', '', TRUE);
		$this->load->view('front/template', $data);
	}
	...
	function contacto_wtc(){
		...
		$data['title'] = lang('contacto.meta.title').' - '.lang('menu.wtc-valencia');
		//$data['meta_keywords'] = lang('contacto.meta.keywords').' - '.lang('inicio.meta.title');
		$data['meta_descripcion'] = lang('contacto.meta.description');
