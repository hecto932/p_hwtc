...
<div class="row">
	<div class="twelve columns">
		...
		<div class="cuadro_contacto hide-for-small">
			<img src="../../assets/front/img/temp/galeria_wtc/large/contacto01.jpg" alt="vista externa Hesperia"/>
			<div itemscope itemtype="http://schema.org/ContactPoint" class="cuadro_contacto_inner">
			<h3><span itemprop="name"><?php echo lang('contacto.inst_tit'); ?></span></h3>
				<h4><span itemprop="email"><?php echo lang('contacto.inst_correo'); ?></span> <br/> <span itemprop="telephone"><?php echo lang('contacto.inst_telf'); ?></span></h4>
			</div>
		</div>

		<div class="cuadro_contacto hide-for-small">
			<img src="../../assets/front/img/temp/galeria_wtc/large/large3.jpg" alt="habitaciones" />
			<div itemscope itemtype="http://schema.org/ContactPoint" class="cuadro_contacto_inner">
				<h3><span itemprop="name"><?php echo lang('contacto.aloj_tit'); ?></span></h3>
				<h4><span itemprop="email"><?php echo lang('contacto.aloj_correo'); ?></span> <br/> <span itemprop="telephone"> <?php echo lang('contacto.aloj_telf'); ?></span></h4>
			</div>
		</div>

		<div class="cuadro_contacto hide-for-small">
			<img src="../../assets/front/img/temp/galeria_wtc/large/contacto03.jpg" alt="centro de convenciones" />
			<div itemscope itemtype="http://schema.org/ContactPoint" class="cuadro_contacto_inner">
				<h3><span itemprop="name"><?php echo lang('contacto.even_tit'); ?></span></h3>
				<h4><span itemprop="email" ><?php echo lang('contacto.even_correo'); ?> </span><br/> <span itemprop="telephone"><?php echo lang('contacto.even_telf'); ?></span></h4>
			</div>
		</div>

		<div class="cuadro_contacto hide-for-small">
			<img src="../../assets/front/img/temp/galeria_wtc/large/contacto04.jpg" alt="evento" />
			<div itemscope itemtype="http://schema.org/ContactPoint" class="cuadro_contacto_inner">
				<h3><span itemprop="name"><?php echo lang('contacto.cong_tit'); ?></span></h3>
				<h4><span itemprop="email"><?php echo lang('contacto.cong_correo'); ?></span> <br/> <span itemprop="telephone"><?php echo lang('contacto.cong_telf'); ?></span></h4>
			</div>
		</div>
...
<div class="row">
	...
	<div  itemscope itemtype="http://schema.org/Place" class="four columns" >

		<div class="radius_content_naranja height_contacto">
			<h2><span itemprop="name"><?php echo lang('contacto.mapa_tit'); ?></span></h2>
		...
		<div itemprop="address" itemscope itemtype="http://schema.org/PostalAddress" style="clear:both;"></div>
			<p><span itemprop="streetAddress"><?php echo lang('contacto.mapa_dir'); ?></span></p>
			<p><strong><span itemprop="telephone"><?php echo lang('contacto.mapa_telft'); ?></span></strong> <br/><span itemprop="telephone"> <?php echo lang('contacto.map_telf1'); ?> </span> <br/> <span itemprop="telephone"> <?php echo lang('contacto.map_telf2');?> </span> </p>
			<p><strong><span itemprop="email"><?php echo lang('contacto.map_mailt'); ?></span></strong> <br/> <span itemprop="email"><?php echo lang('contacto.map_mail1'); ?></span> <br/> <span itemprop="email"> <?php echo lang('contacto.map_mail2'); ?> </span> </p>
