...
class Usuario_model extends CI_Model {
	...
	function get_page($start=0,$count=10,$order_field='usuario.id_usuario',$order_dir='desc',$terminos_busqueda=array()){
		...
		$this->db->select('usuario.*,usuario.id_usuario as id_usuario, estado.estado',false);
		
		//OJO
		$this->db->join('estado', 'estado.id_estado = usuario.id_estado');
	...
	function delete($id)
	{
		...
		if ($this->db->update('usuario', array('id_estado' => 3)))
			return true;
		else return false;
	}
