				...
				<table class="twelve" border="1" summary="Tabla de habitaciones.">
					...
					<thead>
						...
						<tr>
							...
							<th id="destacado" class="col7<?php echo ((strpos(uri_string(),'destacado')!=false) ? strtolower($order_dir) : 'desc')?>">
					...
					<tbody>
						...
						<?php foreach ($habitaciones as $habitacion): ?>
							<tr>
								...
								<td class="col7" headers="destacado">
									<p>
										<?php echo ($habitacion->destacado != '') ? $habitacion->destacado : 0;  ?>
									</p>
								</td>
