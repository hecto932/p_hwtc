<h3><?php echo lang('ficha_datos'); ?></h3>
	...
	<div class="ficha_habitacion">
		...
		<table style="border: 0px; padding: 3px 3px;">
			<tr>
				<td><i class="general foundicon-page"></i> <?php echo lang('habitaciones_codigo'); ?>:</td>
				<td><?php echo ($habitacion->codigo == '') ? lang('servicios_sintitulo') : $habitacion->codigo; ?></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><?php echo ucfirst($habitacion->destacado); ?></td>
			</tr>
			<!--
			<tr>
