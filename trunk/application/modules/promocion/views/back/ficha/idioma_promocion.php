...
<?php echo form_open(lang('backend_url').'/'.lang('promociones_url').'/'.lang('guardar_url').'_'.lang('idioma_url'),'id="gen_form" class="custom"'); ?>
	...
	<div class="six columns">
		...
		<label for="nombre"  <?php echo (form_error('nombre') != '') ? 'class="error"' : '' ; ?>>
			<span> <?php echo lang('listado_titulo'); ?> * </span> <?php echo (form_error('nombre') != '') ? '('.form_error('nombre', '<span>', '</span>').')' : '' ; ?>
		</label>

		<?php $temp = (isset($promocion->nombre)) ? $promocion->nombre : ''; ?>
		...
		<label for="subtitulo">
			<span> <?php echo lang('listado_subtitulo'); ?> </span>
		</label>
		<?php $temp = (isset($promocion->subtitulo)) ? $promocion->subtitulo : ''; ?>
        ...
        <?php $temp = (isset($promocion->titulo_pagina)) ? $promocion->titulo_pagina : ''; ?>
	...
	<div class="six columns">
			...
			<select class="custom lenguaje_noticias"  name="id_idioma">
				<?php foreach($idioma_select as $im): ?>
					...
					elseif ($accion != 'normal')
						echo ((isset($promocion->id_idioma) && $promocion->id_idioma==$im->id_idioma) ? ' selected="selected"' : '')?>><?php echo ucfirst($im->nombre); ?></option>
				<?php endforeach; ?>
			</select>
		...
		<?php $temp = (isset($promocion->keywords)) ? $promocion->keywords : ''; ?>
		...
		<?php $temp = (isset($promocion->url)) ? $promocion->url : ''; ?>
	...
	<div class="twelve columns">
		...
		<?php $temp = (isset($promocion->descripcion_pagina)) ? $promocion->descripcion_pagina : ''; ?>
	...
	<div class="twelve columns">
        ...
        <?php $temp = (isset($promocion->descripcion_breve)) ? $promocion->descripcion_breve : ''; ?>
	...
	<div class="twelve columns">
		...
		<?php endif; ?>
		<?php $temp = (isset($promocion->descripcion_ampliada)) ? $promocion->descripcion_ampliada : ''; ?>
		<textarea class="ckeditor" id="descripcion_ampliada" name="descripcion_ampliada" rows="10" cols="50"><?php echo idioma_values(set_value('descripcion_ampliada'), $temp, $accion); ?></textarea>

	</div>

	<?php /*-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/ ?>

	<input type="hidden" name="id_promocion" value="<?php echo (isset($id_promocion)) ? $id_promocion : $promocion->id_promocion; ?>" />
	<?php if (isset($promocion->id_detalle_promocion) || $accion != 'normal'): ?>

		<input type="hidden" name="id_detalle_promocion" value="<?php echo $promocion->id_detalle_promocion ?>" />
       	<?php //echo '<input type="hidden" name="id_idioma" value="'.$promocion->id_idioma.'" />'; ?>
