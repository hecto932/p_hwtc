	...
	<div class="twelve columns">
		...
		<dl class="tabs contained four-up">
			...
			<dd <?php echo ($sub_activo == 'Ficha') ? 'class="active"' : '' ; ?>>
				<a href="#Ficha">
					...
					<span><?php echo lang('restaurantes_ficha_tit'); ?></span>
				</a>
			</dd>
			...
			<dd>
				<a href="#Lang<?php echo $restaurante_idioma->id_idioma ?>" title="">
					<i class="foundicon-globe"></i>
					<span> <?php echo lang($idioma[$restaurante_idioma->id_idioma]->nombre); ?> </span>
			...
			<?php if (count($idiomas) > count($restaurante_idiomas) && ($accion != 'editar')): ?>
		...
		<ul class="tabs-content contained">
			...
			<li id="FichaTab"  <?php echo ($sub_activo == 'Ficha') ? 'class="active"' : '' ; ?>>
				<?php echo $restaurante_info; ?>
			</li>

			<li id="ImagenesTab"  <?php echo ($sub_activo == 'Imagenes') ? 'class="active"' : '' ; ?>>
				<?php echo $restaurante_imagenes; ?>
			</li>

			<?php echo $idioma_info; ?>

			<li id="NewLangTab" <?php echo ($sub_activo == 'NewLangTab') ? 'class="active"' : '' ; ?>>
				<?php //echo modules::run('template/crear_idioma_form', $restaurante->id_restaurante, 'restaurante'); ?>
