<!-- Formulario Nuevo Idioma restaurante -->
<?php echo form_open(lang('backend_url').'/'.lang('restaurantes_url').'/'.lang('guardar_url').'_'.lang('idioma_url'),'id="gen_form" class="custom"'); ?>
	...
	<div class="six columns">
		...
		<?php $temp = (isset($restaurante->nombre)) ? $restaurante->nombre : ''; ?>
		...
		<?php $temp = (isset($restaurante->subtitulo)) ? $restaurante->subtitulo : ''; ?>
		...
		<label for="titulo_pagina" <?php echo (form_error('titulo_pagina') != '') ? 'class="error"' : '' ; ?>>
        		<span> <?php echo lang('restaurantes_ficha_paginaT'); ?> *</span> <?php echo (form_error('titulo_pagina') != '') ? '('.form_error('titulo_pagina', '<span>', '</span>').')' : '' ; ?>
        </label>
        <?php $temp = (isset($restaurante->titulo_pagina)) ? $restaurante->titulo_pagina : ''; ?>
	...
	<div class="six columns">
		<?php //if (!isset($restaurante->id_detalle_restaurante)): ?>
			...
			<select class="custom lenguaje_restaurantes"  name="id_idioma">
				<?php foreach($idioma_select as $im): ?>
					...
					elseif ($accion != 'normal')
						echo ((isset($restaurante->id_idioma) && $restaurante->id_idioma==$im->id_idioma) ? ' selected="selected"' : '')?>><?php echo ucfirst($im->nombre); ?></option>
				<?php endforeach; ?>
			</select>
		...
		<label for="keywords" <?php echo (form_error('keywords') != '') ? 'class="error"' : '' ; ?>>
			<span> <?php echo lang('restaurantes_ficha_pclave'); ?> *</span> <?php echo (form_error('keywords') != '') ? '('.form_error('keywords', '<span>', '</span>').')' : '' ; ?>
		</label>
		<?php $temp = (isset($restaurante->keywords)) ? $restaurante->keywords : ''; ?>
		...
		<label for="url" <?php echo (form_error('url') != '') ? 'class="error"' : '' ; ?>>
			<span> <?php echo lang('restaurantes_ficha_url'); ?> *</span> <?php echo (form_error('url') != '') ? '('.form_error('url', '<span>', '</span>').')' : '' ; ?>
		</label>
		<?php $temp = (isset($restaurante->url)) ? $restaurante->url : ''; ?>
	...
	<div class="twelve columns">
		...
		<label for="descripcion_pagina" <?php echo (form_error('descripcion_pagina') != '') ? 'class="error"' : '' ; ?>>
			<span> <?php echo lang('restaurantes_ficha_paginaD'); ?> *</span> <?php echo (form_error('descripcion_pagina') != '') ? '('.form_error('descripcion_pagina', '<span>', '</span>').')' : '' ; ?>
		</label>
		<?php $temp = (isset($restaurante->descripcion_pagina)) ? $restaurante->descripcion_pagina : ''; ?>
	...
	<div class="twelve columns">
		...
		<label for="descripcion_breve" <?php echo (form_error('descripcion_breve') != '') ? 'class="error"' : '' ; ?>>
        		<span> <?php echo lang('restaurantes_ficha_dscB'); ?> *</span> <?php echo (form_error('descripcion_breve') != '') ? '('.form_error('descripcion_breve', '<span>', '</span>').')' : '' ; ?>
        </label>
        <?php $temp = (isset($restaurante->descripcion_breve)) ? $restaurante->descripcion_breve : ''; ?>
	...
	<div class="twelve columns">
		...
		<label for="descripcion_ampliada">
			<span> <?php echo lang('restaurantes_ficha_dscA'); ?> </span>
		</label>
		...
		<?php endif; ?>
		<?php $temp = (isset($restaurante->descripcion_ampliada)) ? $restaurante->descripcion_ampliada : ''; ?>
	...
	<input type="hidden" name="id_restaurante" value="<?php echo (isset($id_restaurante)) ? $id_restaurante : $restaurante->id_restaurante; ?>" />
	<?php if (isset($restaurante->id_detalle_restaurante) || $accion != 'normal'): ?>

		<input type="hidden" name="id_detalle_restaurante" value="<?php echo $restaurante->id_detalle_restaurante ?>" />
       	<?php //echo '<input type="hidden" name="id_idioma" value="'.$restaurante->id_idioma.'" />'; ?>
...
<!-- Formulario Formulario Nuevo Idioma restaurante cierre -->
