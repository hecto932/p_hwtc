			...
			<dl class="tabs contained four-up">
				<dd <?php echo ($sub_activo == 'Ficha') ? 'class="active"' : '' ; ?>>
					<a href="#Ficha">
						...
						<span><?php echo lang('servicios_ficha_tit'); ?></span>
					</a>
				</dd>
				<dd>
					<a href="#Imagenes">
				...
				?>
				<dd>
					<a href="#Lang<?php echo $servicio_idioma->id_idioma ?>" title="">
						<i class="foundicon-globe"></i>
						<span> <?php echo lang($idioma[$servicio_idioma->id_idioma]->nombre); ?> </span>


					</a>
				</dd>
				<?php endforeach; ?>
				<?php if (count($idiomas) > count($servicio_idiomas) && ($accion != 'editar')): ?>
