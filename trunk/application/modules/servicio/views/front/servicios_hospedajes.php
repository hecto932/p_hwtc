				...
				<?php foreach($habitaciones as $habitacion): ?>
					<li>
						...
						<div class="content">
							...
							<a href="http://www.hesperia.com/nh/en/hotels/venezuela/valencia/hesperia-wtc-valencia.html" target="_blank" class="button small reservar_button"><?php echo mb_strtoupper(lang('hosedaje.reservar')); ?></a>
						</div>
					</li>
				<?php endforeach; ?>
			<?php endif; ?>
