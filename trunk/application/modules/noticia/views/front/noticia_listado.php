...
<div class="row">
	<div class="eight columns">
		...
		<div class="radius_content">
			...
			<div  itemscope itemtype="http://schema.org/Article" class="noticia_principal">
				<?php if(isset($noticia_principal) && !empty($noticia_principal) && ($noticia_principal->id_estado!=3)): ?>
					...
					<a href="<?php echo base_url().lang('noticias_url').'/'.$noticia_principal->url; ?>">
						...
						?>
						<span itemprop='image' > <img src="<?php echo $img_noticia; ?>"></span>
					</a>
					...
					<small itemprop='datePublished' ><?php echo $dia.$mes.$anyo; ?></small>
					<p  itemprop='articleBody'><?php echo character_limiter($noticia_principal->descripcion_breve, 360) ;?></p>
			...
			<?php if(isset($noticias_secundarias) && !empty($noticias_secundarias)): ?>
				...
				<?php foreach($noticias_secundarias as $noticia): ?>
					...
					<div class="six columns mobile-two">
						<div itemscope itemtype="http://schema.org/Article" class="noticia_secundaria">
							<a href="<?php echo base_url().lang('noticias_url').'/'.$noticia->url; ?>">
								...
								?>
								<img itemprop='image' style="width:247px; height: 185px"; src="<?php echo $img_noticia; ?>">
							</a>
							<a itemprop='name' href="<?php echo base_url().lang('noticias_url').'/'.$noticia->url; ?>" class="hide-for-small"><h2><?php echo character_limiter($noticia->nombre, 55); ?></h2></a>
							<a itemprop='name' href="<?php echo base_url().lang('noticias_url').'/'.$noticia->url; ?>" class="show-for-small"><h6><?php echo character_limiter($noticia->nombre, 55); ?></h6></a>
							<?php
							...
							?>
							<small itemprop='datePublished'><?php echo $dia.$mes.$anyo ?></small>
							<p  itemprop='articleBody'><?php echo character_limiter($noticia->descripcion_breve, 150); ?></p>
							<div class="fb-like" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false" data-action="recommend"></div>
						</div>
					</div>
					<?php if($cont%2 == 0): ?>
...
<!------------------------------ REDES SOCIALES CONGRESSUS CENTER ------------------------------>
		<div class="hide-for-small" style="position: absolute; height: 490px">
			...
			<div style="position: absolute; margin-top: 500px; margin-left: -12px" class="fb-like-box" data-href="https://www.facebook.com/CongressusCenter" data-width="310" data-show-faces="true" data-stream="false" data-show-border="true" data-header="false"></div>
		</div>
