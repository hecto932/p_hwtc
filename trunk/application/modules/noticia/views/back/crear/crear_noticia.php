							...
							<div class="row">
						        ...
						        <div class="ten columns">
						        	<?php if(isset($noticia)): ?>
						        		<?php echo form_dropdown('destacado', $array_destacado, $noticia->destacado, 'class="custom select_back" '); ?>
						        	<?php else: ?>
						        		<?php $temp = (isset($noticia) && !empty($noticia->destacado)) ? $noticia->destacado : '' ?>
