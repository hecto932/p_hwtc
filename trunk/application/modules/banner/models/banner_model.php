...
class Banner_model extends CI_Model {
	...
	{
		$this->db->join('rel_banner_multimedia r', 'r.id_banner = b.id_banner');
		$this->db->join('multimedia m', 'm.id_multimedia = r.id_multimedia');
		$this->db->where('b.id_estado', 1);
		$this->db->group_by('b.id_banner');
		$this->db->order_by('b.destacado ASC, b.creado DESC');
		$this->db->limit(4);
		return $this->db->get('banner b')->result();
	}
}
