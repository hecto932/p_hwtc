...
class Relations extends MX_Controller {
     ...
     * @return	mixed
     */
    function get_categorias_deprecado($tipo_cat='1', $id_parent = 0, $ajax = false, $destacado = '') {
    ...
    function arbol_categorias_deprecado($tipo_cat, $current_cat_id = 0, $current_padre_id = 0, $type = 'categoria', $ajax = true, $cats = array(), $niveles = 4) {
        $ret = '';
        $first_run = false;
        if (empty($cats)) {
