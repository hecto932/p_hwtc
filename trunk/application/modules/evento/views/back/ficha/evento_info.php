...
?>
	...
	<div class="row">
		...
		<div class="six columns ficha_evento">
			...
			<table style="border: 0px; padding: 3px 3px;" width="100%">
				<tr>
					<td width="35%"><i class="foundicon-website"></i> <?php echo lang('estado'); ?>:</td>
					<td width="65%"><?php echo ucfirst($estado->estado); ?></td>
				</tr>
				<!--
				<tr>
					<td><i class="general foundicon-address-book"></i> <?php echo lang('categoria_evento')  ?>:</td>
					<td><?php echo $evento->nombre_categoria; ?></td>
				</tr>
				<tr>
					<td><i class="foundicon-website"></i> <?php echo lang('eventos_ficha_levento'); ?>:</td>
					<td><?php echo ucfirst($evento->lugar); ?></td>
				</tr>
				-->
				
				<?php
					list($fecha, $hora) = explode(' ', fecha_to_timestamp($evento->fecha_evento));
				?>
				...
				<tr>
					...
					<td><?php echo date('g:i A' , strtotime($hora)); ?></td>
				</tr>
				<tr>
					<td><i class="foundicon-website"></i> <?php echo lang('destacada'); ?>:</td>
					<td><?php echo $evento->destacado  ?></td>
				</tr>
			</table>
		</div>
		
		<!-- WTC Archivos Asociados -->
		<!--
		<?php /*
	...
	<div class="row">
		...
		<div class="six columns">
			...
			<!-- WTC Hospedaje / Inscripcion / Asistencia -->
			<?php
			/*
