<style>
			...
			.gral_switch{
				width: <?php echo (isset($switch_size) && !empty($switch_size)) ? $switch_size : '80px'; ?>; /*Tamaño del switch*/
				height: 26px;
				background: #01ACE0;
			...
			.gral_switch:after{
				content: '<?php echo (isset($after) && !empty($after)) ? $after : 'SI'; ?>';
			...
			.gral_switch:before{
				content: '<?php echo (isset($before) && !empty($before)) ? $before : 'NO'; ?>';
				font: 12px/26px Arial, sans-serif;
				color: #FFF;
				position: absolute;
				left: 10px;
			...
			.gral_switch div.etiqueta{
				display: block !important;
				width: <?php echo (isset($switch_size_button) && !empty($switch_size_button)) ? $switch_size_button : '34px'; ?> !important; /*Tamaño del button switch*/
			...
			.gral_switch input[type=checkbox]:checked + span + div {
				left: <?php echo (isset($switch_button_position_right) && !empty($switch_button_position_right)) ? $switch_button_position_right : '43px'; ?> !important; /*Posicion final del button switch*/
			}

			.gral_switch input[type=checkbox] + span{
				display:none;
			}
