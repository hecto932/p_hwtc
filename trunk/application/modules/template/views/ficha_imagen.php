		...
		<div class="twelve columns imagenes_secundarias">
			...
			<div style="margin-left: 15px">
				...
				<ul>
					...
					<li style="color: #424242; font-size: 11px"><b><?php echo lang('img_restaurantes_tit'); ?> </b><?php echo lang('img_restaurantes_desc'); ?></li>
					<li style="color: #424242; font-size: 11px"><b><?php echo lang('img_habitaciones_tit'); ?> </b><?php echo lang('img_habitaciones_desc'); ?></li>
					<li style="color: #424242; font-size: 11px"><b><?php echo lang('img_promociones_tit'); ?> </b><?php echo lang('img_promociones_desc'); ?></li>
					<li style="color: #424242; font-size: 11px"><b><?php echo lang('img_servicios_tit'); ?> </b><?php echo lang('img_servicios_desc'); ?></li>
					<li style="color: #424242; font-size: 11px"><b><?php echo lang('img_eventos_tit'); ?> </b><?php echo lang('img_eventos_desc'); ?></li>
				</ul>
			</div>
		</div>
	</div>
...
<div class="row">
	<div class="twelve columns">
		...
		<div class="six columns">
			<?php
				if(isset($permite_secundarias) && $permite_secundarias && isset($url_add_s) && !empty($url_add_s))
