	...
	<div class="grid_8 alpha">
		<div class="pikachoose">
			<ul id="pikame" class="jcarousel-skin-pika">
				...
				<?php
				if ( $imagen == NULL): ?> 
					<li><a><img src="<?php echo $placeholder; ?>" width="430" height="250"/></a></li> <?php endif;
	...
	<div class="grid_8 productos_relacionados">
		...
		<ul class="listaproductosdetalle">
			<?php for ($i=0; $i < 2; $i++)
			{
				...
				if (isset($relacion[$i]))
				{
					$imagen = json_decode(modules::run('services/relations/get_rel','producto','imagen',$relacion[$i]->id_producto,'true','multimedia.id_multimedia',$where2));	
				...
				{ ?>
					<li>
						<a href="<?php echo site_url().lang('detalle_productos_url').$relacion[$i]->url; ?>"><img widht="81" height="47" src="<?php echo $img_url; ?>" /></a>
						<a href="<?php echo site_url().lang('detalle_productos_url').$relacion[$i]->url; ?>"><h3><?php echo $relacion[$i]->nombre; ?></h3></a>
						<br />
						<p><? echo substr($relacion[$i]->descripcion_breve, 0, 20); ?>...<br /><?php echo lang('productos_leer'); ?></p>
					</li>
			<?php
				}
			} ?>
