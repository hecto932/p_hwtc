...
<?php /*--------------------------------- IDIOMA ---------------------------------*/ ?>
	<div class="six columns">
			...
			<select class="custom lenguaje_galerias"  name="id_idioma">
...
<?php /*--------------------------------- DESCRIPCION_BREVE ---------------------------------*/ ?>
	<div class="twelve columns">
        ...
        <?php $temp = (isset($galeria->descripcion_breve)) ? $galeria->descripcion_breve : ''; ?>
...
<?php /*--------------------------------- DESCRIPCION_AMPLIADA1 ---------------------------------*/ ?>
	...
	<div class="twelve columns">
		...
		<?php endif; ?>
		<?php $temp = (isset($galeria->descripcion_ampliada)) ? $galeria->descripcion_ampliada : ''; ?>
